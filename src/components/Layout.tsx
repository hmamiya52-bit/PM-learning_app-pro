...
// 公式午前Ⅱ・論述は F1-P4 / F1-P5 で本格実装、現状は App.tsx でコメントアウト中（クリックすると 404 へ）。
// ----------------------------------------------------------------
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: '午前Ⅱ問題演習',     to: '/morning',                icon: <IconFileText /> },
  { label: '午後Ⅰ問題演習',     to: '/afternoon',              icon: <IconClipboard /> },
  { label: '午後Ⅱ問題演習',     to: '/essay',                  icon: <IconPen /> },
