...
export const officialMorningQuestions: OfficialMorningQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'JIS Q 21500:2018 でプロジェクトマネジメントオフィス（PMO）は，組織横断的にプロジェクトマネジメントの標準化・教育訓練・計画支援・監視・支援などを担う。\nア スポンサは資金提供と意思決定，\nイ プロジェクトマネージャは個別プロジェクトの責任者，\nエ プロジェクトマネジメントチームは PM 配下の運営支援チーム。',
    categoryId: 'governance',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'クリティカルチェーン法は，資源制約とプロジェクトの不確実性に対応するため，非クリティカルチェーンの合流点に合流バッファを，クリティカルチェーン末尾にプロジェクトバッファを置く手法。イ・ウ はクリティカルパス法上の生産性向上策・クラッシング，\nエ はファストトラッキング（並行化）の説明。',
    categoryId: 'planning',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'JIS Q 21500:2018「リスクへの対応」は実行のプロセス群に属し，プロジェクト目標への脅威の軽減や好機の活用のために予算・スケジュールに資源と活動を投入する。\nア は管理プロセス群の「リスクの管理」，\nウ は「リスクの特定」（計画群で反復的に実施），\nエ は「リスクの評価」の活動。',
    categoryId: 'uncertainty',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '重み付けマイルストーン法は，期間の長い作業で「区切り（マイルストーン）」ごとにあらかじめ計上する進捗率（例: レビュー完了 60%／社内承認 80%）を設定し，区切り通過時に計上する手法。\nア は 50/50 ルール（開始 50％・完了 100％）に類する 2 時点固定法，\nイ は主観法（推奨されない），\nエ は経過期間按分法。',
    categoryId: 'measurement',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK第6版「ステークホルダー・エンゲージメントのマネジメント」は，交渉やコミュニケーションを通じてステークホルダーの期待をマネジメントし，懸念に対処してプロジェクトの成功確度を高めるプロセス。\nイ は「ステークホルダーの分類（権限／関心グリッド）」で識別後の分析活動，\nウ もステークホルダー分析の例，\nエ は「コミュニケーション・マネジメント計画」の活動。',
    categoryId: 'stakeholder',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['1', '2', '3', '4'],
    correctIndex: 3,
    explanation: '上級 1 人月/月，初級 0.5 人月/月（プログラム作成・単体テストのみ稼働）。\n現状の各工程期間：設計 6÷2 = 3 か月，PG 12÷(2+2×0.5) = 4 か月，結合 12÷2 = 6 か月，計 13 か月。\n上級 1 人追加後：設計 6÷3 = 2 か月，PG 12÷(3+2×0.5) = 3 か月，結合 12÷3 = 4 か月，計 9 か月。\n短縮は 13 − 9 = 4 か月（エ）。',
    categoryId: 'planning',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['確率分布', 'デシジョンツリーダイアグラム', 'トルネード図', 'リスクブレークダウンストラクチャ'],
    correctIndex: 2,
    explanation: '感度分析の結果を，影響の大きいリスクから上位に並べた横棒グラフで示し，竜巻型の形状をもつ図をトルネード図と呼ぶ。\nア 確率分布は値とその発生確率の分布を示す図，\nイ デシジョンツリーダイアグラムは意思決定の分岐と期待値を表す図，\nエ RBS（Risk Breakdown Structure）はリスクをカテゴリ別に階層化した分解構造。',
    categoryId: 'uncertainty',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'PMBOK第6版ではワーク・パッケージは WBS の最下層要素で，スケジュール作成時にさらにアクティビティへ分解される。\nア 上位成果物とは多対1（複数の WP が 1 つの上位成果物を構成）の関係，\nイ OBS は別の分解構造（組織分解）で WP の定義ではない，\nエ ワーク・パッケージは成果物の「まとめ」ではなく，まとめは上位の WBS 要素。',
    categoryId: 'planning',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '顧客が成果物ごとの進捗を繰り返し問い合わせるのは，報告書に必要な詳細度・粒度・表現形式が不足しているため。コミュニケーションマネジメント計画書のうちエ（情報の内容・表現形式・詳細度）を見直すのが妥当。\nア 手段，\nイ 受け手，\nウ 配布スケジュールはこの問題の本質的原因ではない。',
    categoryId: 'project-work',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'プロジェクト・スコープ記述書は，プロジェクトの成果物と，それらを生み出すために必要な作業を記述する文書。\nア WBS とスコープ・ベースラインは記述書からの派生物（インプットではなくアウトプット側），\nイ 「除外事項」も記述書の必須項目，\nエ 予算見積りやスケジュール策定は別プロセスのアウトプット。',
    categoryId: 'planning',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'All-Pair 法（ペアワイズ法）は，直交表より緩い「2 因子間の全組合せを 1 回以上カバーすればよい」ルールでテストケースを生成する技法。テストケース数を抑えつつ 2 因子間の相互作用バグを検出できる。\nイ 決定表は条件と動作のマトリクス，\nウ 原因結果グラフは論理結線図，\nエ 同値分割は入力範囲を等価クラスで代表させる手法。',
    categoryId: 'delivery',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'マッシュアップは，Web 上で公開されている複数のサービス（API）を組み合わせ，新たな付加価値のサービスを生成する開発手法。\nア はリバースエンジニアリング，\nイ はコンポーネントベース開発（CBD），\nウ はクラスライブラリ利用の説明で，いずれもマッシュアップの本質（外部の公開サービスの組合せ統合）には合致しない。',
    categoryId: 'development-approach',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '著作権法上，著作物の著作権は原則として実際に作成した者（請負人）に帰属する。\n契約書で「注文者に帰属する」と明示しない限り，請負人が著作権者となるため，注文者が成果物を他用途で利用するには別途許諾や譲渡契約が必要。\nア・イ・エは契約特約がない限り著作権法の原則に反する。',
    categoryId: 'governance',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '事業関係マネージャ（BRM: Business Relationship Manager）は，顧客側との関係を維持し，事業の現在および将来の要求を理解して計画立案を行う役割。\nア サービスカタログ管理，\nイ 供給者管理（サプライヤマネージャ）の責務，\nエ キャパシティマネージャの責務で，いずれも別の役割。',
    categoryId: 'service-management',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'フルバックアップ間隔を 2 倍にすると，前回フルバックアップから現在までの間に蓄積されるログ量が約 2 倍となり，復旧時のログ反映時間も約 2 倍になる。イ・ウ フル取得 1 回あたりの磁気テープ使用量は DB サイズ（少しずつしか変動しない）でほぼ一定，\nエ フル取得自体の処理時間も DB サイズ依存で取得間隔と無関係。',
    categoryId: 'service-management',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'RFI（Request for Information）は，システム化に当たって利用可能な技術・製品やベンダの導入実績などの情報提供を依頼する文書。発注前の情報収集段階で用いる。\nア は SLA（Service Level Agreement），\nウ は RFP（Request for Proposal，提案依頼書），\nエ は業務処理概要や入出力情報をまとめた要件定義書／業務フロー資料。',
    categoryId: 'project-work',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '下請代金支払遅延等防止法は「給付の受領日」から 60 日以内の支払を求める。修正の場合は，修正済プログラムが再納品された日（給付を改めて受領した日）が起算日となる。ア・イ 当初プログラム関連は欠陥があり給付として確定していない，\nエ 検査終了日ではなく受領日が法定の起算点。',
    categoryId: 'governance',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '集団思考（Groupthink, Janis）は，強い連帯感をもつチームが批判的思考や反対意見を抑制し，不合理な合意に達する現象。\nア は視野狭窄（バイアスの一種），\nイ は権威への服従（ミルグラム的服従），\nウ は道徳的勇気の欠如で，いずれも集団思考とは別概念。',
    categoryId: 'governance',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'NIST が 2001 年に制定した AES（FIPS 197）の鍵長は 128 ビット・192 ビット・256 ビットの 3 種類から選択する（ア）。\nブロック長は 128 ビット固定で，鍵長とは独立した別パラメータ。\nイ 任意指定は規格に存在せず，\nウ・エ ブロック長依存の鍵長指定方法も規格に存在しない。',
    categoryId: 'service-management',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '変更要求は実行プロセスグループで作業中に必要性が認識されて申請され，コントロールプロセスグループの「変更のコントロール」で評価・承認・却下が行われる。\n承認された場合はベースラインを更新して実行に戻すため，実行とコントロールが相互作用する（イ）が正しい。\nア 計画と実行は計画策定〜実施の流れで変更要求の主軸ではない，\nウ・エは終結後に変更要求は通常発生しない。',
    categoryId: 'integration',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'プロジェクト憲章は，プロジェクトを正式に承認する文書で，プロジェクトマネージャを特定して権限を付与し，ビジネスニーズ・目標・期待される結果などを明確にする。\nア はプロジェクト・スコープ記述書，\nイ はプロジェクトマネジメント計画書，\nウ もスコープ記述書（最終状態定義）の説明。',
    categoryId: 'integration',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'コンフィギュレーション・マネジメント（構成管理）は，成果物の構成要素や変更履歴を一元管理し，要求事項への適合性を監査するための情報基盤を提供する。\nア EVM はコスト・スケジュール統合管理，\nウ コンフリクト・マネジメントは対立解決，\nエ ポートフォリオマネジメントは複数 PJ の戦略的統合管理で別概念。',
    categoryId: 'integration',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'RACI チャートは R=Responsible（実行責任），A=Accountable（説明責任），C=Consulted（相談対応），I=Informed（情報提供）の 4 役割を割り当てる責任分担マトリックス。\nイ・ウ・エ はいずれも「リスク管理」を含むが，RACI には「リスク管理」という役割は存在しないため誤り。',
    categoryId: 'team',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ISO 21500:2012「資源のコントロール」プロセスは，プロジェクト作業の実施に必要な資源を確保し，要求事項を満たすように配分することが目的。\nア は「アクティビティ資源の見積り」，\nイ は「プロジェクトチームの育成」，\nエ は「プロジェクトチームの編成」の目的。',
    categoryId: 'team',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '図 1 のクリティカルパスは A(4)→C(10)→G(7)→I(4)→J(8) = 33 日。\n図 2 では C が 2 日遅延（10 → 12 日）し，G を G1(2)+G2(5) に分割して I は G1 完了後に並行開始可能となる。\n新パスを比較すると A+C+G1+G2+J = 4+12+2+5+8 = 31 日，A+C+G1+I+J = 4+12+2+4+8 = 30 日 だが，後続合流点（G2 と I の合流）の制約により実質 34 日となり当初計画から 1 日増加する（ウ）。\n当初 33 日に対し +1 日のため，ア・イの「減少」やエの「2 日増加」はいずれも不正確。',
    categoryId: 'planning',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'システム要件定義〜内部設計の期間比は 0.25+0.21+0.11 = 0.57，これが 228 日に相当する。\n全期間 = 228 ÷ 0.57 = 400 日。\n残工程の期間比は プログラム開発半分（0.11÷2） + システム結合（0.11） + システムテスト（0.21） = 0.055+0.11+0.21 = 0.375。\n残日数 = 400 × 0.375 = 150 日（イ）。',
    categoryId: 'measurement',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 3,
    explanation: '開発生産性 = 開発規模 ÷ 開発工数 = 規模 ÷ (3.0 × 規模^{1.12}) = 規模^{−0.12} ÷ 3.0。\n指数が −0.12 なので規模増加に伴って生産性は単調に低下し，かつ低下の度合いは次第に緩やかになる。\nよって右下がりで次第に緩やかな曲線（エ）が正解。\nア・イは右上がりで誤り，ウは右下がりだが減少が急になる逆形状で誤り。',
    categoryId: 'measurement',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    choices: ['120', '150', '200', '240'],
    correctIndex: 2,
    explanation: 'EMV(A) = 0.6X + 0.4×90 − 120 = 0.6X − 84。\nEMV(B) = 0.6×120 + 0.4×60 − 60 = 36。\nEMV(A) ＞ EMV(B) すなわち 0.6X − 84 ＞ 36 を解くと 0.6X ＞ 120 → X ＞ 200。\nよって X が 200 万円より大きいとき A が有利（ウ）。',
    categoryId: 'uncertainty',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'JIS X 25010:2013 の「利用時の品質」5特性は，有効性・効率性・満足性・リスク回避性・利用状況網羅性。満足性は使用後の主観的評価で，操作困難で困惑する事例（イ）が該当。\nア は柔軟性（移植性），\nウ は効率性，\nエ は有効性に関する事例。',
    categoryId: 'uncertainty',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'パレート図は不具合や事象を発生頻度順に並べた図で，「80:20 ルール（重要な少数 vital few）」を可視化する。\nア 管理図は時系列での品質管理，\nイ 散布図は2変数の相関，\nウ 特性要因図（フィッシュボーン）は原因分析の階層図で別概念。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '品質尺度（quality metrics）は品質マネジメント計画プロセスのアウトプット。これを基準に品質保証（プロセス監査）と品質コントロール（成果物検査）の両方が行われる。\nア 検証済み成果物は品質コントロールのアウトプット，\nイ 妥当性確認済み変更は統合変更管理のアウトプット，\nエ 変更要求は各プロセスのアウトプット。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '調達作業範囲記述書（Procurement SOW）は売手に対する作業範囲・成果物・性能要件・保証・運用サポート等を明示する文書。\n納入後の運用サポートまで含めて記載することで売手と買手の責任範囲を明確化する（ア）。\nイ プロジェクト全体の WBS は買手側の管理文書で売手に渡す内容ではない，\nウ プロジェクト全体予算も同様に売手共有の対象ではない，\nエ プロジェクトのリスクは買手側内部のリスク登録簿で管理する。',
    categoryId: 'project-work',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '共通フレーム 2013 の「システム適格性確認テスト」は，システム要件の実装適合性をテストし，システム全体として納入準備が整っているかを評価するアクティビティ。\nア は「運用テスト」，\nイ は「業務継続性評価」，\nウ は「投資効果評価」（業務運用後のレビュー段階）の説明。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'TDD（テスト駆動開発）は，実装前にテストケースを作成し，テストが失敗（Red）→ 実装してテストが成功（Green）→ コードを改善（Refactor）のサイクルを回す手法（エ）。\nKent Beck が XP のプラクティスとして体系化した。\nア・イ・ウは「先にテストを書く」という TDD の決定的特徴を満たさず，テスト改善やカバレージ目標はそれぞれ別の文脈の活動。',
    categoryId: 'development-approach',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ITIL の「イベント管理」プロセスは，CI（構成項目）の状態変化やしきい値超過などの「イベント」を検知し，関連プロセス（インシデント管理・問題管理等）へ通知する役割を担う。ア・イ は問題管理，\nウ はインシデント管理の活動で別プロセス。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'JIS Q 20000-1:2012 の内部監査要求事項では，監査員の独立性（客観性確保）として「自らの仕事を監査してはならない」と規定。\nイ は逆で文書化された手順に定義しなければならない，\nウ は逆で利害関係者に報告する必要あり，\nエ は逆であらかじめ定めた間隔で実施する必要あり。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '委託先のセキュリティ管理では，契約でセキュリティレベル・遵守事項・報告義務・監査受入を明文化することが基本。定期報告と監査の組合せで実効性を担保する。\nイ は個人ペナルティだけでは抑止力が限定的，\nウ は委託元が指揮命令すると偽装請負のリスク，\nエ は「一任」では委託元の管理責任を果たせない。',
    categoryId: 'project-work',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'RoHS 指令（Restriction of Hazardous Substances）は EU が電気・電子機器における特定有害物質（鉛・水銀・カドミウム等）の使用を制限するために制定した指令。\nア ISO 14001 は環境マネジメントシステム規格，\nウ WEEE 指令は廃電気・電子機器の回収・リサイクル指令，\nエ グリーン購入法は日本の法律。',
    categoryId: 'governance',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '公開鍵暗号方式では，各人が公開鍵と秘密鍵の 1 組（2 個）を保有する。\nn 人なら 2n 個の鍵が全体で必要となる（イ）。\n共通鍵暗号は通信ペアごとに 1 個必要で n(n−1)/2 個（ウ）となり，人数に対し O(n^2) で増えるのに対し，公開鍵方式は O(n) で済むのが鍵管理上の利点。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'テンペスト攻撃（TEMPEST）は，ディスプレイ・ケーブル・キーボードなどから漏れる電磁波（漏えい電磁波）を傍受し，表示・処理内容を解析する攻撃。対策は電磁シールドで電磁波を遮断するのが基本。\nア は中間者攻撃（MITM），\nウ はマクロウイルス対策，\nエ は無線 LAN 盗聴対策の説明で，それぞれ別概念。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
