...
export const officialMorningQuestions: OfficialMorningQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ISO 21500== では，==プロジェクトガバナンスを維持する責任== は，==プロジェクトを公式に承認し経営判断を下すスポンサ==，または ==上級経営レベルで指導を行う運営委員会==（==ステアリングコミッティ==）にあるとされる（エ）。\n__ア__ ==プロジェクトマネジメントチーム== は PM の管理面支援。\n__イ__ ==プロジェクトマネージャ== は個別プロジェクトの執行責任者。\n__ウ__ ==顧客== は要求事項提示と成果の享受者。いずれもガバナンス維持の主体ではない。',
    categoryId: 'governance',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK の ==組織のプロセス資産（OPA）== はプロセス／方針／手続き／組織知識ベースが該当し，「==課題と欠陥のマネジメントの手順==」は典型例（ア）。\n一方，以下は ==組織体の環境要因（EEF）== に分類される:\n　__イ__ ステークホルダのリスク許容度\n　__ウ__ インフラストラクチャ\n　__エ__ 組織文化・体制・ガバナンス',
    categoryId: 'project-work',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    choices: ['阿部', '伊藤と佐藤', '鈴木と田中', '野村'],
    correctIndex: 3,
    explanation: '==RACI チャート== における ==説明責任==（A=Accountable）は，==アクティビティに対して 1 人が担う== のが原則。\n__設計行を見ると__:\n　==阿部=R==（実行責任）\n　==伊藤=I==（情報提供）\n　==佐藤=I==（情報提供）\n　==鈴木=C==（相談対応）\n　==田中=C==（相談対応）\n　==野村=A==（説明責任）\nよって A を持つのは ==野村== のみ（エ）。',
    categoryId: 'team',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ブルックスの法則==（Brooks\'s Law, 1975）は「==遅延しているソフトウェアプロジェクトへの人員追加は更なる遅れをもたらす==」というもの（エ）。\n__理由__: 新規要員への ==教育コスト== と ==コミュニケーション工数の増大== が既存メンバの生産性を奪うため。\n__ア・イ・ウ__ はいずれもブルックスの法則とは別の経験則。',
    categoryId: 'team',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==クリティカルチェーン法（CCM）== では，各タスクのバッファを取り除いて ==クリティカルチェーン末尾にまとめて配置__ する「==プロジェクトバッファ==」が中核（イ）。これによりタスク単位の ==サバ読みを防ぎ__，全体でのリスクを吸収する。\n__ア__ 非クリティカルチェーンには ==合流バッファ== を設定する。\n__ウ__ 各タスクごとのバッファ設定は CCM の発想と逆。\n__エ__ 前倒しはバッファを設けず逆方向の戦略で適切でない。',
    categoryId: 'planning',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==CPI = EV/AC < 1.0== は ==コスト超過状態==。是正処置として ==原因を分析し改善策に取り組むとともに，継続的に CPI を監視== するのが適切（ウ）。\n__ア__ は ==CPI < 1.0 をコスト余裕と誤解==。\n__イ__ は計算式が逆（==正しくは EAC = BAC ÷ CPI==）。\n__エ__ は完成時 CPI=1.0 という前提が誤り（実績は変動する）。',
    categoryId: 'measurement',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==発生確率・影響度マトリックス== はリスクの ==「確率」と「影響度」を 2 軸で評価== する ==定性的リスク分析== の代表手法（エ）。\n__ア__ ==感度分析==・__イ__ ==EMV（期待金額価値）==・__ウ__ ==デシジョンツリー分析== はいずれも ==定量的リスク分析== の手法で，数値的な影響を計算する。',
    categoryId: 'uncertainty',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==品質コスト== は以下の 4 区分に分類される:\n　==適合コスト==:\n　　==予防コスト==（教育訓練・標準化など）\n　　==評価コスト==（レビュー・テストなど）\n　==不適合コスト==:\n　　==内部失敗コスト==（出荷前の修正など）\n　　==外部失敗コスト==（クレーム・損害賠償など）\n==品質保証教育訓練費== は ==予防コスト== なので適合コストに属する（ウ）。\n__ア__ ==クレーム調査費== と __イ__ ==損害賠償費== は ==外部失敗コスト==（不適合）。\n__エ__ ==プログラム不具合修正費== は ==内部失敗コスト==（不適合）。',
    categoryId: 'delivery',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '本事例の根本原因は「==全工程終了後に一括検査==」したため設計不良の早期検出ができなかったこと。再発防止には ==各開発工程区切りで成果物を提出させ品質検査・原因究明・是正を行う段階的な品質統制== が必要（イ）。\n__ア__ ==実績評価の減点== だけでは再発防止にならない。\n__ウ__ ==量的報告== だけでは品質の根本欠陥を検出できない。\n__エ__ ==確認頻度を上げても== 検査対象が変わらなければ問題は解決しない。',
    categoryId: 'project-work',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==フールプルーフ== は「==利用者の誤入力・誤操作を未然に防ぐ==」設計思想（ア）。==データチェック== や ==エラーメッセージ== で前提条件を満たさない入力を弾く方針はこれに該当。\n__イ__ ==フェールセーフ== は故障時に安全側に倒す設計。\n__ウ__ ==フェールソフト== は故障時に縮退運転で稼働を続ける設計。\n__エ__ ==フォールトトレラント== は冗長化で故障に耐える設計。それぞれ別概念。',
    categoryId: 'delivery',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==マッシュアップ== は ==公開されている複数のサービス（API）を組み合わせ==，新たな付加価値のサービスを生成する開発手法。==店舗案内に外部の地図検索機能を組み込む== エ が該当（正解）。\n__ア__ は ==プラグイン機能==（ブラウザ拡張）。\n__イ__ は ==Ajax 風 UI== 更新（地図カーソル移動でスクロール）。\n__ウ__ は単なる ==リンク集== で，外部 API 連携によるマッシュアップではない。',
    categoryId: 'development-approach',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==インシデント及びサービス要求管理== プロセスは「==サービスを早期復旧する==」ことが目的で，==インシデントの解決とサービス復旧== が主活動（イ）。原因究明は問題管理に委ね，まずは ==復旧優先==（==ワークアラウンド== 適用も可）。\n__ア__ ==既知の誤り記録（KEDB）== の作成は ==問題管理== の活動。\n__ウ__ ==傾向分析と予防処置== も ==問題管理==（または継続的サービス改善）の領域。\n__エ__ ==根本原因の特定== は ==問題管理== の活動。',
    categoryId: 'service-management',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '非機能要件の ==「使用性（Usability）」== は，==システムが利用者にとって学習しやすく操作しやすい度合い== を示す。==トレーニング時間で操作可能になる学習容易性== は使用性の典型例（ア）。\n__イ__ は ==性能要件==（処理時間）。\n__ウ__ は ==移行要件==（システム切替期間）。\n__エ__ は ==災害対策（BCP／可用性）要件==（RTO）。それぞれ別カテゴリの非機能要件。',
    categoryId: 'delivery',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==不正競争防止法== で保護される ==営業秘密== の 3 要件:\n　==秘密管理性==: 秘密として管理されていること\n　==有用性==: 事業活動に有用であること\n　==非公知性==: 公然と知られていないこと\n==秘密管理されている非公開の顧客名簿== はこの 3 要件を満たす（ウ）。\n__ア__ ==特許権== は ==特許法== で保護（別法律）。\n__イ__ ==頒布されている== ＝公然知られている → 非公知性なし。\n__エ__ ==秘密管理されていない== → 秘密管理性なし。',
    categoryId: 'governance',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==特定電子メール法== は 2008 年改正で ==オプトイン方式== に変更され，==原則として事前に同意を得た者にだけ広告宣伝メールを送信できる==（取引関係等の例外あり）（ウ）。\n__ア__ は同意なしの送信を可能とする説明で，現行法に反する。\n__イ__ は ==旧オプトアウト方式== の説明（改正前のルール）。\n__エ__ は ==自動生成メールアドレス宛の送信そのものが禁止== されている。',
    categoryId: 'governance',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==テンペスト技術==（TEMPEST）は，==ディスプレイ・ケーブル・キーボードなどから漏れる電磁波（漏えい電磁波）を傍受== し，表示・処理内容を解析する技術。\n対策は ==電磁シールドで電磁波を遮断== するのが基本（ア）。\n__イ__ は ==中間者攻撃（MITM）== とディジタル署名検証の対策。\n__ウ__ は ==マクロウイルス== 対策。\n__エ__ は ==無線 LAN 盗聴== と通信暗号化の説明。',
    categoryId: 'service-management',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==SPA==（Software Process Assessment）は ==ISO/IEC 15504（SPICE）== の前身で，==組織のソフトウェアプロセスの能力水準を判定__ し ==継続的改善状況を評価__ することを目的とする枠組み（ア）。\n__イ__ は ==SLCP（JIS X 0160）== の説明。\n__ウ__ は ==ISO 9001 系== の品質保証規格。\n__エ__ は ==PMBOK== の説明。',
    categoryId: 'tailoring-models',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'プロジェクトの開始時は要求が固まっておらず ==関係者の影響力が大きく==，作業が進むにつれ決定事項が増えて ==影響力は減少== する。一方，後期になるほど成果物が固まっており ==要求変更を反映する手戻りコストは増大== する。\nよって __a__ = ==ステークホルダの影響力__（減少），__b== = ==要求変更への対応コスト==（増加）が適切（ア）。\n__イ・ウ・エ__ の組合せはこの傾向と矛盾する。',
    categoryId: 'stakeholder',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==プロジェクト憲章== はプロジェクトを正式に認可し PM に権限を与える文書で，PMBOK では ==「プロジェクト統合マネジメント」== 知識エリアの ==「立上げプロセス群」== で作成する（エ）。\n__ア__ は知識エリアが誤り（コミュニケーションではなく統合）。\n__イ__ は知識エリアもプロセス群も誤り。\n__ウ__ はプロセス群が誤り（計画ではなく立上げ）。',
    categoryId: 'integration',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'PMBOK では ==組織のプロセス資産== を 2 種類に分類:\n　==プロセスと手順==: テンプレート・標準・規程・作業指示書など\n　==企業の知識ベース==: 過去プロジェクトの実績・教訓・履歴情報など\n各プロジェクトのパフォーマンス測定ベースラインや品質ベースラインを含む ==プロジェクトファイル== は ==企業の知識ベース== に該当（イ）。\n__ア__ ==テンプレート== は ==プロセスと手順== 側。\n__ウ__ ==要求事項やコミュニケーション媒体== も ==プロセスと手順== 側。\n__エ__ ==標準化された指示書／測定基準== も ==プロセスと手順== 側。',
    categoryId: 'project-work',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==プログラムマネージャ== は関連する複数のプロジェクトを束ねる ==プログラム単位の責任者== で，==個々のプロジェクトの調和を保つよう支援・指導== する役割を担う（エ）。\n__ア__ ==サプライヤ== は納入者であり成果物を使用する側ではない。\n__イ__ ==スポンサ== は資金提供者で構成アイテム提供者ではない。\n__ウ__ ==納入者== は成果物を提供する側で財政的資源を提供する側ではない。',
    categoryId: 'stakeholder',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ローリングウェーブ計画法== は，==近い将来の作業は詳細化__，==先の作業は上位レベルにとどめておき__，時期が近づき情報が明確化した段階で順次詳細化していく ==段階的詳細化（プログレッシブ・エラボレーション）== の手法（ウ）。\n__ア__ は ==WBS 辞書== の役割（WBS 要素ごとの詳細記述）。\n__イ__ は ==WBS テンプレート__ の活用。\n__エ__ は ==WBS の最下位レベル（ワークパッケージ）定義__ の説明。',
    categoryId: 'planning',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==RACI チャート== は以下の 4 役割／責任を整理する責任分担表（RAM）（ア）。\n　==Responsible==（実行責任）\n　==Accountable==（説明責任）\n　==Consulted==（相談対応）\n　==Informed==（情報提供）\n__イ・ウ・エ__ はいずれも「リスク管理」を含むが，==RACI に「リスク管理」という役割は存在しない== ため誤り。',
    categoryId: 'team',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['9', '11', '12', '14'],
    correctIndex: 1,
    explanation: '各パスの所要日数:\n　A→C = ==11==\n　A→D→E = ==13==\n　B→E = ==15==（クリティカルパス）\n__3 日短縮し 12 日にする手順__:\n　B を 3 日短縮（3 万 × 3 = ==9 万円==）→ クリティカルが A→D→E=13 に移る\n　A を 1 日短縮（==2 万円==）→ A→D→E=12，B→E=12 で全体 12 日\n__合計__: 9 + 2 = ==11 万円==（イ）。\n__ア__ 9 万円は B のみ短縮で A→D→E=13 が残るため未達。\n__ウ__ B 2 日 + E 1 日（6+6=12 万円）。\n__エ__ B 1 日 + E 2 日（3+12=15 万円）。いずれも 11 万円より高い。',
    categoryId: 'planning',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==クリティカルチェーン法（CCPM）== は ==ゴールドラットの制約理論== を応用したスケジュール管理手法で，各作業の安全余裕を以下の 2 種類のバッファに集約する（エ）。\n　==フィーディングバッファ==: 合流点に置く\n　==所要期間バッファ（プロジェクトバッファ）==: 全体最後尾に置く\n==リソース制約も加味したクリティカルチェーン== を守る。\n__ア__ は生産性向上策で別アプローチ。\n__イ__ は ==クラッシング==。\n__ウ__ は ==ファストトラッキング== の説明。',
    categoryId: 'planning',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==差異分析（Variance Analysis）== は ==スコープ・スケジュール・コストのベースラインと実績の乖離を明確化__ し，==原因を特定__ する技法（ウ）。実績報告プロセスでは ==EVM== とともに中核となる。\n__ア__ ==what-if シナリオ分析== は代替シナリオの影響評価。\n__イ__ ==傾向分析== は時系列のパフォーマンス推移分析。\n__エ__ ==モンテカルロ分析== はリスクの確率分布シミュレーションで，ベースラインとの差異把握用ではない。',
    categoryId: 'measurement',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['1.2', '1.5', '1.8', '2.1'],
    correctIndex: 2,
    explanation: '__1 人開発時__: 440 ÷ 40 = ==11 週==，総工数 ==440 人時==。\n__10 人チーム__:\n　コミュニケーション工数 = C(10,2) × 4 = 45 × 4 = ==180 人時/週==\n　1 週の開発投入可能工数 = 40 × 10 − 180 = ==220 人時==\n　完了に必要な週数 = 440 ÷ 220 = ==2 週==\n　総工数 = 10 × 40 × 2 = ==800 人時==\n__コスト比__ = 800 ÷ 440 ≒ ==1.8 倍==（ウ）。',
    categoryId: 'measurement',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==EMV==（Expected Monetary Value，期待金額価値）はリスク事象が顕在化したときの ==影響金額 × 発生確率__ で算出される（ア）。==リスクの定量的分析__ や ==デシジョンツリー分析== で用いる代表的な指標。\n__イ__ は割り算で次元が合わず誤り。\n__ウ・エ__ は対応コストを掛けたり割ったりしており EMV の定義と異なる。',
    categoryId: 'uncertainty',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'PMBOK のリスク対応戦略:\n　==マイナスのリスク（脅威）==: ==回避==・==転嫁==・==軽減==\n　==プラスのリスク（好機）==: ==活用==・==共有==・==強化==\n　==両方共通==: ==受容==\n==受容== は脅威・好機の両方に適用される戦略（ウ）。\n__ア__ ==強化== は ==好機専用== で「マイナスに対して使用」が誤り。\n__イ__ ==共有== は ==好機専用==。\n__エ__ ==転嫁== は ==脅威専用==。',
    categoryId: 'uncertainty',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 3,
    explanation: 'MM=3.0×(KDSI)^{1.12} を変形すると 開発生産性 KDSI／MM = ==(1/3.0)×KDSI^{-0.12}==。\n指数が ==負== なので開発規模が大きくなるほど ==生産性は単調減少__ し，さらに ==-0.12 のべき乗関数__ は規模が大きい領域で ==減少が緩やかになる凸形状== をとる。\nよって ==右下がりで次第に変化が緩やかになるエ== が該当。\n__ア・イ__ は右上がりで誤り。\n__ウ__ は右下がりだが規模拡大に伴い減少が急になる逆向きの形状で誤り。',
    categoryId: 'measurement',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==パレート図== は ==項目別の出現度数を大きい順に棒グラフで並べ累積比率の折れ線を重ねた図== で，「==重要な少数==」を識別し主要原因を絞り込むために用いる（==80/20 の法則==）（イ）。\n__ア__ は ==管理図==（時系列＋管理限界）。\n__ウ__ は ==散布図==（相関）。\n__エ__ は ==特性要因図==（フィッシュボーン）の説明。',
    categoryId: 'delivery',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '__手順 1__ 発見されたエラー 30 個のうち 20 個が埋込みエラーなので発見率は 20 ÷ 100 = ==0.2==。\n__手順 2__ 真のエラーも同じ発見率と仮定すると，発見済 10 個から推定される真のエラー総数は 10 ÷ 0.2 = ==50 個==。\n__手順 3__ 埋込み分を除く残存エラー = 50 − 10 = ==40 個==（ア）。',
    categoryId: 'delivery',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['構造化プログラミング', 'コンポーネント指向プログラミング', 'ビジュアルプログラミング', 'ペアプログラミング'],
    correctIndex: 3,
    explanation: '==XP（Extreme Programming）== は ==ケント・ベック== が提唱したアジャイル開発手法で，==ペアプログラミング==・==テスト駆動開発==・==継続的インテグレーション==・==リファクタリング==・==小さなリリース== などのプラクティスを採用する（エ）。\n__ア__ ==構造化プログラミング== は伝統的設計手法。\n__イ__ ==コンポーネント指向== は別系統。\n__ウ__ ==ビジュアルプログラミング== は GUI ベースの開発手法で，いずれも XP のプラクティスではない。',
    categoryId: 'development-approach',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '開発方針と開発モデルの対応:\n　a 要求が明確で全機能を一斉開発 → ==ウォータフォールモデル==\n　b コア部分を先に作り順次機能を追加 → ==段階的（インクリメンタル）モデル==\n　c 開発を繰り返しながら徐々に要求内容を洗練 → ==進化的（イテレーティブ／スパイラル）モデル==\nよって組合せは ==a:ウォータ，b:段階的，c:進化的==（イ）。\n__ア・ウ・エ__ は b と c の対応が逆もしくは a の位置がずれており誤り。',
    categoryId: 'development-approach',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==ITIL v3 のサービスライフサイクル== は以下の 4 段階に「==継続的サービス改善==」が全段階を横断する形で構成される（イ）。\n　a ==サービスストラテジ==（全体戦略を確立）\n　b ==サービスデザイン==（事業要件を満たすサービスを設計）\n　c ==サービストランジション==（変更を本番環境に展開）\n　d ==サービスオペレーション==（運用・サポート）\n__ア・ウ・エ__ は順序が異なり誤り。',
    categoryId: 'service-management',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    choices: ['案1', '案2', '案3', '案4'],
    correctIndex: 2,
    explanation: '効果 = Σ(評価 × 重み)，リスクも同様に算出し，==総合 = 効果 − リスク== を求める。\n__案 1__: 効果 3×4+2×2+5×3 = 31，リスク 2×8+4×3 = 28，総合 ==3==\n__案 2__: 効果 4×4+4×2+4×3 = 36，リスク 4×8+1×3 = 35，総合 ==1==\n__案 3__: 効果 5×4+2×2+2×3 = 30，リスク 1×8+5×3 = 23，総合 ==7==\n__案 4__: 効果 2×4+5×2+4×3 = 30，リスク 5×8+1×3 = 43，総合 ==−13==\n総合が最も高いのは ==案 3 の 7 点==（ウ）。',
    categoryId: 'governance',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ランニングロイヤリティ== は ==特許発明の実施実績==（売上高や生産数量など）に応じて算定される ==従量制の使用料== で，==一時金で支払うイニシャルロイヤリティ== とは区別される（ウ）。\n__ア__ は ==技術料==（テクニカルアシスタンスフィー）。\n__イ__ は ==イニシャルロイヤリティ==。\n__エ__ は ==メンテナンス料金==。いずれも実施実績に連動しない。',
    categoryId: 'governance',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==下請代金支払遅延等防止法 3 条== は，親事業者に対し発注時に ==給付内容・代金額・支払期日・支払方法等を明記した書面（3 条書面）の交付== を義務付けている。==仕様未記載のまま発注書面を交付し，仕様確定後に口頭でのみ伝える行為== は 3 条書面義務に反し禁止されている（ウ）。\n__ア__ は共通事項を基本契約等で別途明示している場合の省略で許容。\n__イ__ は協議に基づく代金加算で正当な変更。\n__エ__ は事前合意のある実費範囲内の手数料差引で許容される。',
    categoryId: 'governance',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==コンティンジェンシープラン（緊急時対応計画）== は ==全システムを一律に対象とするのではなく==，==業務影響度と復旧の重要性／緊急性を勘案して対象を絞り込み==，優先度の高いものから対策を講じる（ア）。\n__イ__ は ==バックアップ媒体をセンター外（遠隔地）に保管== するのが原則で同一拠点保管はリスク回避策として不適切。\n__ウ__ はバックアップ対象を ==機密度ではなく業務継続性で選定== すべき。\n__エ__ はコンティンジェンシープランは ==「事後対応」を策定== するもので「予防策策定手順」とは目的が異なる。',
    categoryId: 'uncertainty',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==SMTP サーバの第三者中継（オープンリレー）== を許可するとスパム送信や踏み台に悪用されるため，==社外発・社外宛のメールを中継しないよう設定__ する（自ドメイン宛のみ受信／自ドメイン送信元のみ中継）のが SMTP 不正利用防止の基本対策（イ）。\n__ア__ は ==DNS サーバ__ の対策。\n__ウ__ は ==Web サーバのディレクトリリスティング__ 対策。\n__エ__ は ==Web サーバの CGI 実行制限__。',
    categoryId: 'service-management',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==SSL／TLS のクライアント認証用ディジタル証明書== は ==IC カードや USB トークンなどの耐タンパ装置に格納可能__ で，==特定の PC に紐づける必要はなくユーザ単位で運用__ できる（イ）。\n__ア__ サーバ証明書のコモンネームには ==FQDN（ホスト名）== を用い IP アドレスの組込みは必須ではない。\n__ウ__ SSL は ==不特定多数の利用者間の通信を保護するオープンな仕組み__ で事前の利用者登録は不要。\n__エ__ 日本国内に SSL の鍵長を ==128 ビット未満に制限する法規制はない__（過去の米国輸出規制も既に撤廃済）。',
    categoryId: 'service-management',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'プロジェクトに関わる ==ステークホルダ__ はプロジェクトの実施・成果に利害をもつ個人・組織で，==成果が自らの利益になる者（受益者）== と ==不利益になる者（被影響者）== の両方が存在し得る（ウ）。\n__ア__ は ==組織内外を問わずステークホルダ__ となる（顧客・規制当局・地域社会等は外部）。\n__イ__ は ==直接参加せず間接的に影響する関係者__ もステークホルダ。\n__エ__ は ==組織や集団としてのステークホルダ__ もあり個人として特定できる必要はない。',
    categoryId: 'stakeholder',
  ...
  },
  {
    ...
    choices: ['0.2', '0.5', '1.9', '5.2'],
    correctIndex: 0,
    explanation: '生産性 L／E は L／(5.2×L^{0.98}) = ==(1/5.2)×L^{0.02}==。\nL=10 を代入すると (1/5.2)×10^{0.02} ≒ 0.192 × 1.047 ≒ ==0.20 キロ行／人月==（ア）。\n__イ・ウ・エ__ はいずれも E＝5.2L^{0.98} の関係から導出できない値。',
    categoryId: 'measurement',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'プロジェクトが ==完了に近づくほど成果物の仕様や設計が固まり，機能の不確実性は減少__ する（PMBOK のライフサイクル特性）（イ）。\n__ア__ ==要員数__ は初期少・中期最大・終結減少の ==ベル型__。\n__ウ__ ==ステークホルダ影響度__ は完了直前ほど低くなる（変更余地が少ない）。\n__エ__ ==変更／エラー修正の影響度__ は完了に近づくほど ==手戻りコストは増加__ する。',
    categoryId: 'project-work',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==プロジェクト憲章__ は ==立上げプロセス群__ でプロジェクトを認知・承認するために作成する文書で，==要求事項・目的・妥当性・全体スケジュール・PM と権限レベル__ を記載する（エ）。\n__ア__ は ==プロジェクトマネジメント計画書__（計画プロセス群の集合体）。\n__イ__ は ==プロジェクトスコープ記述書__（境界・受入基準）。\n__ウ__ は ==WBS__（階層構造）の説明。',
    categoryId: 'integration',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ワークパッケージ__ は ==WBS の最下位レベルの要素__ で，さらにスケジュール作成のために ==アクティビティ（活動）に分解__ される（ウ）。\n__ア__ ==OBS との対応関係__ は責任分担マトリックスで扱い WP の定義ではない。\n__イ__ ワークパッケージは ==関連する作業のまとまり__ であって成果物そのものをまとめたものではない。\n__エ__ 上位の要素成果物と ==1 対 1 とは限らず__ 複数のワークパッケージから構成される場合もある。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==プロジェクトスコープ記述書== は，==プロジェクトの要素成果物（プロダクトスコープ）== と，==その成果物を生み出すために必要な作業（プロジェクトスコープ）== の両方を記述する文書（ウ）。\n__ア__ は ==WBS が出力== で，スコープ記述書はその入力側であって逆の関係。\n__イ__ はスコープに ==「含まれないもの」（除外事項）も明示== するのがスコープ記述書の役割の一つ。\n__エ__ は ==予算見積りやスケジュール策定== は別プロセスのアウトプットで，スコープ記述書には記述しない。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==クリティカルチェーン法== では各タスクの安全余裕を集約した ==プロジェクトバッファ== を設け，==バッファ消費量を「安全」「警告」「対策」の 3 ゾーンで管理== する。==安全区域内のバッファ消費は許容範囲== なので特別な対策は不要（ア）。\n__イ__ クリティカルチェーンを頻繁に見直すと統制が乱れる。\n__ウ__ 個々タスクの終了報告のみでは進捗が遅すぎる（残作業ベースで頻繁に把握）。\n__エ__ ==マイルストーン管理== は伝統的手法で CCPM の特徴ではない。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['2', '3', '4', '5'],
    correctIndex: 0,
    explanation: '各ノードの最早時刻を計算すると 1:0，2:3，3:3，5:8，4:max(2+c=7, 5+ダミー=8) = 8，6:13，7:max(3+e=5, 8+g=12) = 12，8:max(6+h=17, 7+i=15) = ==17== でクリティカルパスは b→d→ダミー→f→h = ==17 日==。\nクリティカル外の a・c・e・g・i にはフロートがあるため，==最短 17 日を維持しつつ開始を遅らせて並行作業数を最小化== できる。例えば a:1〜4，b:0〜3，c:4〜8，d:3〜8，f:8〜13，g:8〜12，e:12〜14，h:13〜17，i:14〜17 と配置すれば全期間で ==同時稼働は最大 2 名==（ア）に抑えられる。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==クラッシング== はクリティカルパス上の活動に ==追加資源（要員・残業など）を投入してコストを掛けて所要期間を短縮== する技法（ア）。\n__イ__ は ==資源コスト削減策== で短縮策ではない。\n__ウ__ は ==完了延期== で短縮ではない。\n__エ__ は ==ファストトラッキング==（先行作業の終了を待たずに後続を並行実施）の説明。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['0', '4', '7', '14'],
    correctIndex: 2,
    explanation: '各作業の ==最早終了時刻==:\n　A:4，B:9，C:12，D:5，E:max(12,5)+2 = 14\n__E の先行__ は C（終了 12）と D（終了 5）なので E は時刻 ==12 から開始==。\n__D の最遅終了__ は E 開始時刻 = 12 まで許容されるため，D の最遅開始は 12 − 1 = ==11==。\n__総余裕__ = 最遅開始 − 最早開始 = 11 − 4 = ==7 日==（ウ）。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 2,
    explanation: '__順調な状態の条件__:\n　==コスト超過しない__ → ==AC ≤ EV__（実コストが完了出来高以下）\n　==納期に遅れない__ → ==EV ≥ PV__（出来高が計画値以上）\n両方を満たすのは ==EV ≥ PV ≥ AC__ の順序で，==アーンドバリュー（EV）が最も高く実コスト（AC）が最も低い__ グラフ（ウ）が該当。\n__ア__ は AC 最大で EV ＞ PV，コスト超過＋進捗先行で条件不満足。\n__イ__ は AC ＞ PV ＞ EV でコスト超過＋進捗遅れ。\n__エ__ は PV ＞ EV ＞ AC で進捗遅れ。',
    categoryId: 'measurement',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    choices: ['選択肢アの分類', '選択肢イの分類', '選択肢ウの分類', '選択肢エの分類'],
    correctIndex: 2,
    explanation: '==IFPUG 法== では機能を 2 種類に分類する（ウ）:\n　==データファンクション==\n　　==ILF==（内部論理ファイル）\n　　==EIF==（外部インタフェースファイル）\n　==トランザクションファンクション==\n　　==EI==（外部入力）\n　　==EO==（外部出力）\n　==EQ==（外部照会）\n__ア・イ・エ__ はデータ／トランザクションの分類が誤っている。',
    categoryId: 'measurement',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==保守性（Maintainability）__ は ==故障発見後にどれだけ速く修正できるか__ を示す指標で，==修正時間の合計 ÷ 修正件数__（平均修復時間 ==MTTR== 系の指標）が該当する（イ）。\n__ア__ は ==信頼性__（誤り密度）。\n__ウ__ は ==移植性__（変更行数比率）。\n__エ__ は ==機能適合性／要求変更率__ に関する指標。',
    categoryId: 'delivery',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['阿部', '伊藤と佐藤', '鈴木と田中', '野村'],
    correctIndex: 3,
    explanation: '==RACI チャート== で設計アクティビティの行を見ると 阿部=R（==実行責任==），伊藤=I（==情報提供==），佐藤=I，鈴木=C（==相談対応==），田中=C，野村=A（==説明責任==）。\nよって設計の説明責任を持つのは ==野村ただ 1 名==（エ）。==RACI では 1 つのアクティビティの説明責任者（A）は原則 1 名に限定== される。',
    categoryId: 'team',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['120', '150', '200', '240'],
    correctIndex: 2,
    explanation: '__EMV(A)__ = 0.6X + 0.4×90 − 120 = ==0.6X − 84==\n__EMV(B)__ = 0.6×120 + 0.4×60 − 60 = 72 + 24 − 60 = ==36==\n__A ＞ B__ の条件は 0.6X − 84 ＞ 36，整理して 0.6X ＞ 120，==X ＞ 200==（ウ）。\nよって X が 200 万円を超える場合にツール A の方が EMV が大きい。',
    categoryId: 'uncertainty',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==アクセシビリティ確保== の観点では，==マウスが使えない利用者にも操作可能== とする必要があり，==Tab キーでフォーカス移動・Enter キーでリンク選択== といったキーボード操作対応が基本要件（ア）。\n__イ__ は項目名と入力欄の配置で，読み上げ順や視覚レイアウトの問題でアクセシビリティ要件には合致しない。\n__ウ__ は ==単語途中の空白== がスクリーンリーダーで誤読されアクセシビリティを損なう。\n__エ__ は ==色（赤色）のみで情報を伝える方式== で色覚特性に対応できずアクセシビリティに反する。',
    categoryId: 'delivery',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==SOA__ はサービス間の独立性を高めるため ==疎結合（loose coupling）__ で設計し，業務変更時の影響範囲を局所化する（ウ）。\n__ア__ ==ステートフル__ は独立性・スケーラビリティを下げるため SOA では ==ステートレスが原則__。\n__イ__ サービス名は ==役割ではなくビジネス機能（業務内容）を表すように命名__ する。\n__エ__ ==再利用性__ は SOA の中核的な目的で「再利用しない方がよい」は誤り。',
    categoryId: 'development-approach',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==スパイラルモデル== は ==設計 → プロトタイプ → 評価 → 次サイクル設計== のように段階的に機能を追加・洗練し，==各繰返しの段階でユーザの要求を確認・確定== していく開発モデル（イ）。\n__ア__ ==ウォータフォール== は後工程で誤りが顕在化しやすく初期段階で全てを判明させるのは困難。\n__ウ__ ==プロトタイピング== は要求仕様確定のためにエンドユーザの参加が不可欠。\n__エ__ ==スパイラルモデル== はプロトタイプ前提ではなく，==リスク駆動でプロトタイプを用いる場合もある== という位置付け。',
    categoryId: 'development-approach',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==フェールソフト__ は ==障害発生時に機能や性能を縮退させつつ運転を継続__ させる設計思想で，「==パフォーマンス低下を許容しサービスを継続__」する事例（ウ）が該当。\n__ア・イ__ は障害発生時に ==安全な停止__ を選ぶ ==フェールセーフ__。\n__エ__ は ==誤操作を未然に防ぐフールプルーフ__ の説明。',
    categoryId: 'service-management',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==複数ファイルに分散したデータ__ は個々のファイルを単独にバックアップすると ==ファイル間の整合性が崩れる__ ため，==一連の更新処理が完了した整合性ある時点でまとめてバックアップ__ するのが適切（エ）。\n__ア__ ==バックアップを消去__ すると過去復旧不能になる。\n__イ__ 全データを取得しないと ==差分／増分の基準が失われ__ 復旧時に整合しない。\n__ウ__ ==同一媒体上書き__ は媒体障害や上書き失敗時に復旧手段を失うため不可。',
    categoryId: 'service-management',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==非機能要件== はシステムが「==どのように==」振る舞うかに関する要件で，==性能・可用性・操作性（ユーザビリティ）・セキュリティ・保守性== などが含まれる。「==システムの操作性==」は非機能要件に該当する（ウ）。\n__ア__ ==業務範囲== は機能要件。\n__イ__ ==情報（データ）の流れ== は機能要件（処理／データフロー）。\n__エ__ ==インタフェースのレイアウト== は機能要件側の仕様。',
    categoryId: 'delivery',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==国際エネルギースターロゴ__ は米国 EPA が制定した ==オフィス機器（PC・プリンタ・複合機等）の省エネ性能基準__ に適合した製品に付与される環境ラベルで，==稼働時／待機時の消費電力基準__ を満たすことを示す（ウ）。\n__ア__ ==FSC__ は森林管理協議会の森林認証（木材製品向け）。\n__イ__ ==グリーンマーク__ は古紙再生紙利用製品向け。\n__エ__ ==統一省エネラベル__ は家電製品（エアコン・冷蔵庫等）の省エネ性能表示制度で情報機器向けではない。',
    categoryId: 'governance',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['ISO 14001', 'RoHS 指令', 'WEEE 指令', 'グリーン購入法'],
    correctIndex: 1,
    explanation: '==RoHS 指令__（Restriction of Hazardous Substances）は ==EU が 2006 年に施行__ した指令で，==電気・電子機器における鉛・水銀・カドミウム・六価クロム・PBB・PBDE 等の特定有害物質__ の使用を基準値以下に制限する（イ）。\n__ア__ ==ISO 14001__ は環境マネジメントシステムの国際規格で物質規制ではない。\n__ウ__ ==WEEE 指令__ は廃電気電子機器のリサイクル責任を規定する別指令。\n__エ__ ==グリーン購入法__ は日本の法律で公的機関の環境物品調達促進が主目的。',
    categoryId: 'governance',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==個人情報保護法__ における個人情報は「==生存する個人に関する情報であって，特定の個人を識別できるもの__」と定義され，==亡くなった個人の情報は原則として対象外__（ウ）。\n__ア__ ==企業の顧客に限らず__ 従業員・取引先個人なども含む。\n__イ__ ==秘密にしているプライバシー情報に限らず__ 公知情報でも識別可能なら個人情報。\n__エ__ ==国籍は問わず__ 日本国内に居住する外国人も保護対象に含まれる。',
    categoryId: 'governance',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==日本工業標準調査会（JISC）== は ==経済産業省に設置された審議会== で，==工業標準化法に基づき工業標準化に関する調査・審議== を行い，特に ==JIS（日本工業規格）の制定・改正・廃止== に関する審議を担う（ア）。\n__イ__ は ==IEEE==（米国電気電子学会）。\n__ウ__ は ==電気規格調査会（JEC 規格）==。\n__エ__ は ==JEITA==（電子情報技術産業協会）の説明。',
    categoryId: 'governance',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
]
