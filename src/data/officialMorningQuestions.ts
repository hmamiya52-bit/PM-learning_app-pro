...
export const officialMorningQuestions: OfficialMorningQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'クリティカルチェーン法は，資源制約と不確実性に対応するため，非クリティカルチェーンの合流点に合流バッファを，クリティカルチェーン末尾にプロジェクトバッファを置く手法。ア・イ はクリティカルパス法上の生産性向上策・クラッシング，\nウ はファストトラッキング（並行化）の説明。',
    categoryId: 'planning',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK第5版において，組織のプロセス資産（OPA）はプロセス／方針／手続き／組織知識ベースが該当し，「課題と欠陥のマネジメントの手順」は典型例。一方，\nイ ステークホルダのリスク許容度，\nウ インフラ，\nエ 組織文化・体制・ガバナンスはいずれも「組織体の環境要因（EEF）」に分類される。',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '是正処置（Corrective Action）は，既に発生した不適合をパフォーマンスを計画に戻す処置。スケジュール遅延を解消するために要員追加する イ が該当。\nア は将来の不適合を予防する「予防処置」，\nウ は不適合な成果物を修正する「欠陥修正」，\nエ はスコープ変更要求（規制変更による新規アクティビティ追加）。',
    categoryId: 'integration',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ローリングウェーブ計画法（Rolling Wave Planning）は段階的詳細化の手法で，近い将来の作業は詳細に，遠い将来の作業は上位レベルで保留し，詳細が明確になってから要素分解する。\nア は WBS 辞書の役割，\nイ はテンプレート利用，\nエ は通常の要素分解の説明。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'PMBOK においてワークパッケージは WBS の最下層要素で，スケジュール作成時にさらにアクティビティへ分解される。\nア OBS は別の分解構造で WP の定義ではない，\nイ ワークパッケージは「まとめ」ではなく，まとめは上位の WBS 要素，\nエ 多対1（複数 WP が 1 つの上位成果物を構成）の関係。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['阿部', '伊藤と佐藤', '鈴木と田中', '野村'],
    correctIndex: 3,
    explanation: 'RACI チャートにおける説明責任（A=Accountable）は，1 つのアクティビティに対して 1 人が担うのが原則。\n設計行を見ると 阿部=R，伊藤=I，佐藤=I，鈴木=C，田中=C，野村=A となっており，A を持つのは野村のみ（エ）。\nア 阿部は実行責任（R），イ 伊藤と佐藤は情報提供（I），ウ 鈴木と田中は相談対応（C）。',
    categoryId: 'team',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['安定期 (Norming)', '遂行期 (Performing)', '成立期 (Forming)', '動乱期 (Storming)'],
    correctIndex: 3,
    explanation: 'タックマンモデルは Forming（成立期）→ Storming（動乱期）→ Norming（安定期）→ Performing（遂行期）→ Adjourning（解散期）の 5 段階で進む。価値観や考え方の違いが顕在化してメンバが意見を主張し合うのは Storming（動乱期）の特徴。\nア Norming は対立解消・ルール形成，\nイ Performing は高パフォーマンス，\nウ Forming は様子見・遠慮の段階。',
    categoryId: 'team',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'クラッシングは，コスト増を許容してクリティカルパス上の作業に資源（人員・設備）を追加投入し，スケジュールを短縮する技法。\nア はまさにこの定義に合致。\nイ は単なるコスト削減策で短縮の話ではない，\nウ は単なる延期，\nエ は先行作業の完了を待たず並行化するファストトラッキングの説明。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['15', '16', '17', '18'],
    correctIndex: 1,
    explanation: '専門チームの支援は同時に 1 アクティビティしか行えないので，支援の競合解消が制約になる。\nA を 1〜10 日（支援 1〜4 日），C を支援が空く 5〜14 日（支援 5〜8 日）に配置し，\nB は A 終了後の 11〜15 日（支援 11〜12 日），D は支援が空く 13〜16 日に置けば 16 日で完了する。\n各アクティビティの支援要件と先行関係を満たす最少日数として 16 日（イ）が成立する。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ベロシティはチームの生産性を測る経験値で，1 スプリントで完了（製造・妥当性確認・受入）したストーリーポイント等の合計値を示す。\nア はストーリーポイント，\nイ はプロダクトバックログ，\nウ はバーンダウンチャートの説明。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    choices: ['350', '470', '480', '500'],
    correctIndex: 1,
    explanation: 'ピーク 11 台のうち継続して使う PC を 4 グループに分け，受入時 2 週間と返却時 1 週間のレンタル計上を加味して最小化する。\nPC1〜2（1 月セットアップ＋2〜11 月稼働＋12 月消去） = 12 か月 × 2 = 24，\nPC3〜4（2 月セット＋3〜11 月＋12 月） = 11 × 2 = 22，\nPC5〜7（3 月セット＋4〜9 月＋10 月） = 8 × 3 = 24，\nPC8〜11（5 月セット＋6〜9 月＋10 月） = 6 × 4 = 24。\n合計 94 か月 × 5 千円 = 470 千円（イ）。',
    categoryId: 'project-work',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'マッシュアップは公開されている複数のサービス（API）を組み合わせ，新たな付加価値のサービスを生成する開発手法。店舗案内に外部の地図検索機能を組み込むエ が該当。\nア はプラグイン機能，\nイ は Ajax / AJAX 風 UI，\nウ は単なるリンク集で，外部 API 連携によるマッシュアップではない。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'リファクタリングは「外部から見た振る舞い（機能）を変えず，内部構造を改善して保守性・可読性・拡張性を高める」コード改善作業。XP のプラクティスとして広まった。\nイ はリバースエンジニアリング，\nウ はコンポーネントベース開発（CBD），\nエ は回帰テスト（リグレッションテスト）の説明。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'フルバックアップ間隔を 2 倍にすると，前回フルバックアップから現在までの間に蓄積されるログ量が約 2 倍となり，復旧時のログ反映時間も約 2 倍になる。ア・イ フル取得 1 回あたりの磁気テープ使用量は DB サイズで決まるためほぼ一定，\nウ フル取得自体の処理時間も DB サイズ依存で取得間隔と無関係。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'DA（Data Administrator）はデータそのものの全社視点の管理者で，論理データベース設計やデータ項目の標準化を担う。一方 DBA（Database Administrator）はデータベースという物理製品の管理者で，\nア の容量計画・ディスク増設，\nウ のパフォーマンスチューニング，\nエ の障害復旧などを担当する。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '経産省「情報システム・モデル取引・契約書」では，要件定義フェーズ（a）と運用テストフェーズ（d）は，業務上の判断や利用者側の主体的活動が中心となるため準委任型を推奨する（イ）。\n一方，設計・実装・結合・システムテスト（b・c）は成果物が明確で完成義務を負わせやすいため請負型が中心となる。',
    categoryId: 'project-work',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '36 協定（労働基準法 36 条）は，時間外労働・休日労働についての労使協定を書面で締結し，労働基準監督署に届け出ることで法定労働時間を超える時間外労働を可能にする制度。\nア は裁量労働制，\nイ は変形労働時間制（1 か月単位），\nエ はフレックスタイム制の説明。',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '派遣先責任者は派遣先における派遣労働者の適正な就業確保のため，指揮命令者へ関連法規・派遣契約内容・派遣元からの通知などを周知する義務を負う。\nア 人事記録と考課は派遣元事業主の役割，\nイ 派遣就業場所が複数なら原則として場所ごとに選任する必要あり，\nウ 管理職位の者から選任する必要は法定要件ではない。',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'CSIRT（Computer Security Incident Response Team）は，企業や行政機関などに設置され，セキュリティインシデントの検知・対応・復旧・再発防止を担う組織。\nア はプライバシーマーク制度認定機関（JIPDEC），\nウ は CRYPTREC（暗号技術評価），\nエ は NISC（内閣サイバーセキュリティセンター）の説明。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ペネトレーションテストは，攻撃者の視点でファイアウォール・公開サーバ等に対し実際の侵入を試み，脆弱性を検出する動的セキュリティ検査。\nア は暗号仕様の適合性確認，\nイ は機能テスト，\nウ は性能テストで，いずれも侵入試行ではない。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'SPA（Software Process Assessment, ISO/IEC 15504/SPICE）は組織のソフトウェアプロセスの能力水準を評価し，継続的改善のために用いる国際標準。\nイ は JIS X 0160（ソフトウェアライフサイクルプロセス），\nウ は ISO 9001 系，\nエ は PMBOK の説明。',
    categoryId: 'development-approach',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '【公式誤問・改題版の解説】スコープベースラインは，スコープ記述書・WBS・WBS辞書から構成されるベースラインで，コスト見積もりの主要インプットとなる。また品質マネジメント計画でも PM 計画書の一部として参照される。\nア 人的資源計画書はチーム編成用，\nウ ステークホルダ登録簿は関与計画用，\nエ 品質尺度は品質計画のアウトプットで，いずれも本問の条件には合致しない。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'プロジェクトの不確実性は情報が少ない開始時に最も高く，進行とともに低下する。\nア は逆でステークホルダ影響力は開始時が最大，\nウ は要員数は中盤が最大で典型的な S 字曲線を描く，\nエ は逆で変更・エラー訂正コストは終盤が最大（手戻り影響範囲が広いため）。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'プロジェクトを公式に承認する文書はプロジェクト憲章で，承認権限を持つのはプロジェクトスポンサー。PM は憲章により任命される側なので PM が承認する選択肢（ア・ウ）は不適切。\nエ プロジェクトマネジメント計画書は承認後に PM が作成する文書で，プロジェクト開始の公式承認文書ではない。',
    categoryId: 'integration',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'スコープコントロールはプロジェクトの作業範囲（スコープ）への変更を管理する活動。\nウ は外部システム連携作業を「本プロジェクトのスコープから除外する」スコープ変更で該当。\nア はスケジュールマネジメント，\nイ はコストマネジメント，\nエ は資源マネジメントの活動で，スコープへの変更ではない。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'RACI チャートは R=Responsible（実行責任），A=Accountable（説明責任），C=Consulted（相談対応），I=Informed（情報提供）の 4 役割を割り当てる責任分担マトリックス。「リスク管理」を含む選択肢はいずれも誤り。',
    categoryId: 'team',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '資源カレンダー（Resource Calendar）は資源が利用可能な作業日・シフト・休暇・繁忙期を示す情報源で，所要期間見積もりにおいて資源確保可能日を把握するために使う。\nア は資源見積り，\nイ は RBS（資源ブレークダウン）の役割，\nエ は過去類似プロジェクト情報による類推見積りの活動。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 2,
    explanation: 'コスト超過せず納期にも遅れない順調な状態は CPI = EV/AC > 1.0 かつ SPI = EV/PV > 1.0，すなわち現時点で EV が AC と PV の両方より大きいグラフ（ウ）が該当。\nア は AC > EV でコスト超過，\nイ は AC > PV > EV でコスト超過＋スケジュール遅延，\nエ は PV > EV > AC でスケジュール遅延。',
    categoryId: 'measurement',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '傾向分析（trend analysis）は，時間の経過に伴うプロジェクトのパフォーマンス（コスト・スケジュール・品質指標等）の変動を分析する技法。\nア はデシジョンツリー分析，\nイ は感度分析（影響度分析），\nエ は特性要因図（フィッシュボーン）の説明。',
    categoryId: 'measurement',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 3,
    explanation: '開発生産性 = KDSI ÷ MM = KDSI ÷ (3.0 × KDSI^{1.12}) = KDSI^{−0.12} ÷ 3.0。指数が −0.12 なので規模増加に伴って生産性は単調に低下し，かつ低下の度合いは次第に緩やかになる。右下がりで次第に緩やかな曲線（エ）が正解。',
    categoryId: 'measurement',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'デルファイ法は，複数の専門家から匿名・独立のアンケートを集めて要約し，再度アンケートを行うサイクルを反復することで意見の収束を図る技法。匿名性と反復が特徴。\nア はインタビュー（一回限り），\nウ はブレーンストーミング／合議制，\nエ は SWOT 分析の説明。',
    categoryId: 'uncertainty',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '定性的リスク分析は，個別リスクの発生確率と影響度を査定して優先順位付けし，その結果でリスク登録簿を更新するプロセス。\nア 感度分析は定量的リスク分析の技法，\nイ 優先順位付けは定性分析の結果で行う（定量分析の結果ではない），\nウ リスク特定は別プロセスで対応計画ではなく実績データに基づく。',
    categoryId: 'uncertainty',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '受容（Accept）は脅威・好機の両方に適用される戦略で，特別な対応をせず顕在化時に対処する。\nア 強化（Enhance）は好機側の戦略，\nイ 共有（Share）は好機側のみ，\nエ 転嫁（Transfer）は脅威側のみで，それぞれ説明が逆になっている。',
    categoryId: 'uncertainty',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'JIS X 0160 では，ソフトウェア方式設計（外部設計に相当）プロセスにおいて，ソフトウェア結合のための暫定的なテスト要求事項とスケジュールを定義・文書化することを規定している。V 字モデルで「設計工程で対応するテスト工程の計画を立てる」考え方と整合する。',
    categoryId: 'development-approach',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'フェールセーフは故障時にシステムを安全側に倒す設計思想。信号機の故障時に赤を点灯し車両停止を促す イ が該当。\nア は誤接続を未然に防ぐフールプルーフ，\nウ は縮退運転で稼働を続けるフェールソフト，\nエ は冗長化による耐故障性向上（フォールトトレラント／信頼性向上）。',
    categoryId: 'delivery',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'CMMI（Capability Maturity Model Integration）は，組織のプロセス改善のためのベストプラクティス手引きで，5 段階の成熟度モデルにより組織能力を評価・改善する枠組みを提供する。\nア は CASE ツール，\nイ は共通フレーム（SLCP-JCF），\nエ は ISO 9001 系の品質保証規格の説明。',
    categoryId: 'development-approach',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['構造化プログラミング', 'コンポーネント指向プログラミング', 'ビジュアルプログラミング', 'ペアプログラミング'],
    correctIndex: 3,
    explanation: 'XP（エクストリームプログラミング）の主なプラクティスにはペアプログラミング・テスト駆動開発（TDD）・リファクタリング・継続的インテグレーション・シンプル設計などがある。\nア の構造化プログラミングは古典的な制御構造のスタイル，イ・ウ はそれぞれコンポーネント再利用やビジュアル開発の概念で，XP 固有のプラクティスではない。',
    categoryId: 'development-approach',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'ITIL v3 のサービストランジション段階は，設計されたサービスを本番環境に移行し，要件・制約に沿って確実に稼働させることが目的。変更管理・リリース管理・展開管理などを含む。\nイ は CSI（継続的サービス改善），\nウ はサービス設計，\nエ はサービス戦略段階の説明。',
    categoryId: 'service-management',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'フェールソフトは，障害発生時に構成を縮小しつつパフォーマンスが低下しても運転を継続する設計思想（縮退運転）。ア・イ は障害時に「安全に停止」させるフェールセーフ，\nエ は誤入力・誤操作を未然防止するフールプルーフの説明。',
    categoryId: 'delivery',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ROI（Return on Investment）= 収益 ÷ 投資額 の比率で評価する手法。簡便だが時間価値を考慮しない欠点がある。\nア は NPV（正味現在価値），\nイ は回収期間法（ペイバック），\nウ は IRR（内部収益率）の説明で，それぞれ別概念。',
    categoryId: 'governance',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '労働基準法 106 条は使用者に対し，就業規則を労働者へ周知する義務（掲示・備付け・書面交付・電子データの提供等）を課している。\nア は逆で就業規則を下回る個別合意は無効（労働契約法 12 条），\nウ は逆で常時 10 名以上では行政官庁への届出義務あり（労基法 89 条），\nエ は逆で労働者代表の意見聴取が必要（労基法 90 条）。',
    categoryId: 'governance',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'シャドー IT は，IT 部門の公式な承認を得ずに従業員や部門が独自に導入・利用するデバイスやクラウドサービスを指す。BYOD の浸透やクラウドサービスの普及に伴いセキュリティリスクとして顕在化。\nア はグリーン IT，\nウ はショルダーハッキング，\nエ はフットプリンティング（情報収集）の説明。',
    categoryId: 'service-management',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'DNSSEC は，DNS リソースレコードに認証局相当の鍵によるデジタル署名を付け，リゾルバ側で署名検証することで送信者の正当性とデータの完全性を保証する仕組み。\nア はオープンリゾルバ問題に逆行する設定で攻撃悪用される側，\nウ はセカンダリ DNS による冗長化（可用性向上）で DNSSEC とは別技術，\nエ は TSIG（Transaction SIGnature）による DNS 更新認証の説明。',
    categoryId: 'service-management',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
