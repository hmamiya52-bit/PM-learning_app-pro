...
export const officialMorningQuestions: OfficialMorningQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'アジャイル宣言の背後にある 12 原則は，「要求の変更はたとえ開発の後期であっても歓迎する」「動くソフトウェアを頻繁に提供する」を掲げ，変化に追随しつつ持続可能なペースを保つことを重視する。\nイ 追加機能の優先順位を顧客と合意し，期間を延長せず優先度の高い機能から消化するのが原則に整合する。\nア は「変更を拒否」する点で原則に反し，\nウ は「対面の会話が最も効率的」の原則に反し，\nエ は「動くソフトウェア」より進捗率報告を優先しており不適切。',
    categoryId: 'development-approach',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'JIS Q 21500:2018「プロジェクト全体計画の作成」は，プロジェクトをどのように実行・管理・終結するかを文書化することが目的のプロセスである。\nア は「アクティビティ資源の見積り」，\nウ は「プロジェクト組織の定義」，\nエ は「WBS の作成」の目的。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'JIS Q 21500:2018 では「スコープの定義」は計画のプロセス群に属する。\nイ「品質保証の遂行」とエ「プロジェクトチームの編成」は実行のプロセス群，\nウ「プロジェクト憲章の作成」は立上げのプロセス群に属する。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'JIS Q 21500:2018「ステークホルダのマネジメント」プロセスは，貢献を最大限利用するために，ステークホルダ及びそのプロジェクトへの影響を詳細に分析することを活動として含む。イ・ウ はコミュニケーション系プロセス（コミュニケーションのマネジメント／コミュニケーションの計画），\nエ は「ステークホルダの特定」プロセスの活動。',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'コスト効率指数 CPI = EV / AC = 40 / 60 = 2/3。\nコスト効率が今後も継続する前提なので完成時総コスト見積りは EAC = BAC / CPI = 100 / (2/3) = 150 万円。\nEAC には残作業のコスト効率に応じた複数の式があるが，本問は「現在のコスト効率が継続するパターン」（BAC/CPI 式）に該当する。',
    categoryId: 'measurement',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['11', '13', '14', '15'],
    correctIndex: 1,
    explanation: 'CCPM は ABP（50% 見積り）でスケジュールを組み，余裕日数の合計の半分をプロジェクトバッファとして末尾に置く。\n担当者 A は ① → ② → ④ の連続作業となり，これがクリティカルチェーン。\nABP の合計 = 6+2+3 = 11 日。\n余裕日数（HP−ABP）合計 = 2+1+1 = 4 日 → バッファ = 4÷2 = 2 日。\n全体所要 = 11+2 = 13 日（イ）。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'クリティカルチェーン法は，資源制約とプロジェクトの不確実性に対応するため，合流バッファ（非クリティカルチェーンの合流点に置く）とプロジェクトバッファ（クリティカルチェーン末尾に置く）を設ける手法。イ・ウ はクリティカルパス法上での生産性向上策・要員追加策，\nエ はファストトラッキング（並行化）の説明。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '10 人のコミュニケーション組合せは 10C2 = 45 組，週当たりの追加工数は 45 × 4 = 180 人時/週。\nチーム週稼働 10 × 40 = 400 人時/週から差し引き，開発に充てられるのは 220 人時/週なので 440 人時を完了するのに 2 週間かかる。\n総コストは 400 × 2 = 800 人時。\n1 人開発時のコスト 440 人時との比は 800 ÷ 440 ≒ 1.81 → 切り捨てて 1.8 倍（ウ）。',
    categoryId: 'measurement',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['45', '46', '49', '50'],
    correctIndex: 0,
    explanation: '各要素処理の複雑さを表 2・表 3 で判定し，表 4 で FP 値に変換する。\n① 外部入力（関連 1, データ 8） → 低 = 3，\n② 外部照会（関連 3, データ 21） → 高 = 6，\n③ 外部照会（関連 1, データ 12） → 低 = 3，\n④ 外部出力（関連 2, データ 10） → 中 = 5。\nトランザクション小計 = 3+6+3+5 = 17。\nデータファンクション 33 と合計して未調整 FP = 50。\n調整要因 0.9 を掛けて 50 × 0.9 = 45（ア）。',
    categoryId: 'measurement',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'EMV（期待金額価値） = リスク事象発生時の影響金額 × 発生確率。\n脅威ならマイナス，好機ならプラスの符号を付けてリスク事象ごとに算出し，総和でポートフォリオの期待値を求める。\nイ は割り算で次元が合わず誤り，\nウ・エ は対応コストを掛けたり割ったりしておりいずれも EMV の定義ではない。',
    categoryId: 'uncertainty',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'a の「参加者が持ち回りでレビュー責任者を務める」のはラウンドロビン。\nb の「作成者が説明者になり参加者が質問する」のはウォークスルー。\nc の「議長・読み上げ係を決め公式に評価する」のはインスペクション。\n最も公式度が高いインスペクションは欠陥検出と記録，フォローアップまで含む点が特徴。',
    categoryId: 'delivery',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '汎化（generalization）とは，複数のクラスに共通する性質を抽出して上位のクラスとして定義する関係であり，下位（具象クラス）は上位（抽象クラス）の特化として位置付けられる。\nア は逆方向の「特化」，\nウ は所有関係である「集約」，\nエ は同名メソッドを束ねる「ポリモーフィズム（インタフェース抽象化）」の説明。',
    categoryId: 'tailoring-models',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'スクラムガイドはスプリントを 1 か月以内の固定期間（タイムボックス）で実施することを定めている。\nイ「構造化言語による仕様記述」はスクラムのルールではなく構造化分析の話題，\nウ「頻繁なリファクタリング」とエ「ペアプログラミング」はエクストリームプログラミング（XP）のプラクティスでスクラム自体のルールではない。',
    categoryId: 'development-approach',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'JIS X 0160:2021 のテクニカルプロセスは，利害関係者ニーズを製品・サービスに変換し，それを適用または運用することで利害関係者要件を満たすことを目的とする。\nア は合意プロセス，\nイ はプロジェクトプロセス，\nウ は組織のプロジェクトイネーブリングプロセスの説明。',
    categoryId: 'development-approach',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '著作権法上，受託者が単独で開発したプログラムの著作権は，契約で明示しない限り受託者（委託先）に帰属する。委託元が成果物を別ソフトに転用するには利用許諾や著作権譲渡が必要となる。\nイ ソースコード公開はオープンソース由来の義務で本件と無関係，\nウ 他社販売の制限は別論点，\nエ ハードウェア特許は著作権ではなく特許権の話。',
    categoryId: 'project-work',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'JIS Q 20000-1:2020 では「内部監査」は，組織が自ら規定した要求事項と本規格の要求事項に SMS が適合しているかどうかの情報を得るため，あらかじめ定めた間隔で行うことを要求している。\nア 監視・測定はパフォーマンスの把握，\nイ サービスの報告は顧客向けの情報提供，\nエ マネジメントレビューはトップマネジメントによる適切性・妥当性・有効性の評価。',
    categoryId: 'service-management',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '検証可能な要件とは「要件を満たすか否かを妥当な費用・労力で確認できる方法」が存在する要件であり，\nウ がこれに該当する。\nア は重要度のランク付けで「優先度の明確化」，\nイ は利害関係者の網羅性で「完全性」，\nエ はニーズの網羅で「完全性」を述べているが，いずれも検証可能性とは別の品質特性。',
    categoryId: 'delivery',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'プロバイダ責任制限法は，権利侵害情報の流通に対する送信防止措置を講じた場合，「権利侵害情報が流通していると信ずるに足りる相当の理由がある」など一定の条件を満たせば，特定電気通信役務提供者は発信者への損害賠償責任を負わないと定める（同法 4 条）。\nア は事前承諾を必須化しており不適切，\nウ 裁判所決定の要件は同法にない，\nエ 個人情報保護委員会ではなく被害者から直接の申出に対応する仕組み。',
    categoryId: 'governance',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '36 協定（労働基準法 36 条）は，時間外労働・休日労働について労使協定を書面で締結し，労働基準監督署に届け出ることで法定労働時間を超える時間外労働を可能にする制度。\nア は裁量労働制，\nイ は変形労働時間制（1 か月単位），\nエ はフレックスタイム制の説明。',
    categoryId: 'governance',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'ISO/IEC 15408（コモンクライテリア，CC）は，IT 製品のセキュリティ機能を仕様書・ガイダンス・開発プロセスなど多面的に評価するための国際規格。\nイ は組織管理（ISO/IEC 27001 等）の領域，\nウ は暗号モジュール評価（ISO/IEC 19790 / FIPS 140），\nエ は EAL の要件のみを述べた断片的な説明で誤り（CC は EAL に加え機能要件 PP・ST も評価対象）。',
    categoryId: 'service-management',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'デジタルフォレンジックスは，犯罪・インシデントの証拠となり得る電子データを改ざんなく保全・収集し，調査・分析することで，訴訟や原因究明に備える技術・手続きである。\nア はデジタル透かし，\nイ はペネトレーションテスト，\nウ はソーシャルエンジニアリングの説明。',
    categoryId: 'service-management',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'JIS Q 21500:2018「スコープの管理」は，作業実績と承認されたスコープ・WBS との差異を監視するプロセスで，WBS が主要インプットとなる。\nイ「品質管理の遂行」は品質計画書と作業実績，\nウ「変更の管理」は変更要求と計画書，\nエ「リスクの管理」はリスク登録簿が主要インプットで，いずれも WBS は主インプットではない。',
    categoryId: 'planning',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'タックマンモデルは Forming（成立期）→ Storming（動乱期）→ Norming（安定期）→ Performing（遂行期）→ Adjourning（解散期）の 5 段階で進む。価値観や考え方の違いが顕在化してメンバーが意見を主張し合うのは Storming（動乱期）の特徴。\nア Norming は対立解消・ルール形成，\nイ Performing は高パフォーマンス，\nウ Forming は様子見・遠慮の段階。',
    categoryId: 'team',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'JIS Q 21500:2018「資源の管理」は，プロジェクト作業の実施に必要な資源を確保し，要求事項を満たすように配分することが目的のプロセス。\nア は「アクティビティ資源の見積り」，\nイ は「プロジェクトチームの育成」，\nウ は「プロジェクトチームのマネジメント」プロセスの目的。',
    categoryId: 'team',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'CPI=0.9 < 1.0 はコスト超過，SPI=1.1 > 1.0 はスケジュール先行，TCPI=1.2 > 1.0 は残作業を今より高いコスト効率で消化しないと BAC を超えてしまうことを意味する。よってコスト超過リスクへの対策（効率改善）と，必要に応じてコンティンジェンシー予備費の使用を検討するイが適切。\nア は「TCPI > 1.0」を見落としており，ウ・エ は「CPI < 1.0 = コスト超過」を「コストに余裕」と誤って解釈している。',
    categoryId: 'measurement',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'WBS（Work Breakdown Structure）はプロジェクトのスコープを階層的に詳細化し，管理可能な大きさのワークパッケージへ細分化するための成果物指向の分解構造。\nア は CPM/PERT，\nイ はネットワーク図（PDM）の目的，\nウ はガントチャートの説明。',
    categoryId: 'planning',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'クリティカルパスは B(10)→C(20)→G(20)→H(10) = 60 日（B 後の合流点へ A はダミーで合流）。E は B(10)→E(10)→H(10) 経路で，H の最遅完了 60 日から逆算すると E の最遅終了 50 日，B 終了 10 日から最早開始 10 日・所要 10 日で最早終了 20 日，余裕は 50−20 = 30 日。\nア C の最早開始は 10 日終了の翌日（11 日目），\nイ D は経由しない非クリティカル，\nエ F の最遅開始は 40 日目（H 直前のダミー合流まで余裕がある）。',
    categoryId: 'planning',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'EMV = 期待収入 − 投資額 で算出する。\n新規開発 = 0.7×180 + 0.3×50 − 100 = 126 + 15 − 100 = 41 億円。\n既存改修 = 0.7×120 + 0.3×40 − 50 = 84 + 12 − 50 = 46 億円。\nEMV が高い既存改修（46 億円）を採用する（ア）。',
    categoryId: 'uncertainty',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '基準値 5.0 件/k ステップに対し許容範囲は 0.9 倍〜1.1 倍 = 4.5〜5.5 件/k ステップ。\nA = 130÷30 ≒ 4.33（範囲外），\nB = 120÷24 = 5.00（範囲内），\nC = 64÷16 = 4.00（範囲外），\nD = 46÷10 = 4.60（範囲内）。\n範囲外で品質に問題があるのは A と C → ア。',
    categoryId: 'delivery',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'JIS X 25010:2013 における信頼性の品質副特性は，成熟性・可用性・障害許容性・回復性の 4 つ。「中断時・故障時に影響を受けたデータを回復し，希望状態に復元できる度合い」は回復性の定義で，信頼性の副特性に該当する。\nア は使用性の運用操作性（運用性），\nイ は保守性の解析性／修正性，\nエ は互換性の相互運用性。',
    categoryId: 'delivery',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'アジャイルソフトウェア開発宣言の 4 つの価値の一つは「包括的なドキュメントよりも，動くソフトウェアを」である。左側にも価値があるとしつつ右側により大きな価値を置く形で記述されており，\nエ がこの形式に正確に対応する。ア「計画 vs 自己組織化チーム」，イ「契約交渉 vs 顧客満足」，ウ「プロセスやツール vs 実用的プラクティス」はいずれも宣言にない対比。',
    categoryId: 'development-approach',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    choices: ['A', 'B', 'C', 'D'],
    correctIndex: 3,
    explanation: '5 年間の投資額＝初期＋運用×5，利益＝削減×5 − 投資額。\nA: 投資 50，利益 75，ROI = 75/50 = 1.5。\nB: 投資 50，利益 50，ROI = 50/50 = 1.0。\nC: 投資 40，利益 35，ROI = 35/40 = 0.875。\nD: 投資 40，利益 70，ROI = 70/40 = 1.75。\n最大は D（1.75）。',
    categoryId: 'measurement',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ウォームスタンバイは，バックアップ機を待機させておき，緊急時に起動してデータを最新化したうえでサービスを再開する方式。常時データ同期＋即時切替の ウ はホットスタンバイ，イ「持ち込んで再開」はコールドスタンバイ，\nア は相互救援協定（リカバリーパートナー）に近い説明。',
    categoryId: 'service-management',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'A-B 間は定額契約でスコープ確定済みのため，B 社内の人的リソース不足による追加コストを A 社に請求できない。\nB-C 間は実費償還契約で C 社は実費を請求できるが，C 社設備に故障はなく追加費用の発生原因は B 社にある。\nよって追加費用は B 社のみが負担する（ウ）。',
    categoryId: 'project-work',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'RoHS 指令（Restriction of Hazardous Substances）は，EU が制定した電気・電子機器における特定有害物質（鉛・水銀・カドミウム等）の使用制限指令。\nア ISO 14001 は環境マネジメントシステムの国際規格，\nウ WEEE 指令は廃電気・電子機器の回収・リサイクルを定める指令，\nエ グリーン購入法は日本の法律。',
    categoryId: 'governance',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'SDGs（Sustainable Development Goals）は，2015 年の国連サミットで採択された 2030 年を年限とする 17 の国際目標で，貧困・飢餓・気候変動など持続可能な世界の実現を目指す。\nア はカーボンニュートラル，\nイ は CSR（企業の社会的責任），\nウ は UNEP の海洋プラごみ問題への取組の説明。',
    categoryId: 'governance',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'CRL（証明書失効リスト）は，認証局が発行したデジタル証明書のうち，有効期限内に失効されたものについて，シリアル番号と失効日時を提示するリスト。\nア 秘密鍵は CRL に登録されない，\nウ リアルタイムに照会するのは OCSP，\nエ 有効期限切れの証明書は自然に失効するため CRL には登録されない。',
    categoryId: 'service-management',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'リバースプロキシ方式の SSO では，すべての認証をリバースプロキシで一元化するため，バックエンド Web サーバの認証手段に依存せずデジタル証明書認証など強固な認証手段を利用できる。\nア cookie はクライアントではなくサーバが発行・保存，\nイ cookie 方式は同一インターネットドメインに配置が必要（cookie のドメインスコープのため），\nウ リバースプロキシ方式は逆に同一ドメインで構成しても問題ない。',
    categoryId: 'service-management',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'サイバーセキュリティ演習でのレッドチームは，脅威シナリオに基づき対象組織に攻撃を仕掛ける側のチーム。\nア はホワイトチーム（演習ルールの監督），\nイ はブルーチーム（防御・検知・対応），\nエ はパープルチーム（レッド／ブルー間の知見共有）に近い説明。',
    categoryId: 'service-management',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
