...
export const officialMorningQuestions: OfficialMorningQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'プロジェクト憲章は，プロジェクトを正式に承認する文書で，プロジェクトマネージャを特定して権限を付与し，ビジネスニーズ・目標・期待される結果などを明確にする。ア はプロジェクト・スコープ記述書，イ はプロジェクトマネジメント計画書，ウ もスコープ記述書（最終状態定義）の説明。',
    categoryId: 'integration',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'コンフィギュレーション・マネジメント（構成管理）は，成果物の構成要素や変更履歴を一元管理し，要求事項への適合性を監査するための情報基盤を提供する。ア EVM はコスト・スケジュール統合管理，ウ コンフリクト・マネジメントは対立解決，エ ポートフォリオマネジメントは複数 PJ の戦略的統合管理で別概念。',
    categoryId: 'integration',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ISO 21500:2012「資源のコントロール」プロセスは，プロジェクト作業の実施に必要な資源を確保し，要求事項を満たすように配分することが目的。ア は「アクティビティ資源の見積り」，イ は「プロジェクトチームの育成」，エ は「プロジェクトチームの編成」の目的。',
    categoryId: 'team',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '受容（Accept）は脅威・好機の両方に適用される戦略で，特別な対応をせず顕在化時に対処する。ア 強化（Enhance）は好機側の戦略，イ 共有（Share）は好機側のみ，エ 転嫁（Transfer）は脅威側のみで，それぞれ説明が逆になっている。',
    categoryId: 'uncertainty',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '発生確率・影響度マトリックスはリスクの「確率」と「影響度」を 2 軸で評価する定性的リスク分析の代表手法。ア 感度分析・イ EMV・ウ デシジョン・ツリーはいずれも定量的リスク分析の手法で，数値的な影響を計算する。',
    categoryId: 'uncertainty',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'JIS X 25010:2013 の「利用時の品質」5特性は，有効性・効率性・満足性・リスク回避性・利用状況網羅性。満足性は使用後の主観的評価で，操作困難で困惑する事例（イ）が該当。ア は柔軟性（移植性），ウ は効率性，エ は有効性に関する事例。',
    categoryId: 'uncertainty',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'パレート図は不具合や事象を発生頻度順に並べた図で，「80:20 ルール（重要な少数 vital few）」を可視化する。ア 管理図は時系列での品質管理，イ 散布図は2変数の相関，ウ 特性要因図（フィッシュボーン）は原因分析の階層図で別概念。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '品質尺度（quality metrics）は品質マネジメント計画プロセスのアウトプット。これを基準に品質保証（プロセス監査）と品質コントロール（成果物検査）の両方が行われる。ア 検証済み成果物は品質コントロールのアウトプット，イ 妥当性確認済み変更は統合変更管理のアウトプット，エ 変更要求は各プロセスのアウトプット。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '共通フレーム 2013 の「システム適格性確認テスト」は，システム要件の実装適合性をテストし，システム全体として納入準備が整っているかを評価するアクティビティ。ア は「運用テスト」，イ は「業務継続性評価」，ウ は「投資効果評価」（業務運用後のレビュー段階）の説明。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ITIL の「イベント管理」プロセスは，CI（構成項目）の状態変化やしきい値超過などの「イベント」を検知し，関連プロセス（インシデント管理・問題管理等）へ通知する役割を担う。ア・イ は問題管理，ウ はインシデント管理の活動で別プロセス。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'JIS Q 20000-1:2012 の内部監査要求事項では，監査員の独立性（客観性確保）として「自らの仕事を監査してはならない」と規定。イ は逆で文書化された手順に定義しなければならない，ウ は逆で利害関係者に報告する必要あり，エ は逆であらかじめ定めた間隔で実施する必要あり。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '委託先のセキュリティ管理では，契約でセキュリティレベル・遵守事項・報告義務・監査受入を明文化することが基本。定期報告と監査の組合せで実効性を担保する。イ は個人ペナルティだけでは抑止力が限定的，ウ は委託元が指揮命令すると偽装請負のリスク，エ は「一任」では委託元の管理責任を果たせない。',
    categoryId: 'project-work',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '労働基準法 106 条は使用者に対し，就業規則を労働者へ周知する義務（掲示・備付け・書面交付・電子データの提供等）を課している。ア は逆で就業規則を下回る個別合意は無効（労働契約法 12 条），ウ は逆で常時 10 名以上では行政官庁への届出義務あり（労基法 89 条），エ は逆で労働者代表の意見聴取が必要（労基法 90 条）。',
    categoryId: 'governance',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'RoHS 指令（Restriction of Hazardous Substances）は EU が電気・電子機器における特定有害物質（鉛・水銀・カドミウム等）の使用を制限するために制定した指令。ア ISO 14001 は環境マネジメントシステム規格，ウ WEEE 指令は廃電気・電子機器の回収・リサイクル指令，エ グリーン購入法は日本の法律。',
    categoryId: 'governance',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'テンペスト攻撃（TEMPEST）は，ディスプレイ・ケーブル・キーボードなどから漏れる電磁波（漏えい電磁波）を傍受し，表示・処理内容を解析する攻撃。対策は電磁シールドで電磁波を遮断するのが基本。ア は中間者攻撃（MITM），ウ はマクロウイルス対策，エ は無線 LAN 盗聴対策の説明で，それぞれ別概念。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'クリティカルチェーン法は，資源制約と不確実性に対応するため，非クリティカルチェーンの合流点に合流バッファを，クリティカルチェーン末尾にプロジェクトバッファを置く手法。ア・イ はクリティカルパス法上の生産性向上策・クラッシング，ウ はファストトラッキング（並行化）の説明。',
    categoryId: 'planning',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK第5版において，組織のプロセス資産（OPA）はプロセス／方針／手続き／組織知識ベースが該当し，「課題と欠陥のマネジメントの手順」は典型例。一方，イ ステークホルダのリスク許容度，ウ インフラ，エ 組織文化・体制・ガバナンスはいずれも「組織体の環境要因（EEF）」に分類される。',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '是正処置（Corrective Action）は，既に発生した不適合をパフォーマンスを計画に戻す処置。スケジュール遅延を解消するために要員追加する イ が該当。ア は将来の不適合を予防する「予防処置」，ウ は不適合な成果物を修正する「欠陥修正」，エ はスコープ変更要求（規制変更による新規アクティビティ追加）。',
    categoryId: 'integration',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ローリングウェーブ計画法（Rolling Wave Planning）は段階的詳細化の手法で，近い将来の作業は詳細に，遠い将来の作業は上位レベルで保留し，詳細が明確になってから要素分解する。ア は WBS 辞書の役割，イ はテンプレート利用，エ は通常の要素分解の説明。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'PMBOK においてワークパッケージは WBS の最下層要素で，スケジュール作成時にさらにアクティビティへ分解される。ア OBS は別の分解構造で WP の定義ではない，イ ワークパッケージは「まとめ」ではなく，まとめは上位の WBS 要素，エ 多対1（複数 WP が 1 つの上位成果物を構成）の関係。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    choices: ['安定期 (Norming)', '遂行期 (Performing)', '成立期 (Forming)', '動乱期 (Storming)'],
    correctIndex: 3,
    explanation: 'タックマンモデルは Forming（成立期）→ Storming（動乱期）→ Norming（安定期）→ Performing（遂行期）→ Adjourning（解散期）の 5 段階で進む。価値観や考え方の違いが顕在化してメンバが意見を主張し合うのは Storming（動乱期）の特徴。ア Norming は対立解消・ルール形成，イ Performing は高パフォーマンス，ウ Forming は様子見・遠慮の段階。',
    categoryId: 'team',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ガントチャートは横軸を時間，縦軸を作業として横棒で各作業の開始・終了時点を示し，計画と実績の対比による進捗管理に適する一方，作業間の依存関係（順序）の把握には向かない。ア は EVM，イ はネットワーク図／CPM，エ はマイルストーンチャートの説明。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ベロシティはチームの生産性を測る経験値で，1 スプリントで完了（製造・妥当性確認・受入）したストーリーポイント等の合計値を示す。ア はストーリーポイント，イ はプロダクトバックログ，ウ はバーンダウンチャートの説明。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'CPI = EV/AC < 1.0 はコスト超過状態。是正処置として原因を分析し改善策に取り組むとともに，継続的に CPI を監視するのが適切。ア は CPI<1.0 をコスト余裕と誤解，イ は計算式が逆（EAC = BAC/CPI が正しい），エ は完成時 CPI=1.0 という前提が誤り（実績は変動する）。',
    categoryId: 'measurement',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'マッシュアップは公開されている複数のサービス（API）を組み合わせ，新たな付加価値のサービスを生成する開発手法。店舗案内に外部の地図検索機能を組み込むエ が該当。ア はプラグイン機能，イ は Ajax / AJAX 風 UI，ウ は単なるリンク集で，外部 API 連携によるマッシュアップではない。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'リファクタリングは「外部から見た振る舞い（機能）を変えず，内部構造を改善して保守性・可読性・拡張性を高める」コード改善作業。XP のプラクティスとして広まった。イ はリバースエンジニアリング，ウ はコンポーネントベース開発（CBD），エ は回帰テスト（リグレッションテスト）の説明。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'フルバックアップ間隔を 2 倍にすると，前回フルバックアップから現在までの間に蓄積されるログ量が約 2 倍となり，復旧時のログ反映時間も約 2 倍になる。ア・イ フル取得 1 回あたりの磁気テープ使用量は DB サイズで決まるためほぼ一定，ウ フル取得自体の処理時間も DB サイズ依存で取得間隔と無関係。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '36 協定（労働基準法 36 条）は，時間外労働・休日労働についての労使協定を書面で締結し，労働基準監督署に届け出ることで法定労働時間を超える時間外労働を可能にする制度。ア は裁量労働制，イ は変形労働時間制（1 か月単位），エ はフレックスタイム制の説明。',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '派遣先責任者は派遣先における派遣労働者の適正な就業確保のため，指揮命令者へ関連法規・派遣契約内容・派遣元からの通知などを周知する義務を負う。ア 人事記録と考課は派遣元事業主の役割，イ 派遣就業場所が複数なら原則として場所ごとに選任する必要あり，ウ 管理職位の者から選任する必要は法定要件ではない。',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'CSIRT（Computer Security Incident Response Team）は，企業や行政機関などに設置され，セキュリティインシデントの検知・対応・復旧・再発防止を担う組織。ア はプライバシーマーク制度認定機関（JIPDEC），ウ は CRYPTREC（暗号技術評価），エ は NISC（内閣サイバーセキュリティセンター）の説明。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ペネトレーションテストは，攻撃者の視点でファイアウォール・公開サーバ等に対し実際の侵入を試み，脆弱性を検出する動的セキュリティ検査。ア は暗号仕様の適合性確認，イ は機能テスト，ウ は性能テストで，いずれも侵入試行ではない。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'SPA（Software Process Assessment, ISO/IEC 15504/SPICE）は組織のソフトウェアプロセスの能力水準を評価し，継続的改善のために用いる国際標準。イ は JIS X 0160（ソフトウェアライフサイクルプロセス），ウ は ISO 9001 系，エ は PMBOK の説明。',
    categoryId: 'development-approach',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '【公式誤問・改題版の解説】スコープベースラインは，スコープ記述書・WBS・WBS辞書から構成されるベースラインで，コスト見積もりの主要インプットとなる。また品質マネジメント計画でも PM 計画書の一部として参照される。ア 人的資源計画書はチーム編成用，ウ ステークホルダ登録簿は関与計画用，エ 品質尺度は品質計画のアウトプットで，いずれも本問の条件には合致しない。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'プロジェクトの不確実性は情報が少ない開始時に最も高く，進行とともに低下する。ア は逆でステークホルダ影響力は開始時が最大，ウ は要員数は中盤が最大で典型的な S 字曲線を描く，エ は逆で変更・エラー訂正コストは終盤が最大（手戻り影響範囲が広いため）。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'プロジェクトを公式に承認する文書はプロジェクト憲章で，承認権限を持つのはプロジェクトスポンサー。PM は憲章により任命される側なので PM が承認する選択肢（ア・ウ）は不適切。エ プロジェクトマネジメント計画書は承認後に PM が作成する文書で，プロジェクト開始の公式承認文書ではない。',
    categoryId: 'integration',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'スコープコントロールはプロジェクトの作業範囲（スコープ）への変更を管理する活動。ウ は外部システム連携作業を「本プロジェクトのスコープから除外する」スコープ変更で該当。ア はスケジュールマネジメント，イ はコストマネジメント，エ は資源マネジメントの活動で，スコープへの変更ではない。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '資源カレンダー（Resource Calendar）は資源が利用可能な作業日・シフト・休暇・繁忙期を示す情報源で，所要期間見積もりにおいて資源確保可能日を把握するために使う。ア は資源見積り，イ は RBS（資源ブレークダウン）の役割，エ は過去類似プロジェクト情報による類推見積りの活動。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 2,
    explanation: 'コスト超過せず納期にも遅れない順調な状態は CPI = EV/AC > 1.0 かつ SPI = EV/PV > 1.0，すなわち現時点で EV が AC と PV の両方より大きいグラフ（ウ）が該当。ア は AC > EV でコスト超過，イ は AC > PV > EV でコスト超過＋スケジュール遅延，エ は PV > EV > AC でスケジュール遅延。',
    categoryId: 'measurement',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'デルファイ法は，複数の専門家から匿名・独立のアンケートを集めて要約し，再度アンケートを行うサイクルを反復することで意見の収束を図る技法。匿名性と反復が特徴。ア はインタビュー（一回限り），ウ はブレーンストーミング／合議制，エ は SWOT 分析の説明。',
    categoryId: 'uncertainty',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '定性的リスク分析は，個別リスクの発生確率と影響度を査定して優先順位付けし，その結果でリスク登録簿を更新するプロセス。ア 感度分析は定量的リスク分析の技法，イ 優先順位付けは定性分析の結果で行う（定量分析の結果ではない），ウ リスク特定は別プロセスで対応計画ではなく実績データに基づく。',
    categoryId: 'uncertainty',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'フェールセーフは故障時にシステムを安全側に倒す設計思想。信号機の故障時に赤を点灯し車両停止を促す イ が該当。ア は誤接続を未然に防ぐフールプルーフ，ウ は縮退運転で稼働を続けるフェールソフト，エ は冗長化による耐故障性向上（フォールトトレラント／信頼性向上）。',
    categoryId: 'delivery',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'CMMI（Capability Maturity Model Integration）は，組織のプロセス改善のためのベストプラクティス手引きで，5 段階の成熟度モデルにより組織能力を評価・改善する枠組みを提供する。ア は CASE ツール，イ は共通フレーム（SLCP-JCF），エ は ISO 9001 系の品質保証規格の説明。',
    categoryId: 'development-approach',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'ITIL v3 のサービストランジション段階は，設計されたサービスを本番環境に移行し，要件・制約に沿って確実に稼働させることが目的。変更管理・リリース管理・展開管理などを含む。イ は CSI（継続的サービス改善），ウ はサービス設計，エ はサービス戦略段階の説明。',
    categoryId: 'service-management',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ROI（Return on Investment）= 収益 ÷ 投資額 の比率で評価する手法。簡便だが時間価値を考慮しない欠点がある。ア は NPV（正味現在価値），イ は回収期間法（ペイバック），ウ は IRR（内部収益率）の説明で，それぞれ別概念。',
    categoryId: 'governance',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'シャドー IT は，IT 部門の公式な承認を得ずに従業員や部門が独自に導入・利用するデバイスやクラウドサービスを指す。BYOD の浸透やクラウドサービスの普及に伴いセキュリティリスクとして顕在化。ア はグリーン IT，ウ はショルダーハッキング，エ はフットプリンティング（情報収集）の説明。',
    categoryId: 'service-management',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
