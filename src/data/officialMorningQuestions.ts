...
export const officialMorningQuestions: OfficialMorningQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'JIS Q 21500:2018 でプロジェクトマネジメントオフィス（PMO）は，プロジェクトマネジメントの標準化（テンプレート・手法整備），教育訓練，プロジェクトの監視・支援などを担うと定義されている。\nア スポンサは資金提供と意思決定，\nイ プロジェクトマネージャは個別プロジェクトの責任者，\nエ プロジェクトマネジメントチームは PM 配下の運営支援チームで，標準化や教育全般を担う役割ではない。',
    categoryId: 'governance',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK ガイド第 6 版において，組織のプロセス資産（OPA）はプロセス／方針／手続き／組織知識ベースが該当し，「課題と欠陥のマネジメント上の手続き」は典型例。一方，\nイ インフラ，\nウ ステークホルダーのリスク許容度，\nエ 組織構造・文化・実務などは「組織体の環境要因（EEF）」に分類される。',
    categoryId: 'project-work',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['10', '11', '12', '13'],
    correctIndex: 2,
    explanation: '各作業の開始終了を順に計算する。\nA = 2 日（0 → 2）。\nB は A の FS で開始（2 → 5）。\nC は B との FS−2 関係なので B 終了 2 日前から開始可 = 3 日目開始（3 → 7）。\nD は A の FS+2 なので A 終了 2 日後 = 4 日目開始（4 → 8）。\nE は C と D の両方終了後 = max(7, 8) = 8 日目開始（8 → 12）。\n最少所要日数 = 12 日（ウ）。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ガントチャートは作業を横棒で表し，計画と実績を時間軸上に並べることで個人・グループの進捗管理に適する一方，作業間の依存関係（順序）の把握には向かない。\nア は EVM（コストと進捗を時間推移で示す），\nイ はネットワーク図／CPM（順序関係・重要作業），\nエ はマイルストーンチャートの説明。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'クリティカルチェーン法は，資源制約と不確実性に対応するため，非クリティカルチェーンの合流点に合流バッファを，クリティカルチェーンの末尾にプロジェクトバッファを置く手法。イ・ウ はクリティカルパス法上の生産性向上策・クラッシング，\nエ はファストトラッキングの説明。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '離脱 4 人が 8〜9 月に開発するはずの 4×2 = 8 人月と，引継ぎ 0.5 か月で離脱予定 4 人が開発できない 4×0.5 = 2 人月，合計 10 人月が不足する。\n増員 X 人は引継ぎ後の 8〜9 月の 2 か月で実作業に投入されるので 2X = 10 → X = 5 人。\n増加人件費 = 増員 5 人 × 2.5 か月 × 100 − 離脱 4 人 × 2 か月 × 100 = 1,250 − 800 = 450 万円（ウ）。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'COSMIC 法（ISO/IEC 19761）は，機能プロセスごとにデータ移動をエントリ・エグジット・読込み・書込みの 4 種類に識別し，それぞれの個数に単位規模を乗じて機能規模を求める機能規模測定手法。\nア COCOMO は規模（LOC）から工数を見積もる回帰モデル，\nウ 積み上げ法はボトムアップで作業を積み上げる手法，\nエ 類推法は過去類似案件と比較して見積もる手法。',
    categoryId: 'measurement',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['管理', '計画', '実行', '終結'],
    correctIndex: 1,
    explanation: 'JIS Q 21500:2018 のリスク主題群では，計画のプロセス群に「リスクの特定」「リスクの評価」が，実行のプロセス群に「リスクへの対応」が，管理のプロセス群に「リスクの管理」が配置されている。\n特定と評価はいずれも対応策を計画する前段の活動なので「計画」（イ）に属する。\nア 管理は実績との差異監視，ウ 実行は対応策の実施，エ 終結はクロージング活動に対応する。',
    categoryId: 'uncertainty',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'JIS Q 21500:2018「コミュニケーションのマネジメント」は，ステークホルダのコミュニケーションニーズを確実に満足し，コミュニケーション課題が発生した際にそれを解決することが目的のプロセス。\nア は「プロジェクトチームのマネジメント」，\nウ は「コミュニケーションの計画」，\nエ は「情報の配布」プロセスの目的。',
    categoryId: 'project-work',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ロバストネス分析（Robustness Analysis）は，ユースケースから抽出したクラスをバウンダリ（境界）・コントロール（制御）・エンティティ（情報）の 3 種類に分類し，それらのクラス間関連を図に表す手法。ICONIX プロセスの中核技法で，ユースケースと設計クラス図の橋渡しを担う。\nア は SA/SD（オブジェクト指向分析）の段階定義，\nイ は OMT（オブジェクトモデリング技法）の 3 モデル，\nエ は OOSE などの観点別仕様化に関する記述。',
    categoryId: 'development-approach',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '効果＝Σ(評価点×重み)，リスクも同様に算出して総合評価点＝効果−リスク。\n案 1：効果 5×3+2×2+3×4 = 31，リスク 4×3+2×8 = 28，総合 3。\n案 2：効果 4×3+4×2+4×4 = 36，リスク 1×3+4×8 = 35，総合 1。\n案 3：効果 2×3+2×2+5×4 = 30，リスク 5×3+1×8 = 23，総合 7。\n案 4：効果 4×3+5×2+2×4 = 30，リスク 1×3+5×8 = 43，総合 −13。\n最大は案 3 の 7 点（ウ）。',
    categoryId: 'measurement',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'UX デザインは，ユーザがシステムを利用する際の有効性・操作性に加えて，快適さ・安心感・楽しさなど一連の体験価値（ユーザエクスペリエンス）を重視する設計思想。\nア はセキュリティバイデザイン，\nイ は SOA（Service Oriented Architecture），\nエ は公開 API 活用（マッシュアップ含む）の説明。',
    categoryId: 'delivery',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '就業規則に一般的な秘密保持規定があるとき，担当者の職務に即して具体的な秘密内容を個別合意で特定する行為は，労働契約と就業規則の整合を保ちつつ運用を強化する手段として労働法上適切。\nイ は就業規則変更時に従業員代表の意見聴取が義務（労基法 90 条），\nウ は就業規則を上回る個別合意は労働者に不利な場合は無効，\nエ は秘密保持に関する制裁規定はむしろ就業規則の必要的記載事項に該当しうるため，記載してはいけないという前提が誤り。',
    categoryId: 'governance',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ホイッスルブローイング（whistleblowing）は，組織内部の人物が，法令違反や社会的規範を逸脱する行為を組織内外の第三者（監督官庁・マスコミ等）に通報する行為，いわゆる内部告発を指す。\nア はイノベーション，\nイ はコーチング／人材育成，\nエ はコンティンジェンシープランの説明。',
    categoryId: 'governance',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'AES（Advanced Encryption Standard）は，DES の後継として米国 NIST が標準化した代表的な共通鍵（対称鍵）暗号方式。\nイ ElGamal 暗号，\nウ RSA，\nエ 楕円曲線暗号 はいずれも公開鍵（非対称鍵）暗号方式。',
    categoryId: 'service-management',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'テンペスト攻撃（TEMPEST）は，ディスプレイ・ケーブル・キーボードなどから漏れる電磁波（漏えい電磁波）を遠隔で傍受し，表示・処理内容を解析する攻撃。対策は電磁シールドで電磁波を遮断するのが基本。\nア は中間者攻撃（MITM）と署名検証，\nウ はマクロウイルス対策，\nエ は無線 LAN 盗聴と通信暗号化の説明。',
    categoryId: 'service-management',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    choices: ['計画，実行', '実行，管理', '実行，終結', '管理，終結'],
    correctIndex: 1,
    explanation: '変更要求は実行のプロセス群で作業中に必要性が認識されて提出され，管理のプロセス群の「変更の管理」プロセスで評価・承認・却下が行われる。\n承認された場合はベースラインを更新して実行に戻すため，実行と管理が相互作用する組合せ（イ）が正しい。\nア 計画と実行は計画策定〜実施の流れで変更要求の主軸ではない，\nウ・エは終結後に変更要求は通常発生しない。',
    categoryId: 'integration',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'JIS Q 21500:2018「プロジェクト作業の管理」は，プロジェクト全体計画に従い，統合的にプロジェクト活動を完了することが目的のプロセス。\nア は「進捗の管理」（パフォーマンス監視と課題特定），\nイ は「プロジェクトチームのマネジメント」，\nウ は「変更の管理」プロセスの目的。',
    categoryId: 'integration',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'プロジェクト憲章は，プロジェクトを正式に許可し，プロジェクトマネージャを特定して権限を付与する文書で，ビジネスニーズ・目標・期待される結果などが盛り込まれる。\nア はビジネスケース，\nイ はプロジェクトマネジメント計画書，\nウ はプロジェクトスコープ記述書の説明。',
    categoryId: 'integration',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'BAC=10,000，経過 80% で PV=BAC×0.8=8,000 万円，出来高 70% で EV=BAC×0.7=7,000 万円，AC=8,500 万円。コスト差異 CV = EV − AC = 7,000 − 8,500 = −1,500 万円（コスト超過）。\nア EV は 7,000 万円，\nウ AC は問題文の 8,500 万円，\nエ スケジュール差異 SV = EV − PV = 7,000 − 8,000 = −1,000 万円。',
    categoryId: 'measurement',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'ガントチャートは横軸を時間，縦軸を作業として横棒で各作業の開始・終了時点を示す図表で，開始終了時期と進捗が一目で把握できる。\nイ「構成要素」は WBS の特徴，\nウ「前後関係・クリティカルパス」はアローダイアグラム／ネットワーク図の特徴，\nエ「余裕日数」も同様にネットワーク図側で表現される情報。',
    categoryId: 'planning',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['12', '14', '18', '21'],
    correctIndex: 3,
    explanation: '全経路を辿ると最長は A(8)→D(10)→G(12) = 30 日でこれが最短完了日数（クリティカルパス）。\nH に続く後続作業は I(4) のみで，H と I を合わせた所要は 5+4 = 9 日。\n全体 30 日以内に完了するためには H の最遅開始 = 30 − 9 = 21 日後となる（エ）。',
    categoryId: 'planning',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '資源平準化（resource leveling）は，資源制約に合わせて開始日・終了日を調整するため，フロートを超えて作業を移動することがありクリティカルパスが変わる原因になりやすい。イ・ウ はフロート内に収める「資源スムージング」の特徴で，CP が変わらない点が両者の決定的な違い。\nエ は論理ネットワーク・パスの柔軟性を見る「クリティカルパス法」の説明。',
    categoryId: 'planning',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '好機の対応戦略は「活用 (Exploit)」「強化 (Enhance)」「共有 (Share)」「受容 (Accept)」の 4 つ。強化は好機の発生確率や影響を増大させる施策で，資源を追加投入して好機を高める ア が該当する。\nイ はリスク共有，\nウ ・エ はそれぞれ脅威・好機どちらにも適用される受容（コンティンジェンシー予備による積極的受容と，特別対応をしない消極的受容）の説明。',
    categoryId: 'uncertainty',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '実コスト 8,000 万円は目標コスト 9,000 万円を下回るので条件 (3) を適用する。\n差額 9,000 − 8,000 = 1,000 万円，その 70% = 700 万円が成功報酬。\n基本フィー 1,000 万円に加算して，インセンティブフィー = 1,000 + 700 = 1,700 万円（エ）。',
    categoryId: 'project-work',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'JIS Q 21500:2018「コミュニケーションの計画」は，プロジェクトステークホルダの情報及びコミュニケーションのニーズを決定することが目的のプロセス。\nア は「ステークホルダの特定」，\nイ は「情報の配布」，\nウ は「コミュニケーションのマネジメント」の目的。',
    categoryId: 'project-work',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['a', 'b', 'c', 'd'],
    correctIndex: 3,
    explanation: 'カークパトリックモデルの 4 段階は Lv1 Reaction（反応：満足度・感想），Lv2 Learning（学習：知識・理解度の獲得），Lv3 Behavior（行動：現場での行動変容），Lv4 Results（結果：業績・ROI）。\na 受講後アンケート＝Lv1，\nb 行動変容の確認＝Lv3，\nc 業績インパクトの分析＝Lv4，\nd 理解度テストで学習成果を測る＝Lv2 に該当する（エ）。',
    categoryId: 'delivery',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'SOA（Service Oriented Architecture）はサービス間を疎結合に設計し，個々のサービスの変更が他に波及しないようにすることで，業務変化への追随性を高める。\nア は可用性向上のためにステートレスにすべき（拡張容易性とフェールオーバを確保），\nイ は業務概念に対応した具体名にして使いやすくする，\nエ は SOA の本質である再利用性を否定しており不適切。',
    categoryId: 'development-approach',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ユースケース駆動開発は，ユーザがシステムをどう使うかを示すユースケースを開発の中心軸に据え，ひとまとまりの要件（ユースケース）単位で分析・設計・実装・テストを進める。ユースケース単位の進捗が見えやすい点が利点。\nア は反復型開発（変化への対応），\nイ はリスク駆動の反復（スパイラルモデル等），\nウ はアーキテクチャ駆動開発の特徴。',
    categoryId: 'development-approach',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '伝熱負荷は，屋根・壁・床などの建物外殻を通じて伝わる熱による負荷であり，断熱性能を高めることで軽減できる。\nア は機器発熱を抑える室内負荷（内部負荷）対策，\nイ は隙間風・換気の外気負荷対策，\nウ は日射負荷（窓ガラスからの太陽放射熱）対策。',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'スタンフォード d.school のデザイン思考は，共感 (Empathize) → 問題定義 (Define) → アイディア出し (Ideate) → 試作 (Prototype) → 試行 (Test) の 5 ステップを反復する人間中心の問題解決アプローチで，利用者観察・共感から始める点が特徴。\nア はアイディア発散を抑える収束思考でデザイン思考と逆，\nイ は対話より分析優先で「共感」原則と相反，\nエ はナレッジマネジメントの説明。',
    categoryId: 'development-approach',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '個人情報保護法の「個人情報」は，生存する個人に関する情報で，氏名・生年月日その他の記述により特定の個人を識別できるもの（個人識別符号を含む）と定義される。\nア 顧客限定，\nイ プライバシー限定，\nエ 日本国籍限定はいずれも法の定義にはなく，従業員・取引先など広く対象となり，国籍も問わない。',
    categoryId: 'governance',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '労働者派遣では，派遣元と派遣労働者の間に労働契約が成立し，労働時間・休日・休暇などの就業条件はその労働契約で定める。\n派遣先は派遣契約と労働者派遣法の範囲内で指揮命令ができるだけで，労働条件そのものを直接決定する立場にはない（エ）。\nア・イ・ウはそれぞれ派遣の二面性（労働契約は派遣元側／指揮命令は派遣先側）を取り違えている。',
    categoryId: 'governance',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'リバースプロキシ方式の SSO では，すべての認証をリバースプロキシで一元化するため，バックエンド Web サーバの認証手段に依存せずデジタル証明書認証など強固な認証手段を利用できる。\nア cookie はサーバが発行し，クライアントが保存する，\nイ cookie 方式は同一インターネットドメインに配置する必要がある，\nウ リバースプロキシ方式は単一の入口に認証を集約するため，バックエンドが同一ドメインでも問題なく動作する。',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'CVSS（Common Vulnerability Scoring System）は，IT 製品の脆弱性に対するベンダー非依存・オープンな汎用評価手法。\nア CVSSv2 と v3 はメトリックや計算式が異なり同じ値にならない，\nウ スコアは 0.0〜10.0 の範囲で表現する，\nエ 評価基準は基本評価基準・現状評価基準・環境評価基準の 3 つで構成される。',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'ファジングは，ソフトウェアの入出力に注目し，問題を引き起こしそうな大量かつ多様なパターンのデータを入力して挙動を観察し，例外的・想定外の振る舞いから脆弱性を見つける動的な検査手法。\nア はパッチ管理・バージョン管理の検査，\nウ はセキュリティアドバイザリ照合，\nエ は静的解析（ホワイトボックス検査）の説明。',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
