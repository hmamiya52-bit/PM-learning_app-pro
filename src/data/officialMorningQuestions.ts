...
export const officialMorningQuestions: OfficialMorningQuestion[] = [
  {
    ...
    correctIndex: 1,
    explanation: '==プロジェクトマネジメント計画書==は，プロジェクトの__実行・監視・管理の方法__を定義し，__スコープ・スケジュール・コスト__などの==ベースライン==を統合した文書（PMBOK の主要計画文書）。\n__ア__ は==ビジネスケース==（事業目的・ベネフィットの根拠を示す文書）の説明，\n__ウ__ は==プロジェクトスコープ記述書==（目標・成果物・受入基準を定義）の説明，\n__エ__ は==プロジェクト憲章==（プロジェクトを正式に許可し PM に権限を与える文書）の説明。',
    categoryId: 'planning',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==RACI チャート==は==責任分担マトリックス（RAM）==の代表形式で，以下の 4 役割を各アクティビティに割り当てる。\n　__R__＝Responsible（==実行責任==：実際に作業を行う）\n　__A__＝Accountable（==説明責任==：最終結果に責任を持つ，原則 1 名）\n　__C__＝Consulted（==相談対応==：双方向で意見を求める）\n　__I__＝Informed（==情報提供==：結果を一方向で伝達される）\n__イ・ウ・エ__ はいずれも「リスク管理」を含むが，==RACI に「リスク管理」という役割は存在しない==ため誤り。',
    categoryId: 'team',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==JIS Q 21500:2018==「==プロジェクト組織の定義==」プロセスは，__役割・責任・権限__について __すべての当事者から必要なコミットメントを得ること__ が目的（ウ）。\n__ア__ は「==アクティビティ資源の見積り==」（活動ごとに必要な資源を決定）の目的，\n__イ__ は「==ステークホルダーの特定==」（影響する／される個人・組織の識別と文書化）の目的，\n__エ__ は「==プロジェクトチームの編成==」（必要な人的資源の獲得）の目的。',
    categoryId: 'team',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==TCPI==（残作業効率指数）は ==BAC==（完成時総予算）どおりに完了させるため，__残予算で残作業を消化するのに必要なコスト効率指数__。\n__計算式__: ==TCPI = (BAC − EV) / (BAC − AC)==\n__代入__: TCPI = (100 − 34) / (100 − 40) = 66 / 60 ≒ ==1.1==（ウ）\n__解釈__: 1.0 を超えるため，==これまで以上のコスト効率== が今後求められる（残作業をより効率的にこなす必要がある）。',
  ...
  },
  {
    ...
    choices: ['12', '14', '18', '21'],
    correctIndex: 3,
    explanation: '__クリティカルパス__: A(8)+D(10)+G(12) = ==30 日==（最短完了日数）\n__H の後続作業__: I(4) のみで，H と I の所要合計は 5+4 = 9 日\n__H の最遅開始__: 全体 30 日以内に完了させるため，==30 − 9 = 21 日後==（エ）\n__ア〜ウ__ は A→D 経由のクリティカル制約を満たさず，全体 30 日を超えてしまうため誤り。',
    categoryId: 'planning',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    choices: ['18', '19', '20', '21'],
    correctIndex: 1,
    explanation: '__PDM の FS 依存に従う最早完了__: A(8)+C(5)+D(5) = 18 日，B = 12 日 → 名目クリティカルパスは ==18 日==。\n__ただし制約あり__: ==試験設備は 1 台== で，各アクティビティの「__最終 3 日間__」が競合する。\n__調整__: 設備使用区間が重ならないように 1 日ずらすと，==最少所要日数は 19 日==（イ）。\n__ア__ 18 日は資源制約を無視した値で誤り，\n__ウ・エ__ は過剰なシフトで最適でない。',
    categoryId: 'planning',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ベロシティ==は「==定められた期間（1 スプリント）に受入が完了したチームの成果物の量==」を示す指標で，チームの__実績生産性__を計測する（エ）。\n__ア__ は==ストーリーポイント==（ユーザストーリー同士の相対的な規模見積り単位）の説明，\n__イ__ は==プロダクトバックログ==（優先順に並べた要求事項のリスト）の説明，\n__ウ__ は==バーンダウンチャート==（完了量と残作業量の時系列グラフ）の説明。',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==CPI < 1.0== は __コストが超過__ している状態（実コスト > 出来高）。\n__定石対応__: 原因分析 → 是正処置 → CPI 継続監視（ウ）。\n__ア__ は逆方向の修正（コストが下回っている前提）で誤り。\n__イ__ は計算式が==完成時総コスト見積り（EAC）==として妥当でない。\n__エ__ は ==CPI が自然に 1.0 に戻る保証はない==ため，対策なしで完成を待つのは不適切。',
    categoryId: 'measurement',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '__手順 1__: E = 5.2 × 10^{0.98} ≒ 5.2 × 9.55 ≒ ==49.66 人月==\n__手順 2__: 生産性 = L / E = 10 / 49.66 ≒ ==0.20 k ステップ/人月==（ア）\n__補足__: 指数が 1 に近いためほぼ線形だが，0.98 の影響で==規模が大きいほど生産性がわずかに下がる==。',
    categoryId: 'measurement',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '__考え方__: 1 ステップを生産するのに，各工程で 1/X，1/Y，1/Z 人月を消費するため，\n__合計所要人月__ = ==1/X + 1/Y + 1/Z==。\n__全体生産性__（ステップ/人月）はその逆数 ＝ ==1 / (1/X + 1/Y + 1/Z)==（エ）。\nこれは==調和平均的な合成==で，工程直列のスループットを表す。\n__ア__ は単純加算で次元が合わず誤り，\n__イ__ は単純平均で工程直列に非整合，\n__ウ__ は逆数の和で「生産性」そのものを表していない。',
    categoryId: 'measurement',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==「リスクへの対応」==（Treat Risks）プロセスは，特定・評価したリスクに対し __予算・スケジュール・資源・活動を投入__ して対処する ==実行プロセス==（イ）。\n__ア__ は「==リスクの管理==」（対応の進捗レビュー）プロセス，\n__ウ__ は「==リスクの特定==」（潜在リスク事象の決定）プロセス，\n__エ__ は「==リスクの評価==」（発生確率と影響度の推定）プロセスの説明。',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '__必要 PC 台数__: 要員計画の合計欄から導かれる（最大は ==6 月／7 月／9 月の 11 台==）。\n__制約__:\n　・==セットアップ 2 週間==・==データ消去 1 週間== もレンタル期間に含める。\n　・==月単位課金==（月途中の解約や日割り精算ができない）。\n__計算__: 必要月数を最小化し，月額 5 千円/台で総額を算出すると ==最低 470 千円==（イ）。',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==GoF==（Gang of Four）デザインパターンはオブジェクト指向設計のための ==23 パターン==で，以下の 3 カテゴリに分類される（イ）。\n　__Creational__（==生成==）: オブジェクト生成の抽象化\n　__Structural__（==構造==）: クラス・オブジェクト結合の整理\n　__Behavioral__（==振る舞い==）: オブジェクト間の責任配分\n__ア__ は==Java EE のパターン体系==，\n__ウ__ は ==POSA==（Pattern-Oriented Software Architecture）の 4 分類，\n__エ__ は ==Layers / Broker== などのアーキテクチャパターンの説明で，いずれも GoF ではない。',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==移行リハーサル==の目的は __本番移行のリスク洗い出しと手順検証__。発生した問題は __原因究明と本番環境で非発生の確認__ ができた時点で完了条件を満たす（ア）。\n__イ__ は==切戻し検証を省略==しており，リハーサルとして不十分。\n__ウ__ は==計画外の作業順変更==で本番手順との整合性が取れない。\n__エ__ は==時間超過==が放置されており，本番時間枠の検証として未達。',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==CMMI V2.0== 成熟度レベルは以下の 5 段階。\n　__1__ Initial（==初期==：場当たり的）\n　__2__ Managed（==管理された==：プロジェクトレベルで管理）\n　__3__ Defined（==定義された==：組織標準が整備）\n　__4__ Quantitatively Managed（==定量的に管理された==：データで運営）\n　__5__ Optimizing（==最適化されている==：継続改善・革新）\n__レベル 4__ は「==定量的な実績目標とともにデータで運営される==」段階（イ）。\n__ア__ はレベル 5（継続改善・革新），\n__ウ__ はレベル 3（組織標準），\n__エ__ はレベル 2（プロジェクトレベル管理）の説明。',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==INVEST== は質の高いユーザーストーリーの 6 観点の頭字語:\n　__I__ Independent（==独立==：他ストーリーから独立）\n　__N__ Negotiable（==交渉可能==：議論で詳細を詰められる）\n　__V__ Valuable（==顧客にとって価値==がある）\n　__E__ Estimable（見積り可能）\n　__S__ Small（==作業期間に対し適切な大きさ==）\n　__T__ Testable（テスト可能）\n__イ__「作業期間に対して適切な大きさ」は ==S== に対応し正解。\n__ア__ は「開発者にとって価値」とあり ==V（顧客の価値）==に反する。\n__ウ__ は「議論・交渉の余地がない」が ==N（交渉可能）==に反する。\n__エ__ は「他ストーリーとの依存関係」が ==I（独立）==に反する。',
    categoryId: 'development-approach',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==アジャイルソフトウェア開発宣言==の 4 つの価値観:\n　・プロセスやツールよりも ==個人と対話== を\n　・包括的なドキュメントよりも ==動くソフトウェア== を\n　・契約交渉よりも ==顧客との協調== を\n　・計画に従うことよりも ==変化への対応== を\n__エ__「包括的なドキュメントよりも動くソフトウェアを」が宣言の文言と一致し正解。\n__ア__ は宣言の「変化への対応」を「自己組織化されたチームによる裁量」に==改変==しており誤り。\n__イ__ は宣言の「顧客との協調」を「顧客の競争力と満足度の向上」に==改変==しており誤り。\n__ウ__ は宣言の「個人と対話」を「実用的なプラクティス」に==改変==しており誤り。',
    categoryId: 'development-approach',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==JIS Q 20000-1:2020==（ISO/IEC 20000-1）は ==サービスマネジメントシステム（SMS）== の要求事項を規定する規格で，組織が SMS を __確立・実施・維持・継続的に改善__ するための要件を定める（イ）。\n__ア__ は製品／ツール仕様で SMS 規格の対象外。\n__ウ__ は SMS 要求が==組織形態に依存しない汎用==仕様のため，「組織の形態・規模に応じた要求」は誤り。\n__エ__ は規格自体に==用語定義==が含まれているため，「用語の置き換え（変換）」は誤り。',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==フルバックアップ間隔を 2 倍==にすると，前回バックアップから現時点までの ==ログ蓄積量が約 2 倍==となる。\nよって復旧時に行う ==ログ反映（ロールフォワード）の処理時間が約 2 倍==に増える（ア）。\n__イ・ウ__ バックアップ 1 回当たりの容量は __データベース総量__ で決まり間隔には依存しないため変化しない。\n__エ__ フルバックアップ取得時間も __総量依存__ で間隔とは無関係のため変化しない。',
    categoryId: 'service-management',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==実費償還契約==（Cost Reimbursable）は，__ベンダーが負担した実費__ に ==報酬（フィー）==を加えて支払う契約形態（エ）。リスクは買手側が大きく負う。\n__ア__ は==完全定額契約==（FFP: Firm Fixed Price，リスクは売手）の説明，\n__イ__ は==価格調整付き定額契約==（FPEPA，物価変動を反映）の説明，\n__ウ__ は==インセンティブフィー契約==（CPIF: Cost Plus Incentive Fee，目標コスト達成度で利益配分）の説明。',
    categoryId: 'project-work',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '経済産業省「==AI・データの利用に関する契約ガイドライン==」は ==法的拘束力をもたない== 参考枠組みで，AI 開発・利用の __契約プラクティスが未確立__ である現状を背景に作られた（ウ）。\n__ア__ は「法律で全て規定されている」前提が誤り（実際は法整備が追いついていない）。\n__イ__ はデータの ==経済的価値や秘匿性== は契約上考慮必須。\n__エ__ はガイドラインに ==法的拘束力なし== のため「のっとらなければならない」は誤り。',
    categoryId: 'project-work',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==「心の警備」==（Mindguard）は，集団思考を脅かす ==情報や異議を遮断して集団を保護==する役割を指す（イ）。\n__ア__ は ==「不死身の幻想」==（自集団は失敗しないという錯覚），\n__ウ__ は ==「全会一致の幻想」==（沈黙を同意とみなす），\n__エ__ は ==「異議者への直接圧力」==。いずれもジャニスの集団思考 8 兆候の別項目に該当する。',
    categoryId: 'governance',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==SAML==（Security Assertion Markup Language）は，==ID プロバイダ== と ==サービスプロバイダ== の間で __認証・認可に関する情報を XML 形式で交換__ する仕様（エ）。==シングルサインオン（SSO）== の基盤として広く利用される。\n__ア__ は ==SNMP== 等の監視プロトコル，\n__イ__ は ==STIX/TAXII== などの脅威情報共有仕様，\n__ウ__ は ==IPsec／TLS== による VPN 仕様の説明で，いずれも SAML の機能ではない。',
    categoryId: 'service-management',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==JPCERT/CC「CSIRT ガイド」==の ==インシデントハンドリング== は以下の流れで構成される。\n　__検知__ → ==__トリアージ__== → __対応__ → __報告__\n==トリアージ==（エ）は __緊急度・影響度を評価し対応優先順位を決める__活動で，ハンドリングの中核。\n__ア・イ__ は==事前準備==（演習・マニュアル整備）の業務でハンドリングそのものに含まれない。\n__ウ__ は別業務である ==脆弱性情報ハンドリング==に属する。',
    categoryId: 'service-management',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==公開 PoC==（Proof of Concept）は ==既知の脆弱性==を悪用するもの。最も効果的な ==未然防止策==は，使用ソフトウェアの ==脆弱性情報を確認==し，==修正プログラムを適用==（または一時的な==ワークアラウンド==を実施）すること（ウ）。\n__ア__ は人的管理策で外部からの攻撃と直接関係せず予防効果が低い。\n__イ__ は==事後検知==（侵害された情報の流通確認）で予防策ではない。\n__エ__ は==侵害後の検知策==（不審通信の発見）で予防策ではない。',
    categoryId: 'service-management',
    sourceUrl: R6_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==アジャイル宣言の背後にある 12 原則==は，「==要求の変更はたとえ開発の後期であっても歓迎する==」「==動くソフトウェアを頻繁に提供する==」を掲げ，__変化に追随しつつ持続可能なペース__ を保つことを重視する。\n__イ__ 追加機能の優先順位を顧客と合意し，==期間を延長せず優先度の高い機能から消化==するのが原則に整合し正解。\n__ア__ は「変更を拒否」する点で原則に反する。\n__ウ__ は「対面の会話が最も効率的」の原則に反する（メール記録は不適切）。\n__エ__ は「==動くソフトウェア==」より進捗率報告を優先しており不適切。',
    categoryId: 'development-approach',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==JIS Q 21500:2018==「==プロジェクト全体計画の作成==」プロセスは，__どのようにプロジェクトを実行・管理・終結するかを文書化__ することが目的（イ）。\n__ア__ は「==アクティビティ資源の見積り==」（活動ごとの必要資源を決定）の目的，\n__ウ__ は「==プロジェクト組織の定義==」（全当事者からコミットメント取得）の目的，\n__エ__ は「==WBS の作成==」（階層的分割の枠組み提供）の目的。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'JIS Q 21500:2018 のプロセス群分類:\n　__立上げ__ : プロジェクト憲章の作成\n　__計画__ : ==スコープの定義==・WBS の作成・スケジュール／コストの作成 等\n　__実行__ : 品質保証の遂行・プロジェクトチームの編成 等\n　__管理__ : 変更／コスト／スコープの管理 等\n　__終結__ : プロジェクト／フェーズの終結\n==「スコープの定義」==は計画プロセス群に属する（ア）。\n__イ__「品質保証の遂行」と __エ__「プロジェクトチームの編成」は==実行==に，\n__ウ__「プロジェクト憲章の作成」は==立上げ==に属する。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==JIS Q 21500:2018==「==ステークホルダのマネジメント==」プロセスは，貢献を最大限利用するために __ステークホルダ及びそのプロジェクトへの影響を詳細に分析__ することを活動として含む（ア）。\n__イ__ は「==コミュニケーションのマネジメント==」（ニーズ充足・課題解決）の活動，\n__ウ__ は「==コミュニケーションの計画==」（情報ニーズ特定と手段明確化）の活動，\n__エ__ は「==ステークホルダの特定==」（個人／集団／組織の識別と情報文書化）の活動。',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '__手順 1__ コスト効率指数 ==CPI = EV / AC== = 40 / 60 = ==2/3==。\n__手順 2__ コスト効率が今後も継続する前提なので，完成時総コスト見積り ==EAC = BAC / CPI== = 100 / (2/3) = ==150 万円==（エ）。\n__補足__: EAC には残作業のコスト効率に応じた複数の式があるが，本問は「==現在のコスト効率が継続するパターン==（BAC/CPI 式）」に該当。',
    categoryId: 'measurement',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['11', '13', '14', '15'],
    correctIndex: 1,
    explanation: '==CCPM==（クリティカルチェーンプロジェクトマネジメント）は ==ABP（50% 見積り）== でスケジュールを組み，__余裕日数の合計の半分__ を ==プロジェクトバッファ== として末尾に置く。\n__クリティカルチェーン__: 担当者 A の連続作業 ① → ② → ④。\n__ABP 合計__: 6 + 2 + 3 = ==11 日==\n__余裕日数（HP−ABP）合計__: 2 + 1 + 1 = 4 日 → ==バッファ = 4 ÷ 2 = 2 日==\n__全体所要__: 11 + 2 = ==13 日==（イ）。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['15', '16', '17', '18'],
    correctIndex: 1,
    explanation: '==専門チームの支援は同時に 1 アクティビティしか行えない== ため，==支援の競合解消== が制約となる。\n__配置例__:\n　A: 1〜10 日（支援 1〜4 日）\n　C: 5〜14 日（支援 5〜8 日）\n　B: 11〜15 日（A 終了後，支援 11〜12 日）\n　D: 13〜16 日（支援が空く期間）\n各アクティビティの支援要件と先行関係を満たす最少日数として ==16 日==（イ）が成立する。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==クリティカルチェーン法==は __資源制約とプロジェクトの不確実性__ に対応するため，以下の 2 種類のバッファを設ける手法（ア）。\n　==合流バッファ==: 非クリティカルチェーンがクリティカルチェーンに合流する点に置く\n　==プロジェクトバッファ==: クリティカルチェーン末尾に置く\n__イ__ は==クリティカルパス法==上での生産性向上策（ツール導入），\n__ウ__ は==クラッシング==（要員追加で短縮），\n__エ__ は==ファストトラッキング==（並行化で短縮）の説明。',
    categoryId: 'planning',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '__手順 1__ 10 人のコミュニケーション組合せ: 10C2 = ==45 組==。週当たり追加工数 = 45 × 4 = ==180 人時/週==。\n__手順 2__ チーム週稼働 = 10 × 40 = 400 人時/週。開発に充てられるのは 400 − 180 = ==220 人時/週==。\n__手順 3__ 440 人時を完了するのに 440 / 220 = ==2 週間==。総コスト = 400 × 2 = ==800 人時==。\n__手順 4__ 1 人開発時のコスト 440 人時との比 = 800 / 440 ≒ 1.81 → 切り捨てて ==1.8 倍==（ウ）。',
    categoryId: 'measurement',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['45', '46', '49', '50'],
    correctIndex: 0,
    explanation: '各要素処理の複雑さを __表 2・表 3__ で判定し，__表 4__ で FP 値に変換する。\n__① 外部入力__（関連 1, データ 8）→ 低 = ==3==\n__② 外部照会__（関連 3, データ 21）→ 高 = ==6==\n__③ 外部照会__（関連 1, データ 12）→ 低 = ==3==\n__④ 外部出力__（関連 2, データ 10）→ 中 = ==5==\n__トランザクション小計__ = 3+6+3+5 = ==17==\n__未調整 FP__ = 17 + 33（データファンクション）= ==50==\n__調整後 FP__ = 50 × 0.9 = ==45==（ア）。',
    categoryId: 'measurement',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==EMV==（期待金額価値） = ==リスク事象発生時の影響金額 × 発生確率==（ア）。\n脅威ならマイナス，好機ならプラスの符号を付けてリスク事象ごとに算出し，総和でポートフォリオの期待値を求める。\n__イ__ は割り算で次元が合わず誤り。\n__ウ・エ__ は対応コストを掛けたり割ったりしておりいずれも EMV の定義ではない。',
    categoryId: 'uncertainty',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['管理', '計画', '実行', '終結'],
    correctIndex: 1,
    explanation: '==JIS Q 21500:2018== のリスク主題群のプロセス配置:\n　__計画__ : ==リスクの特定==・==リスクの評価==\n　__実行__ : ==リスクへの対応==\n　__管理__ : ==リスクの管理==\n特定と評価はいずれも __対応策を計画する前段の活動__ なので「==計画==」（イ）に属する。\n__ア__ 管理は実績との差異監視，__ウ__ 実行は対応策の実施，__エ__ 終結はクロージング活動で別プロセス群。',
    categoryId: 'uncertainty',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '__a__ 「==参加者が持ち回りでレビュー責任者を務める==」のは ==ラウンドロビン==。\n__b__ 「==作成者が説明者になり参加者が質問する==」のは ==ウォークスルー==。\n__c__ 「==議長・読み上げ係を決め公式に評価する==」のは ==インスペクション==。\nよって組合せは ==a:ラウンドロビン，b:ウォークスルー，c:インスペクション==（エ）。\n__補足__: 最も公式度が高いインスペクションは==欠陥検出・記録・フォローアップ==まで含む点が特徴。',
    categoryId: 'delivery',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==汎化==（generalization）とは，__複数のクラスに共通する性質を抽出して上位のクラスとして定義する関係__ で，下位（具象クラス）は上位（抽象クラス）の特化として位置付けられる（イ）。\n__ア__ は逆方向の ==「特化」==（specialization）。\n__ウ__ は所有関係である ==「集約」==（aggregation）。\n__エ__ は同名メソッドを束ねる ==「ポリモーフィズム」==（インタフェース抽象化）の説明。',
    categoryId: 'tailoring-models',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==スクラムガイド==は ==スプリントを 1 か月以内の固定期間（タイムボックス）== で実施することを定めている（ア）。\n__イ__「構造化言語による仕様記述」はスクラムのルールではなく==構造化分析==の話題。\n__ウ__「頻繁なリファクタリング」と __エ__「ペアプログラミング」は ==XP（エクストリームプログラミング）== のプラクティスでスクラム自体のルールではない。',
    categoryId: 'development-approach',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==JIS X 0160:2021== のテクニカルプロセスは __利害関係者ニーズを製品・サービスに変換し，それを適用または運用することで利害関係者要件を満たす__ ことを目的とする（エ）。\n__ア__ は ==合意プロセス==（取得者と供給者の双方が価値を実現），\n__イ__ は ==プロジェクトプロセス==（資源・資産の管理と合意の遂行），\n__ウ__ は ==組織のプロジェクトイネーブリングプロセス==（プロジェクトに資源を提供）の説明。',
    categoryId: 'development-approach',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '著作権法上，==受託者が単独で開発したプログラムの著作権は，契約で明示しない限り受託者（委託先）に帰属== する。\nよって委託元が成果物を ==別ソフトウェアに転用== するには，利用許諾や著作権譲渡が必要となる（ア）。\n__イ__ ソースコード公開義務は==オープンソースライセンス==由来で本件と無関係，\n__ウ__ 他社販売制限はバイナリ／ソースで区別する根拠なし，\n__エ__ ハードウェア部分は==特許権==の話で著作権と別領域。',
    categoryId: 'project-work',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['A案', 'B案', 'C案', 'D案'],
    correctIndex: 2,
    explanation: '==初期費用 + 3 年分のランニング費用== で TCO を比較する。\n__A 案__ = (30+30+5) + (20+6+6)×3 = 65 + 96 = ==161==\n__B 案__ = 85 + (20+5+4)×3 = 85 + 87 = ==172==\n__C 案__ = 75 + (15+5+6)×3 = 75 + 78 = ==153==\n__D 案__ = 85 + (15+5+4)×3 = 85 + 72 = ==157==\n最小は ==C 案 = 153 百万円==（ウ）。',
    categoryId: 'measurement',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==JIS Q 20000-1:2020== では ==「内部監査」== は，組織が ==自ら規定した要求事項と本規格の要求事項に SMS が適合しているかどうかの情報を得るため，あらかじめ定めた間隔で行う== ことを要求している（ウ）。\n__ア__ ==監視・測定・分析・評価== はパフォーマンスの把握活動，\n__イ__ ==サービスの報告== は顧客向けの情報提供活動，\n__エ__ ==マネジメントレビュー== はトップマネジメントによる適切性・妥当性・有効性の評価活動。',
    categoryId: 'service-management',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==検証可能な要件==とは「==要件を満たすか否かを妥当な費用・労力で確認できる方法==」が存在する要件であり，__ウ__ がこれに該当（正解）。\n__ア__ は重要度のランク付けで「==優先度==」の品質特性。\n__イ__ は利害関係者の網羅性で「==完全性==」の品質特性。\n__エ__ はニーズの網羅で「==完全性==」の品質特性。\nいずれも検証可能性とは別の品質特性。',
    categoryId: 'delivery',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==プロバイダ責任制限法==（同法 4 条）は，権利侵害情報の流通に対する送信防止措置を講じた場合に，__一定の条件（「権利侵害情報が流通していると信ずるに足りる相当の理由がある」等）を満たせば，特定電気通信役務提供者は発信者への損害賠償責任を負わない__ と定める（イ）。\n__ア__ 事前承諾を必須化しており同法の趣旨に反する。\n__ウ__ 裁判所決定の要件は同法に存在しない。\n__エ__ 個人情報保護委員会ではなく==被害者からの直接の申出==に対応する仕組み。',
    categoryId: 'governance',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==36 協定==（労働基準法 36 条）は，==時間外労働・休日労働==について ==労使協定を書面で締結し，労働基準監督署に届け出る== ことで法定労働時間を超える時間外労働を可能にする制度（ウ）。\n__ア__ は ==裁量労働制==（業務遂行・時間配分を労働者に委ねる）の説明。\n__イ__ は ==変形労働時間制==（1 か月以内の期間で平均して法定労働時間を超えない）の説明。\n__エ__ は ==フレックスタイム制==（始業・終業時刻を労働者に委ねる）の説明。',
    categoryId: 'governance',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==ISO/IEC 15408==（==コモンクライテリア，CC==）は，IT 製品のセキュリティ機能を __仕様書・ガイダンス・開発プロセスなど多面的に評価__ するための国際規格（ア）。\n__イ__ は ==組織管理==（ISO/IEC 27001 等）の領域。\n__ウ__ は ==暗号モジュール評価==（ISO/IEC 19790 / FIPS 140）の領域。\n__エ__ は ==EAL（評価保証レベル）== のみを述べた断片的な説明で誤り（CC は EAL に加え機能要件 PP・ST も評価対象）。',
    categoryId: 'service-management',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==デジタルフォレンジックス==は，犯罪・インシデントの証拠となり得る電子データを ==改ざんなく保全・収集し，調査・分析することで，訴訟や原因究明に備える== 技術・手続き（エ）。\n__ア__ は ==デジタル透かし==（コンテンツへの情報埋込み）の説明。\n__イ__ は ==ペネトレーションテスト==（実際に攻撃して侵入を試みる）の説明。\n__ウ__ は ==ソーシャルエンジニアリング==（話術・盗み聞き等で情報入手）の説明。',
    categoryId: 'service-management',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==ファジング==は，ソフトウェアの __データの入出力に注目__ し，==問題を引き起こしそうな大量かつ多様なパターンのデータを入力== して挙動を観察し，例外的・想定外の振る舞いから脆弱性を見つける ==動的な検査手法==（イ）。\n__ア__ は ==パッチ管理・バージョン管理== の検査。\n__ウ__ は ==静的解析==（ホワイトボックス検査）。\n__エ__ は ==セキュリティアドバイザリ照合==（情報ベース検査）。',
    categoryId: 'service-management',
    sourceUrl: R5_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==変更要求==は __実行のプロセス群__ で作業中に必要性が認識されて提出され，__管理のプロセス群__ の「==変更の管理==」プロセスで評価・承認・却下が行われる。\n承認された場合は==ベースラインを更新==して実行に戻すため，==実行と管理が相互作用==する組合せ（イ）が正しい。\n__ア__ 計画と実行は計画策定〜実施の流れで変更要求の主軸ではない。\n__ウ・エ__ は終結後に変更要求は通常発生しない。',
    categoryId: 'integration',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==プロジェクト憲章==は __プロジェクトを正式に許可し，プロジェクトマネージャを特定して権限を付与する文書__。==ビジネスニーズ・目標・期待される結果==などが盛り込まれる（エ）。\n__ア__ は==ビジネスケース==（事業目的・ベネフィットの根拠）の説明，\n__イ__ は==プロジェクトマネジメント計画書==（実行・監視・管理の方法定義）の説明，\n__ウ__ は==プロジェクトスコープ記述書==（目標・成果物・受入基準）の説明。',
    categoryId: 'integration',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==JIS Q 21500:2018==「==スコープの管理==」は，==作業実績と承認されたスコープ・WBS との差異を監視== するプロセスで，==WBS が主要インプット==となる（ア）。\n__イ__「品質管理の遂行」は==品質計画書と作業実績==が主要インプット。\n__ウ__「変更の管理」は==変更要求と計画書==が主要インプット。\n__エ__「リスクの管理」は==リスク登録簿==が主要インプット。\nいずれも WBS は主インプットではない。',
    categoryId: 'planning',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==RACI チャート== は ==責任分担マトリックス（RAM）== の代表形式で，以下の 4 役割を割り当てる（ア）。\n　__R__＝Responsible（==実行責任==：実際に作業を行う）\n　__A__＝Accountable（==説明責任==：最終結果に責任を持つ，原則 1 名）\n　__C__＝Consulted（==相談対応==：双方向で意見を求める）\n　__I__＝Informed（==情報提供==：結果を一方向で伝達される）\n__イ・ウ・エ__ はいずれも「リスク管理」を含むが，==RACI に「リスク管理」という役割は存在しない==ため誤り。',
    categoryId: 'team',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==タックマンモデル== は以下の 5 段階で進む。\n　__Forming__（==成立期==）: 様子見・遠慮\n　__Storming__（==動乱期==）: ==価値観の違いが顕在化し意見を主張し合う==\n　__Norming__（==安定期==）: 対立解消・ルール形成\n　__Performing__（==遂行期==）: 高パフォーマンス\n　__Adjourning__（==解散期==）: 解散\n価値観・考え方の違いが明確になり意見を主張し合うのは ==Storming（動乱期）==（エ）。\n__ア__ Norming，__イ__ Performing，__ウ__ Forming は別段階。',
    categoryId: 'team',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==JIS Q 21500:2018==「==資源の管理==」プロセスは，__プロジェクト作業の実施に必要な資源を確保し，要求事項を満たすように配分すること__ が目的（エ）。\n__ア__ は「==アクティビティ資源の見積り==」（活動ごとの必要資源決定）の目的。\n__イ__ は「==プロジェクトチームの育成==」（パフォーマンス・相互関係の継続的改善）の目的。\n__ウ__ は「==プロジェクトチームのマネジメント==」（フィードバック・課題解決・コミュニケーション促進）の目的。',
    categoryId: 'team',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '__指標の読み取り__:\n　==CPI = 0.9 < 1.0== → ==コスト超過==（実コスト > 出来高）\n　==SPI = 1.1 > 1.0== → ==スケジュール先行==\n　==TCPI = 1.2 > 1.0== → 残作業を今より高いコスト効率で消化しないと ==BAC を超えてしまう==\nよってコスト超過リスクへの ==効率改善対策== と，==コンティンジェンシー予備費の使用== を検討するのが妥当（イ）。\n__ア__ は「TCPI > 1.0」を見落としており不十分。\n__ウ・エ__ は「CPI < 1.0 = コスト超過」を「コストに余裕」と誤って解釈している。',
    categoryId: 'measurement',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==WBS==（Work Breakdown Structure）は __プロジェクトのスコープを階層的に詳細化し，管理可能な大きさのワークパッケージへ細分化__ するための ==成果物指向の分解構造==（エ）。\n__ア__ は ==CPM/PERT==（コスト−期間トレードオフ最適化），\n__イ__ は ==ネットワーク図（PDM）==（作業順序とクリティカルパス把握），\n__ウ__ は ==ガントチャート==（横棒で日程と進捗を表示）の説明。',
    categoryId: 'planning',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '__クリティカルパス__: B(10)→C(20)→G(20)→H(10) = ==60 日==（B 後の合流点へ A はダミーで合流）。\n__E の余裕時間__: E は B(10)→E(10)→H(10) 経路で，\n　H の最遅完了 = 60 日，H の所要 = 10 → E の最遅終了 = ==50 日==\n　B 終了 = 10 日，E の所要 = 10 → E の最早終了 = ==20 日==\n　==総余裕時間 = 50 − 20 = 30 日==（ウ）。\n__ア__ C の最早開始は B 終了の翌日（11 日目）で 6 日目ではない，\n__イ__ D は経由しない非クリティカル，\n__エ__ F の最遅開始は別計算（11 日目ではない）。',
    categoryId: 'planning',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '__開発生産性__ = 開発規模 ÷ 開発工数 = 規模 ÷ (3.0 × 規模^{1.12}) = ==規模^{−0.12} ÷ 3.0==。\n指数が ==−0.12==（負だが小さい絶対値）なので，__規模が増えると生産性は単調に低下__ し，かつ ==低下の度合いは次第に緩やかになる==。\nよって ==右下がりで次第に緩やかな曲線==（エ）が正しい。\n__ア・イ__ は右上がりで誤り，__ウ__ は右下がりだが減少が急になる逆形状で誤り。',
    categoryId: 'measurement',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==EMV = 期待収入 − 投資額== で算出する。\n__新規開発__ = 0.7×180 + 0.3×50 − 100 = 126 + 15 − 100 = ==41 億円==\n__既存改修__ = 0.7×120 + 0.3×40 − 50 = 84 + 12 − 50 = ==46 億円==\nEMV が高い ==既存改修（46 億円）== を採用する（ア）。',
    categoryId: 'uncertainty',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==基準値 5.0 件/k ステップ==に対し，許容範囲は 0.9 倍〜1.1 倍 = ==4.5〜5.5 件/k ステップ==。\n__A__ = 130 ÷ 30 ≒ ==4.33==（==範囲外==）\n__B__ = 120 ÷ 24 = ==5.00==（範囲内）\n__C__ = 64 ÷ 16 = ==4.00==（==範囲外==）\n__D__ = 46 ÷ 10 = ==4.60==（範囲内）\n範囲外で品質に問題があるのは ==A と C==（ア）。',
    categoryId: 'delivery',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==JIS X 25010:2013== における ==信頼性== の品質副特性は 4 つ:\n　==成熟性==（Maturity）\n　==可用性==（Availability）\n　==障害許容性==（Fault Tolerance）\n　==回復性==（Recoverability）\n「==中断時・故障時に影響を受けたデータを回復し，希望状態に復元できる度合い==」は ==回復性== の定義（ウ）。\n__ア__ は ==使用性== の運用操作性（運用性），\n__イ__ は ==保守性== の解析性／修正性，\n__エ__ は ==互換性== の相互運用性。',
    categoryId: 'delivery',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==アジャイルソフトウェア開発宣言== の 4 つの価値観の 1 つは「==包括的なドキュメントよりも，動くソフトウェアを==」。左側にも価値があるとしつつ右側により大きな価値を置く形式で記述されており，__エ__ がこの形式に正確に対応し正解。\n__ア__「計画 vs ==自己組織化チーム==」，__イ__「契約交渉 vs ==顧客満足==」，__ウ__「プロセスやツール vs ==実用的プラクティス==」はいずれも宣言にない==改変された対比==。',
    categoryId: 'development-approach',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==XP（エクストリームプログラミング）== の主なプラクティスは以下:\n　==ペアプログラミング==\n　==テスト駆動開発（TDD）==\n　==リファクタリング==\n　==継続的インテグレーション==\n　==シンプル設計==\nよって ==ペアプログラミング==（エ）が XP プラクティス。\n__ア__ ==構造化プログラミング==は古典的制御構造のスタイル，\n__イ__ ==コンポーネント指向==は再利用性に着目したパラダイム，\n__ウ__ ==ビジュアルプログラミング==は GUI ベースの開発で，いずれも XP 固有ではない。',
    categoryId: 'development-approach',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ユースケース駆動開発==は，==ユーザがシステムをどう使うか== を示すユースケースを開発の中心軸に据え，==ひとまとまりの要件（ユースケース）単位で分析・設計・実装・テストを進める==。ユースケース単位の進捗が見えやすい点が利点（エ）。\n__ア__ は ==反復型開発==（変化への対応），\n__イ__ は ==スパイラルモデル==（リスク駆動の反復），\n__ウ__ は ==アーキテクチャ駆動開発==（早期にアーキテクチャを固める）の特徴。',
    categoryId: 'development-approach',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['A', 'B', 'C', 'D'],
    correctIndex: 3,
    explanation: '__5 年間の投資額__ = 初期 + 運用×5，__利益__ = 削減×5 − 投資額。\n__A__: 投資 = 30 + 4×5 = 50，利益 = 25×5 − 50 = 75，ROI = 75/50 = ==1.5==\n__B__: 投資 = 20 + 6×5 = 50，利益 = 20×5 − 50 = 50，ROI = 50/50 = ==1.0==\n__C__: 投資 = 20 + 4×5 = 40，利益 = 15×5 − 40 = 35，ROI = 35/40 = ==0.875==\n__D__: 投資 = 15 + 5×5 = 40，利益 = 22×5 − 40 = 70，ROI = 70/40 = ==1.75==\n最大は ==D（1.75）==（エ）。',
    categoryId: 'measurement',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'バックアップサイト方式は 3 種類:\n　==ホットスタンバイ==: 常時データ同期 + 即時切替（最短復旧）\n　==ウォームスタンバイ==: 待機機を起動 → ==データを最新化== → サービス再開（エ）\n　==コールドスタンバイ==: 緊急時にバックアップシステムを ==持ち込んで== 再開\n__ウ__ は==ホットスタンバイ==の説明，\n__イ__ は==コールドスタンバイ==の説明，\n__ア__ は==相互救援協定==（リカバリーパートナー）に近い別概念。',
    categoryId: 'service-management',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '__A-B 間__ は ==定額契約== でスコープ確定済みのため，B 社内の人的リソース不足による追加コストを A 社に請求できない。\n__B-C 間__ は ==実費償還契約== で C 社は実費を請求できるが，==C 社設備に故障はなく追加費用の発生原因は B 社== にある。\nよって追加費用は ==B 社のみが負担== する（ウ）。',
    categoryId: 'project-work',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==RoHS 指令==（Restriction of Hazardous Substances）は，==EU が制定== した ==電気・電子機器における特定有害物質==（鉛・水銀・カドミウム等）の使用制限指令（イ）。\n__ア__ ==ISO 14001== は環境マネジメントシステムの国際規格。\n__ウ__ ==WEEE 指令== は廃電気・電子機器の回収・リサイクルを定める EU 指令（RoHS と対をなす）。\n__エ__ ==グリーン購入法== は日本の法律。',
    categoryId: 'governance',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==SDGs==（Sustainable Development Goals）は，==2015 年の国連サミットで採択された 2030 年を年限とする 17 の国際目標== で，貧困・飢餓・気候変動など __持続可能でより良い世界の実現__ を目指す（エ）。\n__ア__ は ==カーボンニュートラル==（排出量と除去量を均衡させる取組）の説明。\n__イ__ は ==CSR==（企業の社会的責任）の説明。\n__ウ__ は ==UNEP== による海洋プラスチックごみ問題への取組の説明。',
    categoryId: 'governance',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==CRL==（証明書失効リスト）は，認証局が発行したデジタル証明書のうち ==有効期限内に失効されたもの== について，==シリアル番号と失効日時の対応== を提示するリスト（イ）。\n__ア__ ==秘密鍵== は CRL に登録されない（公開情報のみ）。\n__ウ__ リアルタイム照会するのは ==OCSP==（Online Certificate Status Protocol）。\n__エ__ ==有効期限切れの証明書== は自然失効するため CRL には登録されない。',
    categoryId: 'service-management',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==リバースプロキシ方式の SSO== では，__すべての認証をリバースプロキシで一元化__ するため，バックエンド Web サーバの認証手段に依存せず ==デジタル証明書認証== など強固な認証手段を利用できる（エ）。\n__ア__ ==cookie== はクライアントではなくサーバが発行・保存する。\n__イ__ cookie 方式は ==同一インターネットドメインに配置が必要==（cookie のドメインスコープ制約）。\n__ウ__ リバースプロキシ方式は==逆に同一ドメインで構成しても問題ない==。',
    categoryId: 'service-management',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'サイバーセキュリティ演習でのチーム役割:\n　==レッドチーム==: ==脅威シナリオに基づき対象組織に攻撃を仕掛ける==（ウ）\n　==ブルーチーム==: 防御・検知・対応\n　==ホワイトチーム==: 演習ルールの監督・攻撃範囲の監視\n　==パープルチーム==: レッド／ブルー間の知見共有\n__ア__ は==ホワイトチーム==，\n__イ__ は==ブルーチーム==，\n__エ__ は==パープルチーム==に近い説明。',
    categoryId: 'service-management',
    sourceUrl: R4_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==JIS Q 21500:2018== でプロジェクトマネジメントオフィス（==PMO==）は，__標準化__（テンプレート・手法整備）・__教育訓練__・__プロジェクトの監視・支援__ などを担うと定義されている（ウ）。\n__ア__ ==プロジェクトスポンサ== は資金提供と意思決定。\n__イ__ ==プロジェクトマネージャ== は個別プロジェクトの責任者。\n__エ__ ==プロジェクトマネジメントチーム== は PM 配下の運営支援チームで，標準化や教育全般を担う役割ではない。',
    categoryId: 'governance',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==RACI チャート==における ==説明責任==（A=Accountable）は，==1 つのアクティビティに対して 1 人が担う== のが原則。\n__設計行を見ると__:\n　==阿部=R==（実行責任）\n　==伊藤=I==（情報提供）\n　==佐藤=I==（情報提供）\n　==鈴木=C==（相談対応）\n　==田中=C==（相談対応）\n　==野村=A==（説明責任）\nよって A を持つのは ==野村== のみ（エ）。',
    categoryId: 'team',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK ガイド第 6 版で，==組織のプロセス資産（OPA）== は ==プロセス／方針／手続き／組織知識ベース== が該当し，「==課題と欠陥のマネジメント上の手続き==」は典型例（ア）。\n一方，以下は ==組織体の環境要因（EEF）== に分類される:\n　__イ__ インフラストラクチャ\n　__ウ__ ステークホルダーのリスク許容度\n　__エ__ 組織構造・文化・実務など',
    categoryId: 'project-work',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['10', '11', '12', '13'],
    correctIndex: 2,
    explanation: '各作業の開始終了を順に計算する。\n__A__ = 2 日（0 → 2）\n__B__ は A の FS で開始（2 → 5）\n__C__ は B との ==FS−2== なので B 終了 2 日前から開始可 = 3 日目開始（3 → 7）\n__D__ は A の ==FS+2== なので A 終了 2 日後 = 4 日目開始（4 → 8）\n__E__ は C と D の両方終了後 = max(7, 8) = 8 日目開始（8 → 12）\n最少所要日数 = ==12 日==（ウ）。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ガントチャート==は __作業を横棒で表し，計画と実績を時間軸上に並べる__ ことで __個人・グループの進捗管理__ に適する一方，==作業間の依存関係（順序）の把握には向かない==（ウ）。\n__ア__ は ==EVM==（コストと進捗を時間推移で示す）の説明。\n__イ__ は ==ネットワーク図／CPM==（順序関係・重要作業）の説明。\n__エ__ は ==マイルストーンチャート== の説明。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==クラッシング==は，==コスト増を許容してクリティカルパス上の作業に資源（人員・設備）を追加投入== し，スケジュールを短縮する技法（ア）。\n__イ__ は単なるコスト削減策で短縮の話ではない。\n__ウ__ は単なる ==延期==（クラッシングではない）。\n__エ__ は ==ファストトラッキング==（先行作業の完了を待たず並行化）の説明。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==クリティカルチェーン法==は __資源制約とプロジェクトの不確実性__ に対応するため，以下の 2 種類のバッファを設ける手法（ア）。\n　==合流バッファ==: 非クリティカルチェーンの合流点に置く\n　==プロジェクトバッファ==: クリティカルチェーンの末尾に置く\n__イ__ は ==クリティカルパス法== 上の生産性向上策（ツール導入），\n__ウ__ は ==クラッシング==（要員追加），\n__エ__ は ==ファストトラッキング==（並行化）の説明。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '__不足する人月__:\n　・離脱 4 人が 8〜9 月に開発するはずだった ==4×2 = 8 人月==\n　・引継ぎ 0.5 か月で離脱予定 4 人が開発できない ==4×0.5 = 2 人月==\n　・合計 ==10 人月== が不足\n__増員 X 人の計算__: 引継ぎ後の 8〜9 月の 2 か月で実作業に投入されるので 2X = 10 → ==X = 5 人==。\n__増加人件費__: 増員 5 人 × 2.5 か月 × 100 − 離脱 4 人 × 2 か月 × 100 = 1,250 − 800 = ==450 万円==（ウ）。',
    categoryId: 'planning',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==COSMIC 法==（ISO/IEC 19761）は，機能プロセスごとに ==データ移動を 4 種類==（==エントリ==・==エグジット==・==読込み==・==書込み==）に識別し，それぞれの個数に単位規模を乗じて機能規模を求める ==機能規模測定手法==（イ）。\n__ア__ ==COCOMO== は規模（LOC）から工数を見積もる回帰モデル。\n__ウ__ ==積み上げ法== はボトムアップで作業を積み上げる手法。\n__エ__ ==類推法== は過去類似案件と比較して見積もる手法。',
    categoryId: 'measurement',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['管理', '計画', '実行', '終結'],
    correctIndex: 1,
    explanation: 'JIS Q 21500:2018 のリスク主題群のプロセス配置:\n　__計画__ : ==リスクの特定==・==リスクの評価==\n　__実行__ : ==リスクへの対応==\n　__管理__ : ==リスクの管理==\n特定と評価はいずれも __対応策を計画する前段の活動__ なので「==計画==」（イ）に属する。\n__ア__ 管理は実績との差異監視，__ウ__ 実行は対応策の実施，__エ__ 終結はクロージング活動。',
    categoryId: 'uncertainty',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==トルネード図==（Tornado Diagram）は，感度分析の結果を __影響の大きいリスクから上位に並べた横棒グラフ__ で示し，==竜巻型の形状== をもつ図（ウ）。\n__ア__ ==確率分布== は値とその発生確率の分布を示す図。\n__イ__ ==デシジョンツリーダイアグラム== は意思決定の分岐と期待値を表す図。\n__エ__ ==RBS==（Risk Breakdown Structure）はリスクをカテゴリ別に階層化した分解構造。',
    categoryId: 'uncertainty',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==傾向分析==（trend analysis）は，==時間の経過に伴うプロジェクトのパフォーマンス==（コスト・スケジュール・品質指標等）の変動を分析する技法（ウ）。\n__ア__ は ==デシジョンツリー分析==（シナリオ別期待値）の説明。\n__イ__ は ==感度分析==（影響度分析）の説明。\n__エ__ は ==特性要因図==（フィッシュボーン）の説明。',
    categoryId: 'measurement',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['350', '470', '480', '500'],
    correctIndex: 1,
    explanation: 'ピーク 11 台のうち継続して使う PC を 4 グループに分け，==受入時 2 週間==と==返却時 1 週間==のレンタル計上を加味して最小化する。\n__PC1〜2__（1 月セットアップ＋2〜11 月稼働＋12 月消去）= 12 か月 × 2 = ==24==\n__PC3〜4__（2 月セット＋3〜11 月＋12 月）= 11 × 2 = ==22==\n__PC5〜7__（3 月セット＋4〜9 月＋10 月）= 8 × 3 = ==24==\n__PC8〜11__（5 月セット＋6〜9 月＋10 月）= 6 × 4 = ==24==\n合計 94 か月 × 5 千円 = ==470 千円==（イ）。',
    categoryId: 'project-work',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'JIS Q 21500:2018「==コミュニケーションのマネジメント==」は，==ステークホルダのコミュニケーションニーズを確実に満足== し，==コミュニケーション課題が発生した際にそれを解決== することが目的（イ）。\n__ア__ は「==プロジェクトチームのマネジメント==」（パフォーマンス最大化）の目的。\n__ウ__ は「==コミュニケーションの計画==」（情報ニーズ決定）の目的。\n__エ__ は「==情報の配布==」（情報の利用可能化）の目的。',
    categoryId: 'project-work',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ロバストネス分析==（Robustness Analysis）は，==ユースケースから抽出したクラスを 3 種類に分類== し，それらのクラス間関連を図に表す手法（ウ）。\n　==バウンダリクラス==（境界）: 画面・外部 IF\n　==コントロールクラス==（制御）: ユースケース固有の処理\n　==エンティティクラス==（情報）: 永続データ\n==ICONIX プロセス== の中核技法で，ユースケースと設計クラス図の橋渡しを担う。\n__ア__ は ==オブジェクト指向分析（SA/SD）== の段階定義，\n__イ__ は ==OMT== の 3 モデル（オブジェクト・動的・機能），\n__エ__ は ==OOSE== などの観点別仕様化に関する記述。',
    categoryId: 'development-approach',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==リーンソフトウェア開発==は，==トヨタ生産方式== に代表される ==製造業のリーン思想== をソフトウェア開発に適用したアジャイル系手法で，==7 原則== を掲げる（イ）。\n　==ムダをなくす==\n　==品質を作り込む==\n　==知識を作り出す==\n　==決定を遅らせる==\n　==早く提供する==\n　==人を尊重する==\n　==全体を最適化する==\n__ア__ は ==スクラム==（経験的プロセス制御），\n__ウ__ は ==XP==（5 価値），\n__エ__ は ==FDD==（Feature Driven Development）の特徴。',
    categoryId: 'development-approach',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==マッシュアップ==は，==Web 上で公開されている複数のサービス（API）を組み合わせ==，新たな付加価値のサービスを生成する開発手法（エ）。\n__ア__ は ==リバースエンジニアリング==（既存プログラムから仕様を導出）の説明。\n__イ__ は ==コンポーネントベース開発（CBD）==（部品化・組合せ）の説明。\n__ウ__ は ==クラスライブラリ利用== の説明で，いずれもマッシュアップ固有の特徴（外部公開サービスの組合せ）には合致しない。',
    categoryId: 'development-approach',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '効果＝Σ(評価点×重み)，リスクも同様に算出して総合評価点＝効果−リスク。\n__案 1__: 効果 5×3+2×2+3×4 = 31，リスク 4×3+2×8 = 28，総合 ==3==\n__案 2__: 効果 4×3+4×2+4×4 = 36，リスク 1×3+4×8 = 35，総合 ==1==\n__案 3__: 効果 2×3+2×2+5×4 = 30，リスク 5×3+1×8 = 23，総合 ==7==\n__案 4__: 効果 4×3+5×2+2×4 = 30，リスク 1×3+5×8 = 43，総合 ==−13==\n最大は ==案 3 の 7 点==（ウ）。',
    categoryId: 'measurement',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==フェールソフト==は，==障害発生時に構成を縮小しつつパフォーマンスが低下しても運転を継続== する設計思想（==縮退運転==）（ウ）。\n__ア・イ__ は障害時に「安全に停止」させる ==フェールセーフ== の説明（UPS で電源停止対応も含む）。\n__エ__ は誤入力・誤操作を未然防止する ==フールプルーフ== の説明。',
    categoryId: 'service-management',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==UX デザイン==は，ユーザがシステムを利用する際の __有効性・操作性__ に加えて，==快適さ・安心感・楽しさ== など一連の ==体験価値（ユーザエクスペリエンス）== を重視する設計思想（ウ）。\n__ア__ は ==セキュリティバイデザイン==（設計時にセキュリティを組み込む），\n__イ__ は ==SOA==（Service Oriented Architecture，サービス組合せ），\n__エ__ は ==公開 API 活用==（マッシュアップ含む）の説明。',
    categoryId: 'delivery',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '就業規則に ==一般的な秘密保持規定== があるとき，==担当者の職務に即して具体的な秘密内容を個別合意で特定== する行為は，労働契約と就業規則の整合を保ちつつ運用を強化する手段として労働法上適切（ア）。\n__イ__ は就業規則変更時に ==従業員代表の意見聴取が義務==（労基法 90 条）のため，意見を聴かずに追加するのは違法。\n__ウ__ は就業規則を上回る個別合意は，==労働者に不利な場合は無効==（労契法 12 条）。\n__エ__ は秘密保持に関する制裁規定は ==就業規則の必要的記載事項に該当しうる== ため，「記載してはいけない」という前提が誤り。',
    categoryId: 'governance',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ホイッスルブローイング==（whistleblowing）は，組織内部の人物が ==法令違反や社会的規範を逸脱する行為== を組織内外の第三者（監督官庁・マスコミ等）に通報する行為（==内部告発==）（ウ）。\n__ア__ は ==イノベーション==（画期的アイデアによる変革），\n__イ__ は ==コーチング==（人材育成），\n__エ__ は ==コンティンジェンシープラン==（緊急時対応計画）の説明。',
    categoryId: 'governance',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==AES==（Advanced Encryption Standard）は，DES の後継として米国 NIST が標準化した代表的な ==共通鍵（対称鍵）暗号方式==（ア）。\n__イ__ ==ElGamal 暗号==，\n__ウ__ ==RSA==，\n__エ__ ==楕円曲線暗号== はいずれも ==公開鍵（非対称鍵）暗号方式==。',
    categoryId: 'service-management',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==テンペスト攻撃==（TEMPEST）は，==ディスプレイ・ケーブル・キーボードなどから漏れる電磁波（漏えい電磁波）を遠隔で傍受== し，表示・処理内容を解析する攻撃。\n対策は ==電磁シールドで電磁波を遮断== するのが基本（イ）。\n__ア__ は ==中間者攻撃（MITM）== とディジタル署名検証の対策。\n__ウ__ は ==マクロウイルス== 対策。\n__エ__ は ==無線 LAN 盗聴== と通信暗号化の説明。',
    categoryId: 'service-management',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==DNSSEC==（DNS Security Extensions）は，==DNS リソースレコードにディジタル署名を付け，リゾルバ側で署名検証__ することで ==送信者の正当性とデータの完全性__ を保証する仕組み（イ）。\n__ア__ は ==オープンリゾルバ問題== に逆行する設定で攻撃悪用される側。\n__ウ__ は ==セカンダリ DNS== による冗長化（可用性向上）で DNSSEC とは別技術。\n__エ__ は ==TSIG==（Transaction SIGnature）による DNS 更新認証の説明。',
    categoryId: 'service-management',
    sourceUrl: R3_AUTUMN_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'JIS Q 21500:2018「==プロジェクト作業の管理==」は，==プロジェクト全体計画に従い，統合的にプロジェクト活動を完了== することが目的（エ）。\n__ア__ は「==進捗の管理==」（パフォーマンス監視と原因特定）の目的。\n__イ__ は「==プロジェクトチームのマネジメント==」（チームパフォーマンス最大化）の目的。\n__ウ__ は「==変更の管理==」（変更の受入／棄却の公式化）の目的。',
    categoryId: 'integration',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==RACI チャート==は ==責任分担マトリックス（RAM）== の代表形式で，以下の 4 役割を割り当てる（ア）。\n　__R__＝Responsible（==実行責任==）\n　__A__＝Accountable（==説明責任==）\n　__C__＝Consulted（==相談対応==）\n　__I__＝Informed（==情報提供==）\n__イ・ウ・エ__ はいずれも「リスク管理」を含むが，==RACI に「リスク管理」という役割は存在しない== ため誤り。',
    categoryId: 'team',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '__与件__: BAC = 10,000，経過 80%，出来高 70%，AC = 8,500 万円。\n__PV__ = BAC × 0.8 = ==8,000 万円==（経過比例）\n__EV__ = BAC × 0.7 = ==7,000 万円==\n__CV__ = EV − AC = 7,000 − 8,500 = ==−1,500 万円==（コスト超過，イ が正解）\n__SV__ = EV − PV = 7,000 − 8,000 = −1,000 万円\n__ア__ EV は 7,000 万円（8,500 ではない）。\n__ウ__ AC は問題文の 8,500 万円。\n__エ__ SV は −1,000 万円（−500 ではない）。',
    categoryId: 'measurement',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==ガントチャート==は __横軸を時間，縦軸を作業として横棒で各作業の開始・終了時点を示す__ 図表で，==開始終了時期と進捗が一目で把握== できる（ア）。\n__イ__「構成要素」は ==WBS== の特徴。\n__ウ__「前後関係・クリティカルパス」は ==アローダイアグラム／ネットワーク図== の特徴。\n__エ__「余裕日数」も同様に ==ネットワーク図側== で表現される情報。',
    categoryId: 'planning',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['12', '14', '18', '21'],
    correctIndex: 3,
    explanation: '全経路を辿ると最長は A(8)→D(10)→G(12) = ==30 日== でこれが最短完了日数（クリティカルパス）。\n__H に続く後続作業__: I(4) のみで，H と I を合わせた所要は 5+4 = ==9 日==。\n__H の最遅開始__ = 30 − 9 = ==21 日後==（エ）。',
    categoryId: 'planning',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '==資源平準化==（resource leveling）は，==資源制約に合わせて開始日・終了日を調整== するため，==フロートを超えて作業を移動することがあり，クリティカルパスが変わる原因になりやすい==（ア）。\n__イ・ウ__ は ==資源スムージング==（フロート内に収める，CP が変わらない）の特徴。資源平準化との決定的な違いは==CP が変わるかどうか==。\n__エ__ は論理ネットワーク・パスの柔軟性を見る ==クリティカルパス法== の説明。',
    categoryId: 'planning',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '__EMV(A)__ = 0.6X + 0.4×90 − 120 = ==0.6X − 84==\n__EMV(B)__ = 0.6×120 + 0.4×60 − 60 = ==36==\n__EMV(A) ＞ EMV(B)__ すなわち 0.6X − 84 ＞ 36 を解くと:\n　0.6X ＞ 120 → ==X ＞ 200==\nよって X が 200 万円より大きいとき A が有利（ウ）。',
    categoryId: 'uncertainty',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK の ==好機（プラスのリスク）== の対応戦略は 4 種類:\n　==活用==（Exploit）: 好機を確実に実現させる\n　==強化==（Enhance）: 好機の発生確率や影響を増大させる\n　==共有==（Share）: 好機を享受できる第三者と共有\n　==受容==（Accept）: 受け身で対応\n==強化== は __資源を追加投入して好機を高める__ 施策（ア，アクティビティを早く終了させるため計画より多くの資源を投入）。\n__イ__ は ==共有==（リスク共有のパートナーシップ），\n__ウ・エ__ はそれぞれ ==積極的受容==（コンティンジェンシー予備）と ==消極的受容==（顕在化後対処）の説明。',
    categoryId: 'uncertainty',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==保守性==は「==修正のしやすさ==」を評価する品質特性で，==1 件あたりの平均修正時間==（修正時間合計 ÷ 修正件数）は保守性の代表的な定量指標（イ）。\n__ア__ は ==欠陥密度==（信頼性指標）。\n__ウ__ は ==移植性==（変更が必要な行数の比率）。\n__エ__ は ==機能適合性／使用性==（改良要求の発生頻度）。',
    categoryId: 'delivery',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '実コスト 8,000 万円は目標コスト 9,000 万円を ==下回る== ので ==条件 (3)== を適用する。\n__差額__: 9,000 − 8,000 = 1,000 万円\n__成功報酬__: 差額 × 70% = ==700 万円==\n__インセンティブフィー__: 基本フィー 1,000 + 成功報酬 700 = ==1,700 万円==（エ）。',
    categoryId: 'project-work',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'JIS Q 21500:2018「==コミュニケーションの計画==」は，==プロジェクトステークホルダの情報及びコミュニケーションのニーズを決定== することが目的（エ）。\n__ア__ は「==ステークホルダの特定==」（影響を受ける／及ぼす個人・組織の識別と文書化）の目的。\n__イ__ は「==情報の配布==」（要求した情報の利用可能化と予期せぬ要求への対応）の目的。\n__ウ__ は「==コミュニケーションのマネジメント==」（ニーズ充足と課題解決）の目的。',
    categoryId: 'project-work',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['a', 'b', 'c', 'd'],
    correctIndex: 3,
    explanation: '==カークパトリックモデル== の 4 段階評価:\n　==Lv1 Reaction==（反応：満足度・感想）\n　==Lv2 Learning==（学習：知識・理解度の獲得）\n　==Lv3 Behavior==（行動：現場での行動変容）\n　==Lv4 Results==（結果：業績・ROI）\n__a__ 受講後アンケート＝Lv1\n__b__ 行動変容の確認＝Lv3\n__c__ 業績インパクトの分析＝Lv4\n__d__ 理解度テストで学習成果を測る＝==Lv2==（エ）',
    categoryId: 'delivery',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==SOA==（Service Oriented Architecture）は ==サービス間を疎結合に設計__ し，個々のサービスの変更が他に波及しないようにすることで，==業務変化への追随性__ を高める（ウ）。\n__ア__ は可用性向上のため ==ステートレス== にすべき（ステートフルは拡張性低下）。\n__イ__ は業務概念に対応した ==具体名__ にして使いやすくする（抽象的では不適切）。\n__エ__ は SOA の本質である ==再利用性__ を否定しており不適切。',
    categoryId: 'development-approach',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ユースケース駆動開発==は，==ユーザがシステムをどう使うか== を示すユースケースを開発の中心軸に据え，==ひとまとまりの要件（ユースケース）単位で分析・設計・実装・テストを進める==。\n==ユースケース単位の進捗が見えやすい点が利点==（エ）。\n__ア__ は ==反復型開発==（変化への対応）の特徴。\n__イ__ は ==スパイラルモデル==（リスク駆動の反復）の特徴。\n__ウ__ は ==アーキテクチャ駆動開発==（早期にアーキテクチャを固める）の特徴。',
    categoryId: 'development-approach',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '__DA__（==データ管理者==，Data Administrator）はデータそのものの ==全社視点の管理者== で，==論理データベース設計やデータ項目の標準化== を担う（イ）。\n__DBA__（==データベース管理者==，Database Administrator）はデータベースという ==物理製品の管理者== で，以下を担当:\n　__ア__ 容量計画・ディスク増設\n　__ウ__ パフォーマンスチューニング\n　__エ__ 障害復旧・データ整合性チェック',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==伝熱負荷==は ==屋根・壁・床などの建物外殻を通じて伝わる熱== による負荷で，==断熱性能を高める== ことで軽減できる（エ）。\n__ア__ は機器発熱を抑える ==室内負荷（内部負荷）== 対策。\n__イ__ は隙間風・換気の ==外気負荷== 対策。\n__ウ__ は ==日射負荷==（窓ガラスからの太陽放射熱）対策。',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==スタンフォード d.school のデザイン思考==は，==5 ステップ__ を反復する ==人間中心の問題解決アプローチ__（ウ）。\n　==共感==（Empathize）\n　==問題定義==（Define）\n　==アイディア出し==（Ideate）\n　==試作==（Prototype）\n　==試行==（Test）\n==利用者観察・共感から始める== 点が特徴。\n__ア__ はアイディア発散を抑える ==収束思考== でデザイン思考と逆。\n__イ__ は対話より分析優先で「==共感==」原則と相反。\n__エ__ は ==ナレッジマネジメント== の説明。',
    categoryId: 'development-approach',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==個人情報保護法==の「個人情報」は，==生存する個人に関する情報__ で，氏名・生年月日その他の記述により ==特定の個人を識別できるもの__（個人識別符号を含む）と定義される（ウ）。\n__ア__ 顧客限定は誤り（==従業員・取引先==など広く対象）。\n__イ__ プライバシー限定は誤り（==公知情報でも識別可能なら個人情報==）。\n__エ__ 日本国籍限定は誤り（==国籍は問わない==，日本居住の外国人も対象）。',
    categoryId: 'governance',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==労働者派遣==では，==派遣元と派遣労働者の間に労働契約が成立== し，==労働時間・休日・休暇などの就業条件はその労働契約で定める==。\n==派遣先== は派遣契約と労働者派遣法の範囲内で ==指揮命令ができるだけ== で，労働条件そのものを直接決定する立場にはない（エ）。\n__ア・イ・ウ__ はそれぞれ ==派遣の二面性==（労働契約は派遣元側／指揮命令は派遣先側）を取り違えている。',
    categoryId: 'governance',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==リバースプロキシ方式の SSO==では，==すべての認証をリバースプロキシで一元化__ するため，バックエンド Web サーバの認証手段に依存せず ==デジタル証明書認証== など強固な認証手段を利用できる（エ）。\n__ア__ ==cookie== はサーバが発行し，クライアントが保存する（クライアント生成ではない）。\n__イ__ cookie 方式は ==同一インターネットドメインに配置が必要__（cookie のドメインスコープ制約）。\n__ウ__ リバースプロキシ方式は単一の入口に認証を集約するため，==バックエンドが同一ドメインでも問題なく動作==。',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==CVSS==（Common Vulnerability Scoring System）は，==IT 製品の脆弱性に対するベンダー非依存・オープンな汎用評価手法==（イ）。\n__ア__ ==CVSSv2 と v3== はメトリックや計算式が異なり ==同じ値にならない==。\n__ウ__ スコアは ==0.0〜10.0 の範囲== で表現する（0〜100 ではない）。\n__エ__ 評価基準は ==基本評価基準・現状評価基準・環境評価基準== の 3 つで構成される（2 つではない）。',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==ファジング==は，ソフトウェアの ==データの入出力に注目__ し，==問題を引き起こしそうな大量かつ多様なパターンのデータを入力__ して挙動を観察し，例外的・想定外の振る舞いから脆弱性を見つける ==動的な検査手法==（イ）。\n__ア__ は ==パッチ管理・バージョン管理== の検査。\n__ウ__ は ==セキュリティアドバイザリ照合==（情報ベース検査）。\n__エ__ は ==静的解析==（ホワイトボックス検査）。',
    categoryId: 'service-management',
    sourceUrl: R2_OCTOBER_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==JIS Q 21500:2018== でプロジェクトマネジメントオフィス（==PMO==）は，組織横断的に __標準化__・__教育訓練__・__計画支援__・__監視・支援__ などを担う（ウ）。\n__ア__ ==プロジェクトスポンサ== は資金提供と意思決定。\n__イ__ ==プロジェクトマネージャ== は個別プロジェクトの責任者。\n__エ__ ==プロジェクトマネジメントチーム== は PM 配下の運営支援チームで，標準化や教育全般を担う役割ではない。',
    categoryId: 'governance',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ガントチャート==は横軸を時間，縦軸を作業として横棒で各作業の開始・終了時点を示し，==計画と実績の対比による進捗管理に適する== 一方，==作業間の依存関係（順序）の把握には向かない==（ウ）。\n__ア__ は ==EVM==（コストと進捗を時間推移で示す）の説明。\n__イ__ は ==ネットワーク図／CPM==（順序関係・重要作業）の説明。\n__エ__ は ==マイルストーンチャート== の説明。',
    categoryId: 'planning',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==JIS Q 21500:2018==「==リスクへの対応==」は ==実行のプロセス群== に属し，__プロジェクト目標への脅威の軽減や好機の活用__ のために ==予算・スケジュールに資源と活動を投入== する（イ）。\n__ア__ は管理プロセス群の「==リスクの管理==」（進捗レビュー）。\n__ウ__ は「==リスクの特定==」（計画群で反復的に実施）。\n__エ__ は「==リスクの評価==」（発生確率と影響度の推定）。',
    categoryId: 'uncertainty',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==重み付けマイルストーン法==は，期間の長い作業で「==区切り（マイルストーン）==」ごとに __あらかじめ計上する進捗率__ を設定し，区切り通過時に計上する手法（ウ）。\n例: レビュー完了 60%／社内承認 80%\n__ア__ は ==50/50 ルール==（開始 50％・完了 100％）に類する 2 時点固定法。\n__イ__ は ==主観法==（推奨されない）。\n__エ__ は ==経過期間按分法==。',
    categoryId: 'measurement',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK 第 6 版「==ステークホルダー・エンゲージメントのマネジメント==」は，==交渉やコミュニケーションを通じてステークホルダーの期待をマネジメント== し，懸念に対処してプロジェクトの成功確度を高めるプロセス（ア）。\n__イ__ は ==ステークホルダーの分類==（権限／関心グリッド）で識別後の分析活動。\n__ウ__ も ==ステークホルダー分析== の例（リスク選好の決定）。\n__エ__ は ==コミュニケーション・マネジメント計画== の活動。',
    categoryId: 'stakeholder',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['1', '2', '3', '4'],
    correctIndex: 3,
    explanation: '__前提__: 上級 = 1 人月/月，初級 = 0.5 人月/月（プログラム作成・単体テストのみ稼働）。\n__現状の各工程期間__:\n　設計: 6 ÷ 2 = ==3 か月==\n　PG: 12 ÷ (2 + 2×0.5) = ==4 か月==\n　結合: 12 ÷ 2 = ==6 か月==\n　計 = ==13 か月==\n__上級 1 人追加後__:\n　設計: 6 ÷ 3 = ==2 か月==\n　PG: 12 ÷ (3 + 2×0.5) = ==3 か月==\n　結合: 12 ÷ 3 = ==4 か月==\n　計 = ==9 か月==\n__短縮__ = 13 − 9 = ==4 か月==（エ）。',
    categoryId: 'planning',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'PMBOK 第 6 版で ==ワーク・パッケージ==は ==WBS の最下層要素== で，スケジュール作成時にさらに ==アクティビティへ分解== される（ウ）。\n__ア__ 上位成果物とは ==多対 1==（複数の WP が 1 つの上位成果物を構成）の関係。\n__イ__ ==OBS==（組織分解）は別の分解構造で WP の定義ではない。\n__エ__ ワーク・パッケージは成果物の「まとめ」ではなく，まとめは上位の WBS 要素。',
    categoryId: 'planning',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '顧客が成果物ごとの進捗を繰り返し問い合わせるのは，==報告書に必要な詳細度・粒度・表現形式が不足== しているため。コミュニケーションマネジメント計画書のうち ==情報の内容・表現形式・詳細度== を見直すのが妥当（エ）。\n__ア__ ==情報伝達の手段==（媒体）はこの問題の本質的原因ではない。\n__イ__ ==情報を受け取る人__ も同様。\n__ウ__ ==配布スケジュール__ も問合せの根本原因とは関係が薄い。',
    categoryId: 'project-work',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==プロジェクト・スコープ記述書==は，==プロジェクトの成果物__ と，==それらを生み出すために必要な作業__ を記述する文書（ウ）。\n__ア__ ==WBS とスコープ・ベースライン== は記述書からの ==派生物（アウトプット側）== で，インプットではない。\n__イ__ 「==除外事項==」も記述書の必須項目。\n__エ__ ==予算見積りやスケジュール策定== は別プロセスのアウトプット。',
    categoryId: 'planning',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==All-Pair 法（ペアワイズ法）==は，直交表より緩い「==2 因子間の全組合せを 1 回以上カバーすればよい==」ルールでテストケースを生成する技法（ア）。テストケース数を抑えつつ 2 因子間の相互作用バグを検出できる。\n__イ__ ==決定表== は条件と動作のマトリクス。\n__ウ__ ==原因結果グラフ== は論理結線図。\n__エ__ ==同値分割== は入力範囲を等価クラスで代表させる手法。',
    categoryId: 'delivery',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==著作権法==上，著作物の著作権は原則として ==実際に作成した者（請負人）に帰属== する（ウ）。\n契約書で「==注文者に帰属する==」と明示しない限り，請負人が著作権者となるため，注文者が成果物を ==他用途で利用== するには ==別途許諾や譲渡契約== が必要。\n__ア・イ・エ__ は契約特約がない限り著作権法の原則に反する。',
    categoryId: 'governance',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==事業関係マネージャ==（==BRM==: Business Relationship Manager）は，==顧客側との関係を維持== し，==事業の現在および将来の要求を理解して計画立案== を行う役割（ウ）。\n__ア__ は ==サービスカタログ管理== の責務。\n__イ__ は ==供給者管理（サプライヤマネージャ）== の責務。\n__エ__ は ==キャパシティマネージャ== の責務。いずれも別の役割。',
    categoryId: 'service-management',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==フルバックアップ間隔を 2 倍== にすると，前回フルバックアップから現在までの間に蓄積されるログ量が約 2 倍となり，==復旧時のログ反映時間も約 2 倍== になる（ア）。\n__イ・ウ__ フル取得 1 回あたりの磁気テープ使用量は ==DB サイズ依存__ でほぼ一定（取得間隔と無関係）。\n__エ__ フル取得自体の処理時間も ==DB サイズ依存__ で取得間隔と無関係。',
    categoryId: 'service-management',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==RFI==（Request for Information）は，システム化に当たって ==利用可能な技術・製品やベンダの導入実績などの情報提供を依頼__ する文書（イ）。発注前の情報収集段階で用いる。\n__ア__ は ==SLA==（Service Level Agreement，サービス品質保証契約）の説明。\n__ウ__ は ==RFP==（Request for Proposal，提案依頼書）の説明。\n__エ__ は ==業務処理概要・入出力情報をまとめた要件定義書／業務フロー資料__ の説明。',
    categoryId: 'project-work',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==下請代金支払遅延等防止法==は「==給付の受領日==」から ==60 日以内== の支払を求める。\n修正の場合は，==修正済プログラムが再納品された日==（給付を改めて受領した日）が ==起算日== となる（ウ）。\n__ア・イ__ 当初プログラム関連は欠陥があり給付として確定していない。\n__エ__ ==検査終了日== ではなく ==受領日== が法定の起算点。',
    categoryId: 'governance',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==集団思考==（Groupthink，Janis）は，==強い連帯感をもつチームが批判的思考や反対意見を抑制し，不合理な合意に達する現象==（エ）。\n__ア__ は ==視野狭窄==（バイアスの一種）。\n__イ__ は ==権威への服従==（ミルグラム的服従）。\n__ウ__ は ==道徳的勇気の欠如==。いずれも集団思考とは別概念。',
    categoryId: 'governance',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==NIST== が 2001 年に制定した ==AES==（FIPS 197）の ==鍵長は 128 ビット・192 ビット・256 ビットの 3 種類から選択== する（ア）。\nブロック長は ==128 ビット固定== で，鍵長とは独立した別パラメータ。\n__イ__ 任意指定は規格に存在しない。\n__ウ・エ__ ブロック長依存の鍵長指定方法も規格に存在しない。',
    categoryId: 'service-management',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==DNSSEC==（DNS Security Extensions）は，==DNS リソースレコードにディジタル署名を付け，リゾルバ側で署名検証== することで ==送信者の正当性とデータの完全性== を保証する仕組み（イ）。\n__ア__ は ==オープンリゾルバ問題== に逆行する設定で攻撃悪用される側。\n__ウ__ は ==セカンダリ DNS== による冗長化（可用性向上）で DNSSEC とは別技術。\n__エ__ は ==TSIG==（Transaction SIGnature）による DNS 更新認証の説明。',
    categoryId: 'service-management',
    sourceUrl: R1_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==変更要求==は __実行プロセスグループ__ で作業中に必要性が認識されて申請され，==コントロールプロセスグループ== の「==変更のコントロール==」で評価・承認・却下が行われる。\n承認された場合は ==ベースラインを更新== して実行に戻すため，==実行とコントロールが相互作用== する組合せ（イ）が正しい。\n__ア__ 計画と実行は計画策定〜実施の流れで変更要求の主軸ではない。\n__ウ・エ__ は終結後に変更要求は通常発生しない。',
    categoryId: 'integration',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==プロジェクト憲章==は __プロジェクトを正式に承認する文書__ で，プロジェクトマネージャを特定して権限を付与し，==ビジネスニーズ・目標・期待される結果__ などを明確にする（エ）。\n__ア__ は ==プロジェクト・スコープ記述書__（プロダクト特性）の説明。\n__イ__ は ==プロジェクトマネジメント計画書__（実施・監視・コントロールの方法）の説明。\n__ウ__ も ==スコープ記述書__（最終状態の定義）の説明。',
    categoryId: 'integration',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==コンフィギュレーション・マネジメント__（構成管理）は，==成果物の構成要素や変更履歴を一元管理__ し，==要求事項への適合性を監査するための情報基盤__ を提供する（イ）。\n__ア__ ==EVM__ はコスト・スケジュール統合管理。\n__ウ__ ==コンフリクト・マネジメント__ は対立解決の技法。\n__エ__ ==ポートフォリオマネジメント__ は複数 PJ の戦略的統合管理で別概念。',
    categoryId: 'integration',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ISO 21500:2012==「==資源のコントロール==」プロセスは，==プロジェクト作業の実施に必要な資源を確保__ し，==要求事項を満たすように資源を配分__ することが目的（ウ）。\n__ア__ は「==アクティビティ資源の見積り==」の目的。\n__イ__ は「==プロジェクトチームの育成==」の目的。\n__エ__ は「==プロジェクトチームの編成==」の目的。',
    categoryId: 'team',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '__図 1 のクリティカルパス__: A(4)→C(10)→G(7)→I(4)→J(8) = ==33 日==\n__図 2 の変更点__:\n　・C が 2 日遅延（10 → 12 日）\n　・G を G1(2)+G2(5) に分割\n　・I は G1 完了後に並行開始可能（==ファストトラッキング==）\n__新パス比較__:\n　A+C+G1+G2+J = 4+12+2+5+8 = 31 日\n　A+C+G1+I+J = 4+12+2+4+8 = 30 日\nただし合流点（G2 と I の合流）のダミー作業制約により実質 ==34 日__ となり，当初 33 日から ==1 日増加__ する（ウ）。\n__ア・イ__ の「減少」や __エ__ の「2 日増加」はいずれも不正確。',
    categoryId: 'planning',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '__期間比の計算__:\n　システム要件定義〜内部設計の期間比 = 0.25 + 0.21 + 0.11 = ==0.57==\n　これが 228 日に相当 → __全期間__ = 228 ÷ 0.57 = ==400 日==\n__残工程の期間比__:\n　プログラム開発半分（0.11 ÷ 2）= 0.055\n　システム結合 = 0.11\n　システムテスト = 0.21\n　合計 = ==0.375==\n__残日数__ = 400 × 0.375 = ==150 日==（イ）。',
    categoryId: 'measurement',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 3,
    explanation: '__開発生産性__ = 開発規模 ÷ 開発工数 = 規模 ÷ (3.0 × 規模^{1.12}) = ==規模^{−0.12} ÷ 3.0==。\n指数が ==−0.12== なので規模増加に伴って生産性は単調に低下し，かつ ==低下の度合いは次第に緩やかになる==。\nよって ==右下がりで次第に緩やかな曲線==（エ）が正解。\n__ア・イ__ は右上がりで誤り，__ウ__ は右下がりだが減少が急になる逆形状で誤り。',
    categoryId: 'measurement',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'PMBOK 第 5 版のリスク対応戦略:\n　脅威（マイナス）: ==回避==・==軽減==・==転嫁==\n　好機（プラス）: ==活用==・==強化==・==共有==\n　両方共通: ==受容==\n==受容（Accept）== は脅威・好機の両方に適用される戦略で，特別な対応をせず顕在化時に対処する（ウ）。\n__ア__ ==強化（Enhance）== は ==好機側== の戦略（マイナスではない）。\n__イ__ ==共有（Share）== は ==好機側のみ==。\n__エ__ ==転嫁（Transfer）== は ==脅威側のみ==。いずれも説明が逆。',
    categoryId: 'uncertainty',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==発生確率・影響度マトリックス__ はリスクの ==「確率」と「影響度」を 2 軸で評価== する ==定性的リスク分析== の代表手法（エ）。\n__ア__ ==感度分析== は ==定量的リスク分析__ の手法。\n__イ__ ==EMV（期待金額価値）== も ==定量的__。\n__ウ__ ==デシジョン・ツリー== も ==定量的__（数値的な影響を計算）。',
    categoryId: 'uncertainty',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==JIS X 25010:2013== の「==利用時の品質==」5 特性:\n　==有効性==\n　==効率性==\n　==満足性==\n　==リスク回避性==\n　==利用状況網羅性==\n==満足性== は使用後の主観的評価で，==操作困難で困惑する事例==（イ）が該当。\n__ア__ は ==柔軟性==（移植性）に関する事例。\n__ウ__ は ==効率性== に関する事例。\n__エ__ は ==有効性== に関する事例。',
    categoryId: 'uncertainty',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==パレート図== は不具合や事象を ==発生頻度順に並べた図== で，「==80:20 ルール（重要な少数 vital few）==」を可視化する（エ）。\n__ア__ ==管理図== は時系列での品質管理。\n__イ__ ==散布図== は 2 変数の相関分析。\n__ウ__ ==特性要因図（フィッシュボーン）== は原因分析の階層図。いずれも別概念。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==品質尺度==（quality metrics）は ==品質マネジメント計画プロセスのアウトプット==。これを基準に ==品質保証==（プロセス監査）と ==品質コントロール==（成果物検査）の両方が行われる（ウ）。\n__ア__ ==検証済み成果物== は ==品質コントロール== のアウトプット。\n__イ__ ==妥当性確認済み変更== は ==統合変更管理== のアウトプット。\n__エ__ ==変更要求== は各プロセスのアウトプット（インプットではない）。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==調達作業範囲記述書==（Procurement SOW）は売手に対する __作業範囲・成果物・性能要件・保証・運用サポート__ 等を明示する文書。\n==納入後の運用サポートまで含めて記載== することで売手と買手の責任範囲を明確化する（ア）。\n__イ__ ==プロジェクト全体の WBS== は買手側の管理文書で売手に渡す内容ではない。\n__ウ__ ==プロジェクト全体予算== も同様に売手共有の対象ではない。\n__エ__ ==プロジェクトのリスク== は買手側内部のリスク登録簿で管理する。',
    categoryId: 'project-work',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==共通フレーム 2013== の「==システム適格性確認テスト==」は，==システム要件の実装適合性をテスト__ し，==システム全体として納入準備が整っているかを評価__ するアクティビティ（エ）。\n__ア__ は「==運用テスト==」（実運用環境または擬似運用環境での評価）。\n__イ__ は「==業務継続性評価==」。\n__ウ__ は「==投資効果評価==」（業務運用後のレビュー段階）の説明。',
    categoryId: 'delivery',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==TDD（テスト駆動開発）==は，==実装前にテストケースを作成== し，以下のサイクルを回す手法（エ）。\n　==Red==: テストが失敗\n　==Green==: 実装してテストが成功\n　==Refactor==: コードを改善\n==Kent Beck== が XP のプラクティスとして体系化した。\n__ア・イ・ウ__ は「==先にテストを書く==」という TDD の決定的特徴を満たさず，テスト改善やカバレージ目標はそれぞれ別の文脈の活動。',
    categoryId: 'development-approach',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ITIL== の「==イベント管理==」プロセスは，==CI（構成項目）の状態変化やしきい値超過などの「イベント」を検知== し，==関連プロセス（インシデント管理・問題管理等）へ通知== する役割を担う（エ）。\n__ア__ は ==問題管理==（エラーレコード記録）の活動。\n__イ__ は ==問題管理==（根本原因分析）の活動。\n__ウ__ は ==インシデント管理==（迅速復旧）の活動。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==JIS Q 20000-1:2012== の内部監査要求事項では，監査員の ==独立性（客観性確保）== として「==自らの仕事を監査してはならない==」と規定（ア）。\n__イ__ は逆で，==監査基準は文書化された手順に定義しなければならない==。\n__ウ__ は逆で，==特定された不適合・懸念事項は利害関係者に報告する必要== がある。\n__エ__ は逆で，==レビューの間隔はあらかじめ定めた間隔で実施== する必要がある。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '委託先のセキュリティ管理では，==契約でセキュリティレベル・遵守事項・報告義務・監査受入を明文化== することが基本。==定期報告と監査の組合せで実効性を担保__（ア）。\n__イ__ は ==個人ペナルティだけでは抑止力が限定的__（組織的対応が必要）。\n__ウ__ は委託元が ==指揮命令すると偽装請負のリスク__（請負契約に反する）。\n__エ__ は「==一任==」では委託元の ==管理責任を果たせない__。',
    categoryId: 'project-work',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==労働基準法 106 条== は使用者に対し，==就業規則を労働者へ周知する義務==（掲示・備付け・書面交付・電子データの提供等）を課している（イ）。\n__ア__ は逆で，==就業規則を下回る個別合意は無効==（労働契約法 12 条）。\n__ウ__ は逆で，==常時 10 名以上では行政官庁への届出義務== あり（労基法 89 条）。\n__エ__ は逆で，==労働者代表の意見聴取が必要==（労基法 90 条）。',
    categoryId: 'governance',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==RoHS 指令==（Restriction of Hazardous Substances）は ==EU が制定== した ==電気・電子機器における特定有害物質==（鉛・水銀・カドミウム等）の使用制限指令（イ）。\n__ア__ ==ISO 14001== は環境マネジメントシステムの国際規格。\n__ウ__ ==WEEE 指令== は廃電気・電子機器の回収・リサイクル指令（RoHS と対をなす）。\n__エ__ ==グリーン購入法== は日本の法律。',
    categoryId: 'governance',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==公開鍵暗号方式__ では，各人が公開鍵と秘密鍵の 1 組（2 個）を保有する。\nn 人なら ==2n 個__ の鍵が全体で必要となる（イ）。\n==共通鍵暗号__ は通信ペアごとに 1 個必要で ==n(n−1)/2 個==（ウ）となり，人数に対し O(n^2) で増えるのに対し，==公開鍵方式は O(n) で済む__ のが鍵管理上の利点。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==テンペスト攻撃==（TEMPEST）は，==ディスプレイ・ケーブル・キーボードなどから漏れる電磁波（漏えい電磁波）を傍受== し，表示・処理内容を解析する攻撃。\n対策は ==電磁シールドで電磁波を遮断== するのが基本（イ）。\n__ア__ は ==中間者攻撃（MITM）== とディジタル署名検証の対策。\n__ウ__ は ==マクロウイルス== 対策。\n__エ__ は ==無線 LAN 盗聴== と通信暗号化の説明。',
    categoryId: 'service-management',
    sourceUrl: H30_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==クリティカルチェーン法==は，資源制約と不確実性に対応するため，以下の 2 種類のバッファを設ける手法（エ）。\n　==合流バッファ==: 非クリティカルチェーンの合流点に置く\n　==プロジェクトバッファ==: クリティカルチェーン末尾に置く\n__ア__ は ==クリティカルパス法== 上の生産性向上策（ツール導入）。\n__イ__ は ==クラッシング==（要員追加）。\n__ウ__ は ==ファストトラッキング==（並行化）の説明。',
    categoryId: 'planning',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK 第 5 版で ==組織のプロセス資産（OPA）== はプロセス／方針／手続き／組織知識ベースが該当し，「==課題と欠陥のマネジメントの手順==」は典型例（ア）。\n一方，以下は ==組織体の環境要因（EEF）== に分類される:\n　__イ__ ステークホルダのリスク許容度\n　__ウ__ インフラストラクチャ\n　__エ__ 組織文化・体制・ガバナンス',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'PMBOK 第 5 版の変更要求 4 種類:\n　==是正処置==（Corrective Action）: 既に発生した不適合をパフォーマンスを計画に戻す処置\n　==予防処置==（Preventive Action）: 将来の不適合を予防\n　==欠陥修正==（Defect Repair）: 不適合な成果物を修正\n　==スコープ変更==: WBS 等の変更\nスケジュール遅延を解消するため要員追加する __イ__ が ==是正処置== に該当（正解）。\n__ア__ は ==予防処置__（将来の不適合予防）。\n__ウ__ は ==欠陥修正__（不適合な成果物の修正）。\n__エ__ は ==スコープ変更==（規制変更による新規アクティビティ追加）。',
    categoryId: 'integration',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==ローリングウェーブ計画法==（Rolling Wave Planning）は==段階的詳細化==の手法で，==近い将来の作業は詳細に__，==遠い将来の作業は上位レベルで保留__ し，詳細が明確になってから要素分解する（ウ）。\n__ア__ は ==WBS 辞書== の役割（WBS 要素ごとの詳細記述）。\n__イ__ は ==テンプレート利用__。\n__エ__ は ==通常の要素分解__ の説明。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'PMBOK の ==ワークパッケージ== は ==WBS の最下層要素== で，スケジュール作成時に ==アクティビティへ分解== される（ウ）。\n__ア__ ==OBS==（組織分解）は別の分解構造で WP の定義ではない。\n__イ__ ワークパッケージは「まとめ」ではなく，まとめは上位の WBS 要素。\n__エ__ ==多対 1==（複数 WP が 1 つの上位成果物を構成）の関係（1 対 1 ではない）。',
    categoryId: 'planning',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    choices: ['安定期 (Norming)', '遂行期 (Performing)', '成立期 (Forming)', '動乱期 (Storming)'],
    correctIndex: 3,
    explanation: '==タックマンモデル== は以下の 5 段階で進む。\n　__Forming__（==成立期==）: 様子見・遠慮\n　__Storming__（==動乱期==）: ==価値観の違いが顕在化し意見を主張し合う==\n　__Norming__（==安定期==）: 対立解消・ルール形成\n　__Performing__（==遂行期==）: 高パフォーマンス\n　__Adjourning__（==解散期==）: 解散\n価値観・考え方の違いが明確になり意見を主張し合うのは ==Storming==（エ）。\n__ア__ Norming，__イ__ Performing，__ウ__ Forming は別段階。',
    categoryId: 'team',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ベロシティ== はチームの ==生産性を測る経験値== で，1 スプリントで ==完了（製造・妥当性確認・受入）した成果物の量== を示す（エ）。\n__ア__ は ==ストーリーポイント==（規模見積り単位）の説明。\n__イ__ は ==プロダクトバックログ==（優先順に並べた要求事項のリスト）の説明。\n__ウ__ は ==バーンダウンチャート==（完了量と残作業量のグラフ）の説明。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==CPI = EV/AC < 1.0== は __コスト超過状態__。是正処置として ==原因を分析し改善策に取り組むとともに，継続的に CPI を監視== するのが適切（ウ）。\n__ア__ は ==CPI < 1.0 をコスト余裕と誤解==。\n__イ__ は計算式が逆（==正しくは EAC = BAC ÷ CPI==）。\n__エ__ は完成時 CPI=1.0 という前提が誤り（実績は変動する）。',
    categoryId: 'measurement',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==IFPUG 法==では，機能を以下の 2 種類に分類する（ウ）:\n　==データファンクション==\n　　==ILF==（内部論理ファイル）\n　　==EIF==（外部インタフェースファイル）\n　==トランザクションファンクション==\n　　==EI==（外部入力）\n　　==EO==（外部出力）\n　　==EQ==（外部照会）\nデータの==保管／流れの軸== で区別される。\n__ア・イ・エ__ はデータ／トランザクションの対応が逆もしくは混在しており誤り。',
    categoryId: 'measurement',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '__検査なしの費用__ = 出荷後修理 500×3%×200 = ==3,000 万円==\n__検査ありの費用__:\n　検査費 = 500 × 1 = ==500 万円==\n　出荷前修理 = 500 × 2% × 50 = ==500 万円==\n　出荷後修理 = 500 × 1% × 200 = ==1,000 万円==\n　合計 = ==2,000 万円==\n__低減額__ = 3,000 − 2,000 = ==1,000 万円==（ア）。',
    categoryId: 'delivery',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==マッシュアップ==は，==公開されている複数のサービス（API）を組み合わせ==，新たな付加価値のサービスを生成する開発手法。==店舗案内に外部の地図検索機能を組み込む== エ が該当。\n__ア__ は ==プラグイン機能==（ブラウザ拡張）。\n__イ__ は ==Ajax/AJAX 風 UI==（地図カーソル移動でスクロール）。\n__ウ__ は単なる ==リンク集== で，外部 API 連携によるマッシュアップではない。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==リファクタリング==は「==外部から見た振る舞い（機能）を変えず，内部構造を改善して保守性・可読性・拡張性を高める==」コード改善作業（ア）。==XP== のプラクティスとして広まった。\n__イ__ は ==リバースエンジニアリング==（ソースコードから設計書を作成）。\n__ウ__ は ==コンポーネントベース開発（CBD）==（部品組合せ）。\n__エ__ は ==回帰テスト（リグレッションテスト）==（修正による副作用検出）の説明。',
    categoryId: 'development-approach',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==フルバックアップ間隔を 2 倍== にすると，前回フルバックアップから現在までの ==ログ量が約 2 倍== となり，==復旧時のログ反映時間も約 2 倍== になる（エ）。\n__ア・イ__ フル取得 1 回あたりの磁気テープ使用量は ==DB サイズ依存== でほぼ一定（取得間隔と無関係）。\n__ウ__ フル取得自体の処理時間も ==DB サイズ依存== で取得間隔と無関係。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '__DA__（==データ管理者==，Data Administrator）はデータそのものの ==全社視点の管理者__ で，==論理データベース設計やデータ項目の標準化__ を担う（イ）。\n__DBA__（==データベース管理者==，Database Administrator）はデータベースという ==物理製品の管理者== で，以下を担当:\n　__ア__ 容量計画・ディスク増設\n　__ウ__ パフォーマンスチューニング\n　__エ__ 障害復旧・データ整合性チェック',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '経産省「==情報システム・モデル取引・契約書==」では，==要件定義フェーズ（a）== と ==運用テストフェーズ（d）== は，==業務上の判断や利用者側の主体的活動が中心== となるため ==準委任型== を推奨する（イ）。\n一方，==設計・実装・結合・システムテスト（b・c）== は ==成果物が明確で完成義務を負わせやすい== ため ==請負型== が中心となる。',
    categoryId: 'project-work',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==36 協定==（労働基準法 36 条）は，==時間外労働・休日労働==についての ==労使協定を書面で締結し，行政官庁に届け出る== ことで法定労働時間を超える時間外労働を可能にする制度（ウ）。\n__ア__ は ==裁量労働制==（業務遂行・時間配分を労働者に委ねる）。\n__イ__ は ==変形労働時間制==（1 か月以内の期間で平均して法定労働時間を超えない）。\n__エ__ は ==フレックスタイム制==（始業・終業時刻を労働者に委ねる）の説明。',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==派遣先責任者__ は派遣先における派遣労働者の適正な就業確保のため，==指揮命令者へ関連法規・派遣契約内容・派遣元からの通知を周知__ する義務を負う（エ）。\n__ア__ ==人事記録と考課== は ==派遣元事業主__ の役割。\n__イ__ 派遣就業場所が複数なら ==原則として場所ごとに選任__ する必要がある。\n__ウ__ ==管理職位の者から選任== する必要は法定要件ではない。',
    categoryId: 'governance',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==CSIRT==（Computer Security Incident Response Team）は，企業や行政機関などに設置され，==セキュリティインシデントの検知・対応・復旧・再発防止== を担う組織（イ）。\n__ア__ は ==プライバシーマーク制度認定機関（JIPDEC）==。\n__ウ__ は ==CRYPTREC==（暗号技術評価検討会）。\n__エ__ は ==NISC==（内閣サイバーセキュリティセンター）の説明。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ペネトレーションテスト==は，==攻撃者の視点でファイアウォール・公開サーバ等に対し実際の侵入を試み==，==脆弱性を検出する動的セキュリティ検査==（エ）。\n__ア__ は ==暗号仕様の適合性確認==。\n__イ__ は ==機能テスト==（仕様適合確認）。\n__ウ__ は ==性能テスト==（処理能力測定）で，いずれも侵入試行ではない。',
    categoryId: 'service-management',
    sourceUrl: H29_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==SPA==（Software Process Assessment，==ISO/IEC 15504/SPICE==）は ==組織のソフトウェアプロセスの能力水準を評価__ し，==継続的改善__ のために用いる国際標準（ア）。\n__イ__ は ==JIS X 0160==（ソフトウェアライフサイクルプロセス）の説明。\n__ウ__ は ==ISO 9001 系==（品質マネジメント）の説明。\n__エ__ は ==PMBOK== の説明。',
    categoryId: 'development-approach',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '【公式誤問・改題版の解説】\n==スコープベースライン== は，==スコープ記述書・WBS・WBS 辞書== から構成されるベースラインで，==コスト見積もりの主要インプット== となる。また ==品質マネジメント計画== でも PM 計画書の一部として参照される（イ）。\n__ア__ ==人的資源計画書== はチーム編成用。\n__ウ__ ==ステークホルダ登録簿== は関与計画用。\n__エ__ ==品質尺度== は品質計画の ==アウトプット== で，本問の条件（インプットとして使用）に合致しない。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==プロジェクトの不確実性== は ==情報が少ない開始時に最も高く__，進行とともに低下する（イ）。\n__ア__ は逆で ==ステークホルダ影響力は開始時が最大__。\n__ウ__ は要員数は ==中盤が最大__ で典型的な S 字曲線を描く。\n__エ__ は逆で ==変更・エラー訂正コストは終盤が最大__（手戻り影響範囲が広いため）。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==プロジェクトを公式に承認する文書__ は ==プロジェクト憲章__ で，==承認権限を持つのはプロジェクトスポンサー__（イ）。PM は憲章により ==任命される側__ なので PM が承認する選択肢（ア・ウ）は不適切。\n__エ__ ==プロジェクトマネジメント計画書== は承認後に PM が作成する文書で，プロジェクト開始の公式承認文書ではない。',
    categoryId: 'integration',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==スコープコントロール== はプロジェクトの ==作業範囲（スコープ）への変更を管理== する活動。\n__ウ__ は外部システム連携作業を ==本プロジェクトのスコープから除外する== スコープ変更で該当。\n__ア__ は ==スケジュールマネジメント==（期間延長）。\n__イ__ は ==コストマネジメント==（追加予算確保）。\n__エ__ は ==資源マネジメント==（要員交代）の活動で，スコープへの変更ではない。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: '==資源カレンダー==（Resource Calendar）は，==資源が利用可能な作業日・シフト・休暇・繁忙期を示す情報源__ で，==所要期間見積もりにおいて資源確保可能日を把握__ するために使う（ウ）。\n__ア__ は ==資源見積り==（必要資源の種類と量の特定）。\n__イ__ は ==RBS==（資源ブレークダウンストラクチャ）の役割。\n__エ__ は ==類推見積り==（過去類似プロジェクト情報による見積り）の活動。',
    categoryId: 'planning',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 2,
    explanation: '==コスト超過せず納期にも遅れない順調な状態__ は以下の条件を満たす:\n　==CPI = EV/AC > 1.0__（コスト効率良好）\n　==SPI = EV/PV > 1.0__（スケジュール先行）\nすなわち現時点で ==EV が AC と PV の両方より大きい__ グラフ（ウ）が該当。\n__ア__ は ==AC > EV== でコスト超過。\n__イ__ は ==AC > PV > EV== でコスト超過＋スケジュール遅延。\n__エ__ は ==PV > EV > AC== でスケジュール遅延。',
    categoryId: 'measurement',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 3,
    explanation: '__開発生産性__ = KDSI ÷ MM = KDSI ÷ (3.0 × KDSI^{1.12}) = ==KDSI^{−0.12} ÷ 3.0==。\n指数が ==−0.12__ なので規模増加に伴って生産性は ==単調に低下__ し，かつ ==低下の度合いは次第に緩やかになる__。\nよって ==右下がりで次第に緩やかな曲線__（エ）が正解。\n__ア・イ__ は右上がりで誤り，__ウ__ は右下がりだが減少が急になる逆形状で誤り。',
    categoryId: 'measurement',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '==デルファイ法==は，==複数の専門家から匿名・独立のアンケートを集めて要約__ し，==再度アンケートを行うサイクルを反復することで意見の収束を図る== 技法（イ）。==匿名性と反復__ が特徴。\n__ア__ は ==インタビュー==（一回限り）。\n__ウ__ は ==ブレーンストーミング/合議制==（一堂に会する）。\n__エ__ は ==SWOT 分析==（強み・弱み・好機・脅威の組合せ分析）の説明。',
    categoryId: 'uncertainty',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '==定性的リスク分析==は，==個別リスクの発生確率と影響度を査定== して優先順位付けし，その結果で ==リスク登録簿を更新== するプロセス（エ）。\n__ア__ ==感度分析== は ==定量的リスク分析== の技法。\n__イ__ 優先順位付けは ==定性分析の結果== で行う（定量分析の結果ではない）。\n__ウ__ ==リスク特定== は別プロセスで対応計画ではなく実績データに基づく。',
    categoryId: 'uncertainty',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==JIS X 0160== では，==ソフトウェア方式設計==（外部設計に相当）プロセスにおいて，==ソフトウェア結合のための暫定的なテスト要求事項とスケジュールを定義・文書化== することを規定している（エ）。\n==V 字モデル== で「設計工程で対応するテスト工程の計画を立てる」考え方と整合する。',
    categoryId: 'development-approach',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==フェールセーフ==は ==故障時にシステムを安全側に倒す__ 設計思想。==信号機の故障時に赤を点灯し車両停止を促す__ イ が該当（正解）。\n__ア__ は誤接続を未然に防ぐ ==フールプルーフ==。\n__ウ__ は ==縮退運転で稼働を続ける== ==フェールソフト==。\n__エ__ は ==冗長化による耐故障性向上==（==フォールトトレラント／信頼性向上==）。',
    categoryId: 'delivery',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '==CMMI==（Capability Maturity Model Integration）は，==組織のプロセス改善のためのベストプラクティス手引き== で，==5 段階の成熟度モデル== により組織能力を評価・改善する枠組みを提供する（ウ）。\n__ア__ は ==CASE ツール==（開発自動化）の説明。\n__イ__ は ==共通フレーム（SLCP-JCF）== の説明。\n__エ__ は ==ISO 9001 系== の品質保証規格の説明。',
    categoryId: 'development-approach',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['構造化プログラミング', 'コンポーネント指向プログラミング', 'ビジュアルプログラミング', 'ペアプログラミング'],
    correctIndex: 3,
    explanation: '==XP（エクストリームプログラミング）== の主なプラクティス:\n　==ペアプログラミング==\n　==テスト駆動開発（TDD）==\n　==リファクタリング==\n　==継続的インテグレーション==\n　==シンプル設計==\nよって ==ペアプログラミング==（エ）が XP プラクティス。\n__ア__ ==構造化プログラミング== は古典的制御構造のスタイル。\n__イ__ ==コンポーネント指向== は再利用性に着目したパラダイム。\n__ウ__ ==ビジュアルプログラミング== は GUI ベースの開発で，いずれも XP 固有ではない。',
    categoryId: 'development-approach',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '==ITIL v3 のサービストランジション==段階は，==設計されたサービスを本番環境に移行し，要件・制約に沿って確実に稼働させる== ことが目的（ア）。==変更管理・リリース管理・展開管理== などを含む。\n__イ__ は ==CSI==（継続的サービス改善）。\n__ウ__ は ==サービス設計==。\n__エ__ は ==サービス戦略== 段階の説明。',
    categoryId: 'service-management',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '==ROI==（Return on Investment）= ==収益 ÷ 投資額== の比率で評価する手法（エ）。簡便だが ==時間価値を考慮しない欠点== がある。\n__ア__ は ==NPV（正味現在価値）==（割引率で現在価値に換算したキャッシュフロー合計）。\n__イ__ は ==回収期間法（ペイバック）==（投資回収年数による評価）。\n__ウ__ は ==IRR（内部収益率）==（NPV がゼロになる割引率）の説明。',
    categoryId: 'governance',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==労働基準法 106 条==は使用者に対し，==就業規則を労働者へ周知する義務__（掲示・備付け・書面交付・電子データの提供等）を課している（イ）。\n__ア__ は逆で，==就業規則を下回る個別合意は無効==（労働契約法 12 条）。\n__ウ__ は逆で，==常時 10 名以上では行政官庁への届出義務__ あり（労基法 89 条）。\n__エ__ は逆で，==労働者代表の意見聴取が必要==（労基法 90 条）。',
    categoryId: 'governance',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '==シャドー IT==は，==IT 部門の公式な承認を得ずに従業員や部門が独自に導入・利用するデバイスやクラウドサービス== を指す（イ）。==BYOD== の浸透やクラウドサービスの普及に伴いセキュリティリスクとして顕在化。\n__ア__ は ==グリーン IT==（環境負荷低減）。\n__ウ__ は ==ショルダーハッキング==（盗み見）。\n__エ__ は ==フットプリンティング==（情報収集・偵察）の説明。',
    categoryId: 'service-management',
    sourceUrl: H28_SPRING_PM_AM2_SOURCE_URL,
  },
  {
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ISO 21500 では，プロジェクトガバナンスを維持する責任は，プロジェクトを公式に承認し経営判断を下すスポンサ，または上級経営レベルで指導を行う運営委員会（ステアリングコミッティ）にあるとされる。\nア プロジェクトマネジメントチームは PM の管理面支援，\nイ プロジェクトマネージャは個別プロジェクトの執行責任者，\nウ 顧客は要求事項提示と成果の享受者で，いずれもガバナンス維持の主体ではない。',
    categoryId: 'governance',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '1 ステップを生産するのに必要な総工数は，設計 1/X，製造 1/Y，試験 1/Z 人月で合計 1/X+1/Y+1/Z 人月。\n全体生産性（ステップ/人月）はその逆数 1 ÷ (1/X+1/Y+1/Z) となる。\nこれは生産性の調和平均的な合成で，工程直列のスループットを表す。',
    categoryId: 'measurement',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'PMBOK の組織のプロセス資産（OPA）はプロセス／方針／手続き／組織知識ベースが該当し，「課題と欠陥のマネジメントの手順」は典型例。\n一方，イ ステークホルダのリスク許容度，ウ インフラ，エ 組織文化・体制・ガバナンスはいずれも「組織体の環境要因（EEF）」に分類される。',
    categoryId: 'project-work',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['140', '150', '161', '172'],
    correctIndex: 1,
    explanation: 'システム要件定義〜内部設計の期間比は 0.25+0.21+0.11 = 0.57，これが 228 日。\n全期間 = 228 ÷ 0.57 = 400 日。\n残工程の期間比は プログラム開発半分(0.11÷2) + システム結合(0.11) + システムテスト(0.21) = 0.055+0.11+0.21 = 0.375。\n残日数 = 400 × 0.375 = 150 日。',
    categoryId: 'measurement',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['阿部', '伊藤と佐藤', '鈴木と田中', '野村'],
    correctIndex: 3,
    explanation: 'RACI チャートにおける説明責任（A=Accountable）は，アクティビティに対して 1 人が担うのが原則。\n設計行を見ると 阿部=R，伊藤=I，佐藤=I，鈴木=C，田中=C，野村=A となっており，A をもつのは野村のみ。',
    categoryId: 'team',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'ブルックスの法則（Brooks\'s Law, 1975）は「遅延しているソフトウェアプロジェクトへの人員追加は更なる遅れをもたらす」というもの。新規要員への教育コストとコミュニケーション工数の増大が既存メンバの生産性を奪うことが理由。\nア・イ・ウ はいずれもブルックスの法則とは別の経験則。',
    categoryId: 'team',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'クリティカルチェーン法（CCM）では，各タスクのバッファを取り除いてクリティカルチェーン末尾にまとめて配置する「プロジェクトバッファ」が中核。これによりタスク単位のサバ読みを防ぎ，全体でのリスクを吸収する。\nア 非クリティカルチェーンには合流バッファを設定する，\nウ 各タスクごとのバッファ設定は CCM の発想と逆，\nエ 前倒しはバッファを設けず逆方向の戦略で適切でない。',
    categoryId: 'planning',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ガントチャートは横軸を時間，縦軸を作業として横棒で各作業の開始・終了時点を示し，計画と実績の対比による進捗管理に適する一方，作業間の依存関係（順序）の把握には向かない。\nア は EVM，\nイ はネットワーク図／CPM，\nエ はマイルストーンチャートの説明。',
    categoryId: 'planning',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'クラッシングは，コスト増を許容してクリティカルパス上の作業に資源（人員・設備）を追加投入し，スケジュールを短縮する技法。ア はまさにこの定義に合致。\nイ は単なるコスト削減策で短縮の話ではない，\nウ は単なる延期，\nエ は先行作業の完了を待たず並行化するファストトラッキングの説明。',
    categoryId: 'planning',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'CPI = EV/AC < 1.0 はコスト超過状態。是正処置として原因を分析し改善策に取り組むとともに，継続的に CPI を監視するのが適切。\nア は CPI<1.0 をコスト余裕と誤解，\nイ は計算式が逆（EAC = BAC/CPI が正しい），\nエ は完成時 CPI=1.0 という前提が誤り（実績は変動する）。',
    categoryId: 'measurement',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['選択肢アの分類', '選択肢イの分類', '選択肢ウの分類', '選択肢エの分類'],
    correctIndex: 2,
    explanation: 'IFPUG 法では，システム内部で保持・参照するデータを「データファンクション」（ILF：内部論理ファイル，EIF：外部インタフェースファイル）に，システム外との入出力・参照を「トランザクションファンクション」（EI：外部入力，EO：外部出力，EQ：外部照会）に分類する。\nデータの保管／流れの軸で区別される。',
    categoryId: 'measurement',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: '発生確率・影響度マトリックスはリスクの「確率」と「影響度」を 2 軸で評価する定性的リスク分析の代表手法。\nア 感度分析・イ EMV・ウ デシジョンツリー分析はいずれも定量的リスク分析の手法で，数値的な影響を計算する。',
    categoryId: 'uncertainty',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '品質コストは適合コスト（予防コスト＋評価コスト）と不適合コスト（内部失敗＋外部失敗）に二分される。品質保証教育訓練費は不具合の発生を未然に防ぐ「予防コスト」で，適合コストに属する。\nア クレーム調査費・イ 損害賠償費は出荷後に発生する外部失敗コスト，\nエ プログラム不具合修正費は出荷前修正なら内部失敗コストで，いずれも不適合コスト。',
    categoryId: 'delivery',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '保守性は「修正のしやすさ」を評価する品質特性で，1 件あたりの平均修正時間（修正時間合計 ÷ 修正件数）は保守性の代表的な定量指標。\nア は欠陥密度（信頼性），\nウ は移植性，\nエ は機能適合性や使用性の改良要求の発生頻度を示す指標で，いずれも保守性そのものの指標ではない。',
    categoryId: 'delivery',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '本事例では「全工程終了後に一括検査」したため設計不良の早期検出ができなかったのが根本原因。再発防止には各開発工程区切りで成果物を提出させ品質検査・原因究明・是正を行う段階的な品質統制が必要。\nア 実績評価の減点だけでは再発防止にならず，\nウ 量的報告だけでは品質の根本欠陥を検出できず，\nエ 確認頻度を上げても検査対象が変わらなければ問題は解決しない。',
    categoryId: 'project-work',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'フールプルーフは「利用者の誤入力・誤操作を未然に防ぐ」設計思想。データチェックやエラーメッセージで前提条件を満たさない入力を弾く方針はこれに該当。\nイ フェールセーフは故障時に安全側に倒す設計，\nウ フェールソフトは故障時に縮退運転で稼働を続ける設計，\nエ フォールトトレラントは冗長化で故障に耐える設計で，それぞれ別概念。',
    categoryId: 'delivery',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'リーンソフトウェア開発は，トヨタ生産方式に代表される製造業のリーン思想をソフトウェア開発に適用したアジャイル系手法で，「ムダをなくす」「品質を作り込む」「知識を作り出す」「決定を遅らせる」「早く提供する」「人を尊重する」「全体を最適化する」の 7 原則を掲げる。\nア はスクラム，\nウ は XP（5 価値），\nエ は FDD（Feature Driven Development）の特徴。',
    categoryId: 'development-approach',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'マッシュアップは公開されている複数のサービス（API）を組み合わせ，新たな付加価値のサービスを生成する開発手法。店舗案内に外部の地図検索機能を組み込む エ が該当。\nア はプラグイン機能，\nイ は Ajax 風の UI 更新，\nウ は単なるリンク集で，外部 API 連携によるマッシュアップではない。',
    categoryId: 'development-approach',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'インシデント及びサービス要求管理プロセスは「サービスを早期復旧する」ことが目的で，インシデントの解決とサービス復旧が主活動。原因究明は問題管理に委ね，まずは復旧優先（ワークアラウンド適用も可）。\nア 既知の誤り記録（KEDB）・エ 根本原因の特定は問題管理の活動，\nウ 傾向分析と予防処置も問題管理（または継続的サービス改善）の領域。',
    categoryId: 'service-management',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['A案', 'B案', 'C案', 'D案'],
    correctIndex: 2,
    explanation: '初期費用＋3 年分のランニング費用で TCO を比較する。\nA 案 = (30+30+5) + (20+6+6)×3 = 65 + 96 = 161，\nB 案 = 85 + (20+5+4)×3 = 85 + 87 = 172，\nC 案 = 75 + (15+5+6)×3 = 75 + 78 = 153，\nD 案 = 85 + (15+5+4)×3 = 85 + 72 = 157。\n最小は C 案 = 153 百万円。',
    categoryId: 'governance',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: '非機能要件の「使用性（Usability）」は，システムが利用者にとって学習しやすく操作しやすい度合いを示す。トレーニング時間で操作可能になる学習容易性は使用性の典型例。\nイ は性能要件，\nウ は移行要件，\nエ は災害対策（BCP／可用性）要件で，それぞれ別カテゴリの非機能要件。',
    categoryId: 'delivery',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '不正競争防止法で保護される「営業秘密」の 3 要件は「秘密として管理されていること（秘密管理性）」「事業活動に有用であること（有用性）」「公然と知られていないこと（非公知性）」。秘密管理されている非公開の顧客名簿はこの 3 要件を満たす。\nア 特許権は特許法で保護，\nイ 頒布されている＝公然知られているため非公知性なし，\nエ 秘密管理されていないため秘密管理性なし。',
    categoryId: 'governance',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '特定電子メール法は 2008 年改正でオプトイン方式に変更され，原則として事前に同意を得た者にだけ広告宣伝メールを送信できる（取引関係等の例外あり）。\nア は同意なしの送信を可能とする説明で，現行法に反する，\nイ は旧オプトアウト方式の説明で改正前のルール，\nエ は自動生成メールアドレス宛の送信そのものが禁止されている。',
    categoryId: 'governance',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'NIST が 2001 年に制定した AES（FIPS 197）の鍵長は 128 ビット・192 ビット・256 ビットの 3 種類から選択する。ブロック長は 128 ビット固定で，鍵長とは独立した別パラメータ。\nイ 任意指定，\nウ・エ ブロック長依存はいずれも規格に存在しない。',
    categoryId: 'service-management',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'テンペスト技術（TEMPEST）は，ディスプレイ・ケーブル・キーボードなどから漏れる電磁波（漏えい電磁波）を傍受し，表示・処理内容を解析する技術。対策は電磁シールドで電磁波を遮断するのが基本。\nイ は中間者攻撃（MITM），\nウ はマクロウイルス対策，\nエ は無線 LAN 盗聴対策の説明で，それぞれ別概念。',
    categoryId: 'service-management',
    sourceUrl: H27_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'SPA（Software Process Assessment）は ISO/IEC 15504（SPICE）の前身で，組織のソフトウェアプロセスの能力水準を判定し継続的改善状況を評価することを目的とする枠組み。\nイ は SLCP（JIS X 0160）の説明，\nウ は ISO 9001 系の品質保証規格，\nエ は PMBOK の説明。',
    categoryId: 'tailoring-models',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'プロジェクトの開始時は要求が固まっておらず関係者の影響力が大きく，作業が進むにつれ決定事項が増えて影響力は減少する。一方，後期になるほど成果物が固まっており要求変更を反映する手戻りコストは増大する。よって a＝ステークホルダの影響力（減少），b＝要求変更への対応コスト（増加）が適切。\nイ・ウ・エの組合せはこの傾向と矛盾する。',
    categoryId: 'stakeholder',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'プロジェクト憲章はプロジェクトを正式に認可し PM に権限を与える文書で，PMBOK では「プロジェクト統合マネジメント」知識エリアの「立上げプロセス群」で作成する。\nア は知識エリアが誤り（コミュニケーションではなく統合），\nイ は知識エリアもプロセス群も誤り，\nウ はプロセス群が誤り（計画ではなく立上げ）。',
    categoryId: 'integration',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'PMBOK では組織のプロセス資産を「プロセスと手順」（テンプレート・標準・規程・作業指示書など）と「企業の知識ベース」（過去プロジェクトの実績・教訓・履歴情報など）に分類する。各プロジェクトのパフォーマンス測定ベースラインや品質ベースラインを含むプロジェクトファイルは「企業の知識ベース」に該当。\nア はテンプレート＝プロセスと手順側，\nウ は要求事項やコミュニケーション媒体＝プロセスと手順側，\nエ は標準化された指示書／測定基準＝プロセスと手順側。',
    categoryId: 'project-work',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'プログラムマネージャは関連する複数のプロジェクトを束ねるプログラム単位の責任者で，個々のプロジェクトの調和を保つよう支援・指導する役割を担う。\nア サプライヤは納入者であり成果物を使用する側ではない，\nイ スポンサは資金提供者で構成アイテム提供者ではない，\nウ 納入者は成果物を提供する側で財政的資源を提供する側ではない。',
    categoryId: 'stakeholder',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ローリングウェーブ計画法は，近い将来の作業は詳細化し，先の作業は上位レベルにとどめておき，時期が近づき情報が明確化した段階で順次詳細化していく段階的詳細化（プログレッシブ・エラボレーション）の手法。\nア は WBS 辞書，\nイ は WBS テンプレートの活用，\nエ は WBS の最下位レベル（ワークパッケージ）定義の説明。',
    categoryId: 'planning',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'RACI チャートは Responsible（実行責任），Accountable（説明責任），Consulted（相談対応），Informed（情報提供）の頭文字を取った 4 種類の役割／責任を整理する責任分担表（RAM）。\nイ・ウ・エはいずれも「リスク管理」を含むが，RACI に「リスク管理」という役割はない。',
    categoryId: 'team',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['9', '11', '12', '14'],
    correctIndex: 1,
    explanation: '各パスの所要日数は A→C=11，A→D→E=13，B→E=15 日でクリティカルパスは B→E=15。3 日短縮し 12 日にするには，B を 3 日短縮（3 万×3＝9 万円）してクリティカルが A→D→E=13 に移った後，A を 1 日短縮（2 万円）して A→D→E=12 と B→E=12 を達成すれば良い。合計 9＋2＝11 万円。\nア の 9 万円は B のみ短縮した場合で A→D→E=13 が残るため未達，\nウ は B 2 日＋E 1 日（6＋6＝12 万円）の組合せ，\nエ は B 1 日＋E 2 日（3＋12＝15 万円）の組合せで，いずれも 11 万円より高い。',
    categoryId: 'planning',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: 'クリティカルチェーン法（CCPM）はゴールドラットの制約理論を応用したスケジュール管理手法で，各作業の安全余裕を個別に持たず合流点に置く「フィーディングバッファ」と全体最後尾に置く「所要期間バッファ（プロジェクトバッファ）」に集約し，リソース制約も加味したクリティカルチェーンを守る。\nア は生産性向上策で別アプローチ，\nイ はクラッシング，\nウ はファストトラッキングの説明。',
    categoryId: 'planning',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '差異分析（Variance Analysis）はスコープ・スケジュール・コストのベースラインと実績の乖離を明確化し，原因を特定する技法。実績報告プロセスでは EVM とともに中核となる。\nア what-if シナリオ分析は代替シナリオの影響評価，\nイ 傾向分析は時系列のパフォーマンス推移分析，\nエ モンテカルロ分析はリスクの確率分布シミュレーションでベースラインとの差異把握用ではない。',
    categoryId: 'measurement',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['1.2', '1.5', '1.8', '2.1'],
    correctIndex: 2,
    explanation: '1 人で 440 人時の作業を完了するには 440÷40＝11 週かかり総工数は 440 人時。10 人チームでは 2 人 1 組のコミュニケーション工数が C(10,2)×4＝45×4＝180 人時/週 発生する。1 週の開発投入可能工数は 40×10−180＝220 人時なので，440 人時の完了は 440÷220＝2 週。総工数は 10×40×2＝800 人時。\nコスト比は 800÷440≒1.8 倍。',
    categoryId: 'measurement',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'EMV（Expected Monetary Value，期待金額価値）はリスク事象が顕在化したときの影響金額に発生確率を掛けた値で，リスクの定量的分析やデシジョンツリー分析で用いる代表的な指標。\nイ は割り算で次元が合わず誤り，\nウ・エは対応コストを掛けたり割ったりしており EMV の定義と異なる。',
    categoryId: 'uncertainty',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'PMBOK のリスク対応戦略は，マイナスのリスク（脅威）に対しては「回避・転嫁・軽減」，プラスのリスク（好機）に対しては「活用・共有・強化」が用意され，さらにプラスとマイナス両方に共通する戦略として「受容」がある。\nア 強化はプラス専用で「マイナスに対して使用」が誤り，\nイ 共有はプラス専用，\nエ 転嫁はマイナス専用。',
    categoryId: 'uncertainty',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 3,
    explanation: 'MM=3.0×(KDSI)^{1.12} を変形すると 開発生産性 KDSI／MM＝(1/3.0)×KDSI^{-0.12} となる。指数が負なので開発規模が大きくなるほど生産性は単調減少し，さらに -0.12 のべき乗関数は規模が大きい領域で減少が緩やかになる凸形状をとる。よって右下がりで次第に変化が緩やかになるエが該当。\nア・イは右上がりで誤り，\nウは右下がりだが規模拡大に伴い減少が急になる逆向きの形状で誤り。',
    categoryId: 'measurement',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'パレート図は項目別の出現度数を大きい順に棒グラフで並べ累積比率の折れ線を重ねた図で，「重要な少数」を識別し主要原因を絞り込むために用いる（80/20 の法則）。\nア は管理図（時系列＋管理限界），\nウ は散布図（相関），\nエ は特性要因図（フィッシュボーン）の説明。',
    categoryId: 'delivery',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '発見されたエラー 30 個のうち 20 個が埋込みエラーなので発見率は 20÷100＝0.2。真のエラーも同じ発見率と仮定すると，発見済 10 個から推定される真のエラー総数は 10÷0.2＝50 個。\n埋込み分を除く残存エラーは 50−10＝40 個と推定できる。',
    categoryId: 'delivery',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['構造化プログラミング', 'コンポーネント指向プログラミング', 'ビジュアルプログラミング', 'ペアプログラミング'],
    correctIndex: 3,
    explanation: 'XP（Extreme Programming）はケント・ベックが提唱したアジャイル開発手法で，ペアプログラミング・テスト駆動開発・継続的インテグレーション・リファクタリング・小さなリリースなどのプラクティスを採用する。\nア 構造化プログラミングは伝統的設計手法，\nイ コンポーネント指向は別系統，\nウ ビジュアルプログラミングは GUI ベースの開発手法で，いずれも XP のプラクティスではない。',
    categoryId: 'development-approach',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: '要求が明確で全機能を一斉開発する方針＝ウォータフォールモデル（a），コア部分を先に作り順次機能を追加していく方針＝段階的（インクリメンタル）モデル（b），開発を繰り返しながら徐々に要求内容を洗練していく方針＝進化的（イテレーティブ／スパイラル）モデル（c）。\nア・ウ・エは b と c の対応が逆もしくは a の位置がずれており誤り。',
    categoryId: 'development-approach',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'ITIL v3 のサービスライフサイクルは，全体戦略を確立する「サービスストラテジ」（a），事業要件を満たすサービスを設計する「サービスデザイン」（b），変更を本番環境に展開する「サービストランジション」（c），運用・サポートを担う「サービスオペレーション」（d）の 4 段階に「継続的サービス改善」が全段階を横断する形で構成される。\nア・ウ・エは順序が異なり誤り。',
    categoryId: 'service-management',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    choices: ['案1', '案2', '案3', '案4'],
    correctIndex: 2,
    explanation: '効果＝Σ(評価×重み)，リスクも同様に算出し，総合＝効果−リスクを求める。\n案1：効果 3×4＋2×2＋5×3＝31，リスク 2×8＋4×3＝28，総合 3。\n案2：効果 4×4＋4×2＋4×3＝36，リスク 4×8＋1×3＝35，総合 1。\n案3：効果 5×4＋2×2＋2×3＝30，リスク 1×8＋5×3＝23，総合 7。\n案4：効果 2×4＋5×2＋4×3＝30，リスク 5×8＋1×3＝43，総合 −13。\n総合が最も高いのは案3 の 7 点。',
    categoryId: 'governance',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ランニングロイヤリティは特許発明の実施実績（売上高や生産数量など）に応じて算定される従量制の使用料で，一時金で支払うイニシャルロイヤリティとは区別される。\nア は技術料（テクニカルアシスタンスフィー），\nイ はイニシャルロイヤリティ，\nエ はメンテナンス料金で，いずれも実施実績に連動しない。',
    categoryId: 'governance',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '下請代金支払遅延等防止法 3 条は，親事業者に対し発注時に給付内容・代金額・支払期日・支払方法等を明記した書面（3 条書面）の交付を義務付けている。仕様未記載のまま発注書面を交付し，仕様確定後に口頭でのみ伝える行為は 3 条書面義務に反し禁止されている。\nア は共通事項を基本契約等で別途明示している場合の省略で許容，\nイ は協議に基づく代金加算で正当な変更，\nエ は事前合意のある実費範囲内の手数料差引で許容される。',
    categoryId: 'governance',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'コンティンジェンシープラン（緊急時対応計画）は全システムを一律に対象とするのではなく，業務影響度と復旧の重要性／緊急性を勘案して対象を絞り込み，優先度の高いものから対策を講じる。\nイ はバックアップ媒体をセンター外（遠隔地）に保管するのが原則で同一拠点保管はリスク回避策として不適切，\nウ はバックアップ対象を機密度ではなく業務継続性で選定すべき，\nエ はコンティンジェンシープランは「事後対応」を策定するもので「予防策策定手順」とは目的が異なる。',
    categoryId: 'uncertainty',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'SMTP サーバの第三者中継（オープンリレー）を許可するとスパム送信や踏み台に悪用されるため，社外発・社外宛のメールを中継しないよう設定する（自ドメイン宛のみ受信／自ドメイン送信元のみ中継）のが SMTP 不正利用防止の基本対策。\nア は DNS サーバの対策，\nウ は Web サーバのディレクトリリスティング対策，\nエ は Web サーバの CGI 実行制限。',
    categoryId: 'service-management',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'SSL／TLS のクライアント認証用ディジタル証明書は IC カードや USB トークンなどの耐タンパ装置に格納可能で，特定の PC に紐づける必要はなくユーザ単位で運用できる。\nア サーバ証明書のコモンネームには FQDN（ホスト名）を用い IP アドレスの組込みは必須ではない，\nウ SSL は不特定多数の利用者間の通信を保護するオープンな仕組みで事前の利用者登録は不要，\nエ 日本国内に SSL の鍵長を 128 ビット未満に制限する法規制はない（過去の米国輸出規制も既に撤廃済）。',
    categoryId: 'service-management',
    sourceUrl: H26_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'プロジェクトに関わるステークホルダはプロジェクトの実施・成果に利害をもつ個人・組織で，成果が自らの利益になる者（受益者）と不利益になる者（被影響者）の両方が存在し得る。\nア は組織内外を問わずステークホルダとなる（顧客・規制当局・地域社会等は外部），\nイ は直接参加せず間接的に影響する関係者もステークホルダ，\nエ は組織や集団としてのステークホルダもあり個人として特定できる必要はない。',
    categoryId: 'stakeholder',
  ...
  },
  {
    ...
    choices: ['0.2', '0.5', '1.9', '5.2'],
    correctIndex: 0,
    explanation: '生産性 L／E は L／(5.2×L^{0.98})＝(1／5.2)×L^{0.02}。L＝10 を代入すると (1／5.2)×10^{0.02}≒0.192×1.047≒0.20 キロ行／人月となる。\nイ・ウ・エはいずれも E＝5.2L^{0.98} の関係から導出できない値。',
    categoryId: 'measurement',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'プロジェクトが完了に近づくほど成果物の仕様や設計が固まり，機能の不確実性は減少する（PMBOK のライフサイクル特性）。\nア は要員数で，一般に初期は少なく中期に最大化し終結期に減少する形（ベル型），\nウ はステークホルダ影響度で，完了直前ほど影響度は低くなる（変更余地が少ない），\nエ は変更／エラー修正の影響度で，完了に近づくほど手戻りコストは増加する。',
    categoryId: 'project-work',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: 'プロジェクト憲章は立上げプロセス群でプロジェクトを認知・承認するために作成する文書で，要求事項・目的・妥当性・全体スケジュール・PM と権限レベルを記載する。\nア はプロジェクトマネジメント計画書（計画プロセス群の集合体），\nイ はプロジェクトスコープ記述書，\nウ は WBS の説明。',
    categoryId: 'integration',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'ワークパッケージは WBS の最下位レベルの要素で，さらにスケジュール作成のためにアクティビティ（活動）に分解される。\nア OBS との対応関係は責任分担マトリックスで扱い WP の定義ではない，\nイ ワークパッケージは関連する作業のまとまりであって成果物そのものをまとめたものではない，\nエ 上位の要素成果物と 1 対 1 とは限らず複数のワークパッケージから構成される場合もある。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'プロジェクトスコープ記述書は，プロジェクトの要素成果物（プロダクトスコープ）と，その成果物を生み出すために必要な作業（プロジェクトスコープ）の両方を記述する文書。\nア は WBS が出力で，スコープ記述書はその入力側であって逆の関係，\nイ はスコープに「含まれないもの」（除外事項）も明示するのがスコープ記述書の役割の一つ，\nエ は予算見積りやスケジュール策定は別プロセスのアウトプットで，スコープ記述書には記述しない。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: 'クリティカルチェーン法では各タスクの安全余裕を集約したプロジェクトバッファを設け，バッファ消費量を「安全」「警告」「対策」の 3 ゾーンで管理する。安全区域内のバッファ消費は許容範囲なので特別な対策は不要。\nイ クリティカルチェーンを頻繁に見直すと統制が乱れる，\nウ 個々タスクの終了報告のみでは進捗が遅すぎる（残作業ベースで頻繁に把握），\nエ マイルストーン管理は伝統的手法で CCPM の特徴ではない。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['2', '3', '4', '5'],
    correctIndex: 0,
    explanation: '各ノードの最早時刻を計算すると 1:0，2:3，3:3，5:8，4:max(2+c=7, 5+ダミー=8)＝8，6:13，7:max(3+e=5, 8+g=12)＝12，8:max(6+h=17, 7+i=15)＝17 でクリティカルパスは b→d→ダミー→f→h＝17 日。\nクリティカル外の a・c・e・g・i にはフロートがあるため，最短 17 日を維持しつつ開始を遅らせて並行作業数を最小化できる。例えば a:1〜4，b:0〜3，c:4〜8，d:3〜8，f:8〜13，g:8〜12，e:12〜14，h:13〜17，i:14〜17 と配置すれば全期間で同時稼働は最大 2 名に抑えられる。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'クラッシングはクリティカルパス上の活動に追加資源（要員・残業など）を投入してコストを掛けて所要期間を短縮する技法。\nイ は資源コスト削減策で短縮策ではない，\nウ は完了延期で短縮ではない，\nエ は先行作業の終了を待たずに後続を並行実施するファストトラッキングの説明。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['0', '4', '7', '14'],
    correctIndex: 2,
    explanation: '各作業の最早終了時刻は A:4，B:9，C:12，D:5，E:max(12,5)+2＝14。E の先行は C（終了 12）と D（終了 5）なので E は時刻 12 から開始する。D の最遅終了は E 開始時刻＝12 まで許容されるため，D の最遅開始は 12−1＝11。\n総余裕＝最遅開始−最早開始＝11−4＝7 日。',
    categoryId: 'planning',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['選択肢アのグラフ', '選択肢イのグラフ', '選択肢ウのグラフ', '選択肢エのグラフ'],
    correctIndex: 2,
    explanation: '現時点でコストが超過しない条件は AC ≤ EV（実コストが完了出来高以下），納期に遅れない条件は EV ≥ PV（出来高が計画値以上）。両方を満たすのは EV ≥ PV ≥ AC の順序になっているグラフで，アーンドバリュー（EV）が最も高く実コスト（AC）が最も低いウが該当。\nア は AC が最大で EV ＞ PV，コスト超過＋進捗先行で条件不満足，\nイ は AC ＞ PV ＞ EV でコスト超過＋進捗遅れ，\nエ は PV ＞ EV ＞ AC で進捗遅れ。',
    categoryId: 'measurement',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    choices: ['選択肢アの分類', '選択肢イの分類', '選択肢ウの分類', '選択肢エの分類'],
    correctIndex: 2,
    explanation: 'IFPUG 法では機能をデータファンクション（ILF＝内部論理ファイル，EIF＝外部インタフェースファイル）とトランザクションファンクション（EI＝外部入力，EO＝外部出力，EQ＝外部照会）に分類する。よってウが正しい組合せ。\nア・イ・エはデータ／トランザクションの分類が誤っている。',
    categoryId: 'measurement',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '保守性（Maintainability）は故障発見後にどれだけ速く修正できるかを示す指標で，修正時間の合計／修正件数（平均修復時間 MTTR 系の指標）が該当する。\nア は信頼性（誤り密度），\nウ は移植性（変更行数比率），\nエ は機能適合性／要求変更率に関する指標。',
    categoryId: 'delivery',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['阿部', '伊藤と佐藤', '鈴木と田中', '野村'],
    correctIndex: 3,
    explanation: 'RACI チャートで設計アクティビティの行を見ると阿部＝R（実行責任），伊藤＝I（情報提供），佐藤＝I，鈴木＝C（相談対応），田中＝C，野村＝A（説明責任）。\nよって設計の説明責任を持つのは野村ただ 1 名。RACI では 1 つのアクティビティの説明責任者（A）は原則 1 名に限定される。',
    categoryId: 'team',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'table',
  ...
  },
  {
    ...
    choices: ['120', '150', '200', '240'],
    correctIndex: 2,
    explanation: 'ツール A の EMV＝0.6X＋0.4×90−120＝0.6X−84，ツール B の EMV＝0.6×120＋0.4×60−60＝72＋24−60＝36。\nA ＞ B の条件は 0.6X−84 ＞ 36，整理して 0.6X ＞ 120，X ＞ 200。よって X が 200 万円を超える場合にツール A の方が EMV が大きい。',
    categoryId: 'uncertainty',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
    figure: {
      type: 'svg',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'アクセシビリティ確保の観点では，マウスが使えない利用者にも操作可能とする必要があり，Tab キーでフォーカス移動・Enter キーでリンク選択といったキーボード操作対応が基本要件。\nイ は項目名と入力欄の配置で，読み上げ順や視覚レイアウトの問題でアクセシビリティ要件には合致しない，\nウ は単語途中の空白がスクリーンリーダーで誤読されアクセシビリティを損なう，\nエ は色（赤色）のみで情報を伝える方式で色覚特性に対応できずアクセシビリティに反する。',
    categoryId: 'delivery',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'SOA はサービス間の独立性を高めるため疎結合（loose coupling）で設計し，業務変更時の影響範囲を局所化する。\nア ステートフルは独立性・スケーラビリティを下げるため SOA ではステートレスが原則，\nイ サービス名は役割ではなくビジネス機能（業務内容）を表すように命名する，\nエ 再利用性は SOA の中核的な目的で「再利用しない方がよい」は誤り。',
    categoryId: 'development-approach',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 1,
    explanation: 'スパイラルモデルは設計→プロトタイプ→評価→次サイクル設計，のように段階的に機能を追加・洗練し，各繰返しの段階でユーザの要求を確認・確定していく開発モデル。\nア ウォータフォールは後工程で誤りが顕在化しやすく初期段階で全てを判明させるのは困難，\nウ プロトタイピングは要求仕様確定のためにエンドユーザの参加が不可欠，\nエ スパイラルモデルはプロトタイプ前提ではなく，リスク駆動でプロトタイプを用いる場合もあるという位置付け。',
    categoryId: 'development-approach',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: 'フェールソフトは障害発生時に機能や性能を縮退させつつ運転を継続させる設計思想で，「パフォーマンス低下を許容しサービスを継続する」事例（ウ）が該当。\nア・イ は障害発生時に安全な停止を選ぶフェールセーフ，\nエ は誤操作を未然に防ぐフールプルーフの説明。',
    categoryId: 'service-management',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 3,
    explanation: '複数ファイルに分散したデータは個々のファイルを単独にバックアップするとファイル間の整合性が崩れるため，一連の更新処理が完了した整合性ある時点でまとめてバックアップするのが適切。\nア バックアップを消去すると過去復旧不能になる，\nイ 全データを取得しないと差分／増分の基準が失われ復旧時に整合しない，\nウ 同一媒体上書きは媒体障害や上書き失敗時に復旧手段を失うため不可。',
    categoryId: 'service-management',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '非機能要件はシステムが「どのように」振る舞うかに関する要件で，性能・可用性・操作性（ユーザビリティ）・セキュリティ・保守性などが含まれる。「システムの操作性」は非機能要件に該当する。\nア 業務範囲は機能要件，\nイ 情報（データ）の流れは機能要件（処理／データフロー），\nエ インタフェースのレイアウトは機能要件側の仕様。',
    categoryId: 'delivery',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '国際エネルギースターロゴは米国環境保護庁（EPA）が制定したオフィス機器（PC・プリンタ・複合機等）の省エネ性能基準に適合した製品に付与される環境ラベルで，稼働時／待機時の消費電力基準を満たすことを示す。\nア FSC は森林管理協議会の森林認証（木材製品向け），\nイ グリーンマークは古紙再生紙利用製品向け，\nエ 統一省エネラベルは家電製品（エアコン・冷蔵庫等）の省エネ性能表示制度で情報機器向けではない。',
    categoryId: 'governance',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    choices: ['ISO 14001', 'RoHS 指令', 'WEEE 指令', 'グリーン購入法'],
    correctIndex: 1,
    explanation: 'RoHS 指令（Restriction of Hazardous Substances）は EU が 2006 年に施行した指令で，電気・電子機器における鉛・水銀・カドミウム・六価クロム・PBB・PBDE 等の特定有害物質の使用を基準値以下に制限する。\nア ISO 14001 は環境マネジメントシステムの国際規格で物質規制ではない，\nウ WEEE 指令は廃電気電子機器のリサイクル責任を規定する別指令，\nエ グリーン購入法は日本の法律で公的機関の環境物品調達促進が主目的。',
    categoryId: 'governance',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 2,
    explanation: '個人情報保護法における個人情報は「生存する個人に関する情報であって，特定の個人を識別できるもの」と定義され，亡くなった個人の情報は原則として対象外。\nア 企業の顧客に限らず従業員・取引先個人なども含む，\nイ 秘密にしているプライバシー情報に限らず公知情報でも識別可能なら個人情報，\nエ 国籍は問わず日本国内に居住する外国人も保護対象に含まれる。',
    categoryId: 'governance',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
  {
    ...
    correctIndex: 0,
    explanation: '日本工業標準調査会（JISC）は経済産業省に設置された審議会で，工業標準化法に基づき工業標準化に関する調査・審議を行い，特に JIS（日本工業規格）の制定・改正・廃止に関する審議を担う。\nイ は IEEE（米国電気電子学会），\nウ は電気規格調査会（JEC 規格），\nエ は JEITA（電子情報技術産業協会）の説明。',
    categoryId: 'governance',
    sourceUrl: H25_SPRING_PM_AM2_SOURCE_URL,
  },
]
