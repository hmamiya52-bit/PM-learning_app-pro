 ...
 *   旧 hideConditionUntilUnlock フラグは廃止し、ティアベースの一律ルールへ移行。
 * - アイコン: lucide-react の名前で管理（BadgeMedal の ICON_MAP）
...
export const BADGES: BadgeDefinition[] = [
  // ── 学習継続 study（3枚 / テーマ：歩みの旅路・累計解答数） ──────────────
  {
    ...
    category: 'study', iconName: 'Sprout',
  ...
  },
  {
    ...
    category: 'study', iconName: 'BookMarked',
    gradient: 'from-green-400 to-emerald-600', shadowColor: 'shadow-emerald-500/50',
  ...
  },
  {
    ...
    category: 'streak', iconName: 'TrendingUp',
  ...
  },
  {
    ...
    category: 'streak', iconName: 'Crown',
  ...
  // ── 踏破率 coverage（3枚 / テーマ：領土の制覇・全問の正解到達率） ──────────
  {
    ...
    category: 'coverage', iconName: 'Compass',
  ...
  },
  {
    ...
    category: 'coverage', iconName: 'Target',
  ...
  },
  {
    ...
    category: 'coverage', iconName: 'Medal',
  ...
  // ── カテゴリ制覇 category（3枚 / テーマ：知を統べる・達成率80%超） ──────────
  {
    ...
    category: 'category', iconName: 'FolderCheck',
  ...
  // ── 午前Ⅱ 公式 morning（4枚 / テーマ：研鑽から実力へ・公式300問） ──────────
  {
    ...
    category: 'morning', iconName: 'CheckCircle',
  ...
  },
  {
    ...
    category: 'morning', iconName: 'Flag',
    gradient: 'from-sky-400 to-cyan-600', shadowColor: 'shadow-sky-500/50',
  ...
  },
  {
    ...
    category: 'morning', iconName: 'Crown',
  ...
  // ── 午後Ⅱ 論述 essay（6枚 / テーマ：不屈の意志・量/質/時間） ──────────────
  {
    ...
    category: 'essay', iconName: 'Feather',
