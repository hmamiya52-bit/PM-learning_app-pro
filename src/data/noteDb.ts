...
export const NOTE_DB: Record<string, NoteData> = {
  ...
  stakeholder: {
    ...
    exam_tips: [
      '【最頻出・PMO】==プロジェクトマネジメントオフィス== の役割が2回（R3問1・R1問1）でほぼ同一問題。==標準化==・==教育訓練==・==プロジェクトの計画と監視== が正解の型。',
      '【性質】H25問1。ステークホルダは ==利益になる者と不利益になる者がいる==。「社内だけ」「直接参加だけ」「個人として特定できること」はすべて誤り。',
      '【役割の対応】H26問5。スポンサは ==資金の提供==／納入者は ==構成アイテムの提供==／顧客は ==使用==／プログラムマネージャは ==関連プロジェクトの調和==。',
      '【13.3】R1問7。エンゲージメントのマネジメントは ==交渉やコミュニケーションを通して期待をマネジメントする==。「分類する」は 13.1〜13.2 側。',
      '【コミュニケーション3プロセス】R2問14・R3問14 の2回。計画は ==ニーズの決定==、配布は ==情報を利用可能にする==、マネジメントは ==ニーズを満たし課題を解決する==。',
      '【午前Ⅱ には出ていない】登録簿の記載項目・Power/Interest グリッド・サリエンスモデル・関与レベル5段階は直近12年の午前Ⅱ に出題ゼロ。午後Ⅰ・午後Ⅱ 向けの知識として押さえる。',
    ],
  },
  ...
  team: {
    ...
    sections: [
      ...
      // ── G. IPA PM試験 出題傾向 ──
      {
        ...
        items: [
          ...
          '__PMO の3類型__: ==支援型==／==コントロール型==／==指揮型==（コントロール度の低い順）',
        ],
      },
      {
        heading: '16. ひっかけパターン',
    ...
    exam_tips: [
      '【最頻出・RACI】==RACI チャート== は12年で ==11回==（R6問2・R4問4・R3問2・R2問4・R1問2・H30問4・H29問6・H28問6・H27問5・H26問7・H25問14）。本カテゴリの得点源はここに集中している。',
      '【RACI の中身】==R==（実行責任、複数可）／==A==（説明責任、==1人だけ==）／==C==（相談、双方向）／==I==（報告、一方向）。表から「設計アクティビティで A を持つ要員」を読ませる形が定番。',
      '【タックマン】2回（R4問5・H29問7）。どちらも「考え方や価値観の違いが明確になり意見を主張し合う」ものとして ==混乱期== を答えさせる出題。',
      '【ブルックスの法則】1回（H27問6）。遅れているプロジェクトへの==要員追加はさらに遅らせる==。',
      '【JIS Q 21500 の資源】3回（R6問3・R4問6・H30問5）。「プロジェクト組織の定義」「資源の管理」などプロセスの目的の判別。',
      '【午前Ⅱ には出ないが午後Ⅱ で効く】リーダーシップ理論（SL理論・マネジリアル・グリッド・サーバント）と動機づけ理論は直近12年の午前Ⅱ に==出題ゼロ==。論述で理由を述べるための語彙として押さえる。',
    ],
  },
  ...
  'development-approach': {
    ...
    sections: [
      ...
      // ── E. その他のアジャイル手法 ──
      {
        ...
        items: [
          ...
          '　==TDD==: __テストファースト__（Red → Green → Refactor。delivery §11）',
    ...
    exam_tips: [
      '【最頻出】==XP==（エクストリームプログラミング）4回（R4問16・H30問17・H28問19・H26問17）。プラクティス名と内容の対応を問う。',
      '【アジャイル開発宣言】2回（R6問17・R4問15）。IPA の表記は ==アジャイルソフトウェア開発宣言==。4価値の左辺・右辺を入れ替えた誤答肢が出る。',
      '【ベロシティ】2回（R6問7・H29問11）。==完了したストーリーポイントの実績値== であり、目標として押し付けるものではない。',
      '【INVEST】1回（R6問16）。6要素のうち ==Valuable== の主体は ==顧客==（開発者ではない）。',
      '【スクラム】R5問15。役割（PO／SM／開発者）・5イベント・3成果物・==DoD== はセットで押さえる。',
      '【午前Ⅱ には出ていない】カンバン・==WIP制限==・DevOps・ユーザストーリーの語は直近12年の午前Ⅱ に出題ゼロ。午後Ⅰ の適応型設問で使う知識として押さえる。',
    ],
  },
  ...
  planning: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '　==RBS==（リスクブレークダウンストラクチャ）: __リスクのカテゴリ__で分解（uncertainty §3）',
        ],
    ...
    exam_tips: [
      '【最頻出】==クリティカルパス== 13回・==クリティカルチェーン== 8回・==WBS== 13回。この3つで本カテゴリの過半を占める。',
      '【ネットワーク図】==プレシデンスダイアグラム法==（PDM）5回・==アローダイアグラム== 3回。PDM の4依存関係（==FS/FF/SS/SF==）と、経路の日数計算を確実に。',
      '【工程管理図表】==ガントチャート== と ==管理図== が5回（R3問5・R2問6・R1問3・H29問8・H27問8）。「何が読み取れる図か」で判別する。',
      '【WBS】==成果物指向==・==100%ルール==・==8/80ルール==。==ローリングウェーブ計画法==（将来は上位レベルのまま、詳細が固まってから分解）が2回（H29問4・H26問6）。',
      '【コスト】==コスト・ベースライン== はマネジメント予備を ==含まない==。==コンティンジェンシー予備==（既知）と ==マネジメント予備==（未知）の区別。',
      '【午前Ⅱ には出ていない】==PERT==（(O+4M+P)/6）・3点見積もり・==NPV==／==IRR==／回収期間は直近12年の午前Ⅱ に出題ゼロ。式は午後Ⅰ の計算と他区分向けに押さえる。',
    ],
  },
  ...
  'project-work': {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '__どちらを選ぶか__: 成果物を確定できる工程は請負、__仕様が固まらない工程は準委任__。契約を一括で決めず__工程単位で使い分ける__のが実務',
          '　__H29問21 がこの形__。「情報システム・モデル取引・契約書」に照らして、要件定義〜運用テストの各フェーズのうち __準委任型が適切なもの__ を選ばせた',
          '　　__要件定義と運用テストは発注者が主体__になるので準委任、__外部設計〜内部の製造は成果物が確定する__ので請負、が基本の割り付け',
          '　アジャイル開発は__スコープが動く前提__なので準委任が一般的',
          '__午後Ⅰで最も問われる制約__: 請負・準委任とも、発注者は__受託側の要員に直接指示できない__。直接指示すると ==偽装請負== になる',
          '　作業の指示は__受託会社のリーダー経由__で行う。「発注者が現場に直接指示していないか」は午後Ⅰ で繰り返し問われる',
          '　　__H30問21 の誤答肢がこれ__。請負で委託したのに「委託する側で詳細な体制図を作成して __指揮命令する__」は不適切（正解は ==情報セキュリティレベルを取り決め、報告を義務付け、監査する==）',
          '　　__労働者派遣なら指揮命令できる__。ただし就業条件は ==派遣元と派遣労働者の間==で決め、派遣先はその範囲内でしか命令できない（R2問22・H29問23）',
        ],
      ...
      // ── D. 法律・契約周辺 ──
      {
        ...
        items: [
          ...
          '　__知的財産権の帰属__: 委託で生まれた成果物の権利は、__契約に明記しないと受託側（請負人）に帰属する__。着手前に決めておく',
          '　　__12年で2回出題__。R1問18 は「開発請負契約書に著作権の帰属の記載が無い場合の帰属先」を問い、==請負人に帰属== が正解',
          '　　R5問17 はその裏返しで、記載が無いと __委託元は成果物を自社の別ソフトウェアに流用できなくなる__ という問題が起きる',
        ],
    ...
    exam_tips: [
      '【契約形態】==実費償還== 2回（R6問20・R4問20）、定額・==インセンティブ== が各1回。設問は「リスクを誰が負うか」で問う。CPFF/CPIF/T&M という略号での出題は無い。',
      '【著作権の帰属】2回（R1問18・R5問17）。開発請負契約書に記載が無ければ著作権は ==請負人に帰属== する。委託元は成果物を自社の別ソフトへ流用できなくなる。',
      '【請負と派遣】H30問21（請負なのに委託側が ==指揮命令== するのは不適切）／R2問22・H29問23（派遣の就業条件は ==派遣元と派遣労働者の間== で決める）。',
      '【調達文書】IPA は発注先を ==供給者== と呼ぶ（3回）。==作業範囲記述書==（SOW）2回。RFP・SOW という略号での出題は無い。',
      '【組織のプロセス資産】4回（R3問3・H29問2・H27問3・H26問4）。==プロセスと手順== と ==企業の知識ベース== の2分類。教訓登録簿は後者。',
      '【知識管理】==形式知 vs 暗黙知==／==SECI モデル==／==教訓登録簿== は ==継続的== に更新する（終結時にまとめて作るのではない）。',
    ],
  },
  ...
  delivery: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '__管理図__（Control Chart）: 工程が安定しているかを時系列で見る図',
    ...
    exam_tips: [
      '【最頻出】==保守性の評価指標== が3回（R2問12・H27問14・H25問13）。ほぼ同一問題で繰り返し出る。',
      '【信頼性設計】==フェールソフト== 3回（R3問19・H28問21・H25問19）／==フェールセーフ== 1回（H28問17）／==フールプルーフ== 1回（H27問16）。「機能を落として動かし続ける」がソフト、「安全側に倒す」がセーフ、「誤操作を受け付けない」がフールプルーフ。',
      '【レビュー】R5問13 が ==ラウンドロビン==・==ウォークスルー==・==インスペクション== の対応を問うた。==非機能要件== も2回（H27問21・H25問21）。',
      '【QA vs QC】==品質保証== は __プロセス__ が対象（品質監査）、==品質管理== は __成果物__ が対象（検査・テスト）。H30問14 が3プロセスの区分を問うた。',
      '【品質コスト】==適合コスト==（予防＋評価）vs ==不適合コスト==（内部不良＋外部不良）。H27問13 が適合コストの中身を問うた。==1-10-100の法則==。',
      '【QC道具】==パレート図== が2回（H30問13・H26問15）。7QC道具は道具名を列挙させるのではなく、個別の図の用途で問われる。',
    ],
  },
  ...
  measurement: {
    ...
    exam_tips: [
      '【最頻出・EVM】==EVM== 7回＋==アーンドバリュー== 表記2回。==CV=EV-AC==、==SV=EV-PV==、==CPI=EV/AC==、==SPI=EV/PV==。==分子は常に EV==。',
      '【TCPI】==BAC維持== なら ==(BAC-EV)/(BAC-AC)==、==EAC維持== なら ==(BAC-EV)/(EAC-AC)==。R6問4 の出題実績。',
      '【COCOMO・生産性】==COCOMO== 6回（R4問10・R3問9・R2問9・H30問8・H28問11・H26問14）。「規模が増えるほど ==生産性は下がる==」が読み取りの要点。',
      '【FP法】4回（R5問10・H29問13・H27問11・H25問12）。==ILF/EIF== が ==データファンクション==、==EI/EO/EQ== が ==トランザクションファンクション==。名称ではなく ==2分類== を答えさせる。',
      '【傾向分析】3回（R3問12・R1問11・H28問9）でほぼ同一問題。過去の実績から ==将来のパフォーマンスを予測する== 技法。',
      '【午前Ⅱ には出ていない】==NPS==・==BSC==・==OKR== は直近12年の午前Ⅱ に出題ゼロ。午後Ⅱ の価値・便益の語彙として押さえる。',
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '　__長い棒が上に来るので、どこから手を付けるかが一目で分かる__。==上位のリスク== から優先して対応する',
  ...
  governance: {
    ...
    exam_tips: [
      '【この区分の実態】33問の主力は ==法務と倫理==。ガバナンス理論そのものより、法令・規格の知識が問われる。',
      '【労働関連】==労働基準法== 4回（R5問22・H30問22・H29問22・H28問23）。うち ==36協定== が2回。==労働者派遣== 2回（R2問22・H29問23）で ==指揮命令== の関係を問う。',
      '【技術者倫理】==集団思考== 2回（R6問22・R1問23）、==ホイッスルブローイング== 1回（R3問22）。集団思考は「心の警備」など8つの兆候。',
      '【その他の法令】==下請法== 2回・==個人情報保護法== 2回・==RoHS指令== 3回・プロバイダ責任制限法・SDGs が各1回。',
      '【成熟度】==CMMI== 2回（R6問15・H28問18）。レベル4は ==定量的に管理されている== 状態。',
      '【午前Ⅱ には出ていない】==JIS Q 38500==・==COBIT==・ステアリングコミッティは直近12年の午前Ⅱ に出題ゼロ。午後Ⅰ・午後Ⅱ の体制設計で使う語として押さえる。',
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '__Stacey マトリクス__: ==要求の不確実性== × ==技術の不確実性== の2軸で見る',
  ...
  'service-management': {
    ...
    exam_tips: [
      '【この区分の実態】本カテゴリに割り当てられた午前Ⅱ は45問あるが、大半が ==情報セキュリティ==・データベース・基盤の問題。ITIL / JIS Q 20000 の出題は限られる。',
      '【ITIL】3回（H30問19・H28問20・H26問19）。==サービスライフサイクル5段階== の並びと、各段階が何をするかを問う形。',
      '【JIS Q 20000】R5問19・H30問20。==サービスマネジメントシステム== の要求事項（監視・レビュー・内部監査）。',
      '【可用性】==可用性 = MTBF ÷ (MTBF + MTTR)==。==RPO== は __データ__ の最大許容損失、==RTO== は __サービス__ の最大許容停止時間。',
      '【インシデント vs 問題】==サービス回復==（早期・MTTR）vs ==根本原因の解決==（再発防止・KEDB）。H27問19 がインシデント及びサービス要求管理の活動を問うた。',
      '【午前Ⅱ には出ていない】==SLA==／==OLA==／==UC== の語は直近12年の午前Ⅱ に出題ゼロ。午後Ⅰ の運用引継ぎ設問で使う知識として押さえる。',
    ],
  },
}
