  ...
  planning: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          '5.2 要求事項収集（Collect Requirements）: ステークホルダーのニーズを識別・文書化',
      ...
      },
      {
        ...
        items: [
          '5.3 スコープ定義（Define Scope）: ==プロジェクト・スコープ記述書==を作成し、プロジェクトと製品の境界を確定',
      ...
      },
      {
        ...
        items: [
          '5.5 スコープ妥当性確認（Validate Scope, 監視・コントロール群）: 完成した成果物を顧客／スポンサーが正式に受け入れる。技法は==検査==（inspection）',
          '==妥当性確認==（Validation, 顧客の受入）vs ==品質コントロール==（Verification, 仕様への適合）の違いに注意',
          '5.6 スコープコントロール（Control Scope, 監視・コントロール群）: スコープの状態を監視し、ベースライン変更を管理。スコープ・クリープを検出・是正',
        ],
      },
      // ── C. スケジュールマネジメント（PMBOK6 第6章） ──
      {
        ...
        items: [
          '6.1 スケジュールマネジメント計画（Plan Schedule Management）: 単位・精度・ベースライン更新ルール・EVM 適用方針などスケジュール管理の方法を定める',
        ],
      },
      {
        heading: '12. 6.2 アクティビティ定義',
        items: [
          '6.2 アクティビティ定義（Define Activities）: WBS のワークパッケージをアクティビティに分解',
      ...
      },
      {
        ...
        items: [
          '6.6 スケジュールコントロール（Control Schedule, 監視・コントロール群）: ベースラインに対する進捗監視と変更管理',
      ...
      // ── D. コストマネジメント（PMBOK6 第7章） ──
      {
        ...
        items: [
          '7.1 コストマネジメント計画（Plan Cost Management）: 測定単位・精度・コントロール・スレッショルド（差異の閾値）・EVM 適用方針などコスト管理の方法を定める',
        ],
      },
      {
        heading: '20. 7.2 コスト見積もり',
        items: [
          '7.2 コスト見積もり（Estimate Costs）: 類推／パラメトリック／ボトムアップ／3点の4技法（§15 と共通）',
          '__精度のクラス__:',
      ...
      },
      {
        ...
        items: [
          '7.3 予算設定（Determine Budget）: コスト見積もりを集約し==コスト・ベースライン==を作成',
          '__構成__（積層構造・下から上へ）:',
      ...
      },
      {
        ...
        items: [
          '7.4 コストコントロール（Control Costs, 監視・コントロール群）: ==EVM==で PV／EV／AC から CV・SV・CPI・SPI・EAC 等を算出。公式・計算は measurement §4〜§8 で詳細に扱う',
        ],
      ...
      // ── E. リスク・調達計画 ──
      {
        ...
        items: [
          '11.1 リスクマネジメント計画／11.2 リスクの特定（いずれも計画プロセス群）',
