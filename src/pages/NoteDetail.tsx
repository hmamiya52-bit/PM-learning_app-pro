...
export const NOTE_DB: Record<string, NoteData> = {
  ...
  delivery: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '==正規分布==: ±1σ=68.27%、==±2σ===95.45%、==±3σ===99.73%',
      ...
      // ── H. IPA PM試験 出題傾向 ──
      {
        ...
        items: [
          ...
          '__3σ管理__: ==±3σ===99.73%。プロセス能力指数 Cp/Cpk',
      ...
      },
      {
        ...
        items: [
          ...
          '__σ レベル__: ==6σ===3.4不良/百万、==3σ===99.7%適合',
    ...
    exam_tips: [
      ...
      '【シックスシグマ】==DMAIC==（既存改善）vs ==DMADV==（新規設計）。==6σ===3.4不良/百万。',
      '【統計】==3σ管理===99.73%。プロセス能力指数 Cp/Cpk。管理限界 UCL/LCL。',
      '【規格】==ISO 9001:2015==の7原則と==PDCA+リスク思考==。==CMMI==の5成熟度レベル。',
      '【アジャイル品質】==DoD==／==TDD==（Red-Green-Refactor）／==BDD==（Given-When-Then）／==CI/CD==。',
      '【受入】==UAT==＝実ユーザの最終受入。==アルファ==／==ベータ==／==OAT==／==CAT==の使い分け。',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '　　　 ==EAC = AC + (BAC - EV) / (CPI × SPI)==（コストと時間両方の効率継続）',
      ...
      // ── G. IPA PM試験 出題傾向 ──
      {
        ...
        items: [
          ...
          '__3σ管理__: ==±3σ===99.73% 適合（delivery §17 参照）',
        ],
      },
      {
        heading: '24. ひっかけパターン',
  ...
  integration: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '__変更管理 vs 構成管理__: 変更管理＝プロセス／構成管理＝成果物のバージョン',
    ...
    exam_tips: [
      ...
      '【構成管理】==構成項目==（CI）・==バージョン管理==・==ベースライン==。変更管理＝プロセス、構成管理＝成果物。',
