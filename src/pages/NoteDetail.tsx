  ...
  stakeholder: {
    ...
    sections: [
      ...
      // ── F. 監視・コントロール ──
      {
        ...
        navyItems: [[{ text: '第6版では 13.4「ステークホルダー・エンゲージメントの監視」プロセス（監視・コントロールプロセス群）が対応。ツール&技法に==根本原因分析==・==ステークホルダー分析==を含む（§32 参照）', style: 'navy' }]],
      },
      {
    ...
    exam_tips: [
      ...
      '【PMBOK6 4プロセス】13.1 特定（立上げ）／13.2 計画／13.3 マネジメント（実行）／13.4 監視。各プロセスの ITTO 主要項目（特にツール&技法）が午前II頻出。',
    ],
  },
