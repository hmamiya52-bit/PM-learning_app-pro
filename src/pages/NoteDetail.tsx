...
export const NOTE_DB: Record<string, NoteData> = {
  ...
  stakeholder: {
    ...
    sections: [
      ...
      },
      {
        ...
        navyItems: [[{ text: '本アプリは PMBOK第6版＋第7版を統合的に扱う。第6版要素は §32-33 に集約。第8版での位置づけは本ノートの最終セクション参照', style: 'navy' }]],
      },
    ],
    exam_tips: [
  ...
  planning: {
    summary:
      'プロジェクトのスコープ・スケジュール・コスト・リスクを計画する活動領域。PMBOK第6版では第5/6/7章の3知識エリアで詳細化、第7版では「計画」パフォーマンス領域として統合的に扱う。==WBS==・==クリティカルパス法==・==3点見積もり==・==EVM==が試験頻出。',
    sections: [
      // ── A. 計画領域概観 ──
      {
        heading: '1. 計画パフォーマンス領域の目的と概観',
        items: [
          'PMBOK第7版「計画」パフォーマンス領域は、スコープ／スケジュール／コスト等を十分かつ協調的に組織化する活動を扱う',
          '__成果__:',
          '　プロジェクト目標に対する進捗の組織化・整合化・連携',
          '　価値創出を実現するアプローチの選定',
          '　ステークホルダー期待への対応',
          'PMBOK第6版では3つの知識エリアで詳細化:',
          '　__第5章 スコープマネジメント__（6プロセス）',
          '　__第6章 スケジュールマネジメント__（6プロセス）',
          '　__第7章 コストマネジメント__（4プロセス）',
      ...
      },
      {
        ...
        items: [
          '==プロジェクトマネジメント計画書==（Project Management Plan）: プロジェクト全体の実行・監視・終結の基準を統合',
      ...
      },
      {
        ...
        items: [
          ...
          '__判断軸__:',
          '　__規模__: 大規模 → 詳細計画／小規模 → 軽量計画',
          '　__複雑性__: 複雑 → 詳細／単純 → 簡素',
          '　__リスクレベル__: 高 → 詳細リスク計画／低 → 標準対応',
          '　__組織成熟度__: 高 → カスタマイズ／低 → 標準テンプレート',
          '　__規制環境__: 厳格 → フル文書化',
          '__7原則__（PMBOK7）でテーラリングが積極的に推奨される',
      ...
      },
      {
        ...
        items: [
          ...
          '　__プロダクトビジョン__: 製品の方向性',
          '　__プロダクトロードマップ__: 数四半期〜数年の見通し',
          '　__リリース計画__: 数スプリント〜数ヶ月の中期計画',
          '　__イテレーション計画__（スプリント計画）: 1〜4週の詳細計画',
          '　__デイリープラン__（デイリースクラム）: 24時間単位',
          '__段階的詳細化__: 近期は詳細、遠期は粗',
          '==プランニング・ポーカー==（Planning Poker）: チームで==ストーリーポイント==を相対見積もり',
      ...
      // ── B. スコープマネジメント（PMBOK6 第5章） ──
      {
        ...
        items: [
          ...
          '__目的__: スコープの計画／妥当性確認／コントロール方法を文書化',
          '__主要アウトプット__:',
          '　スコープマネジメント計画書: 詳細スコープの作成方法・WBS 作成方法・受入基準',
          '　==要求事項マネジメント計画書==: 要求事項の識別・分析・追跡方法（本プロセスのアウトプットである点がひっかけ）',
        ],
      ...
      },
      {
        ...
        items: [
          ...
          '__目的__: ステークホルダーのニーズを識別・文書化・管理',
          '__主要技法__: インタビュー／フォーカスグループ／ワークショップ／プロトタイピング／ブレーンストーミング／親和図／多基準意思決定分析 など',
          '__主要アウトプット__:',
          '　要求事項文書',
      ...
      },
      {
        ...
        items: [
          ...
          '__目的__: ==プロジェクト・スコープ記述書==の作成（プロジェクトと製品の境界を確定）',
          '__スコープ記述書の構成要素__:',
          '　製品スコープ記述（特徴・機能）',
          '　成果物（deliverables）',
          '　==受入基準==（acceptance criteria）',
          '　==除外事項==（exclusions）: 「やらないこと」の明示がスコープ争いを防ぐ',
          '　前提条件と制約条件',
      ...
      },
      {
        ...
        items: [
          // 赤字密度メモ: WBS は午前Ⅱ最頻出のため 8 個許容（方針書 §7）
      ...
      // ── C. スケジュールマネジメント（PMBOK6 第6章） ──
      {
        ...
        items: [
          ...
          '　単位（時間・日・週）・精度・ベースライン更新ルール・パフォーマンス測定ルール（EVM の使用方針等）を定める',
        ],
      },
      {
        ...
        items: [
          ...
          '__目的__: WBS のワークパッケージをアクティビティに分解',
          '__主要アウトプット__: アクティビティ・リスト／アクティビティ属性／マイルストーン・リスト',
      ...
      },
      {
        ...
        items: [
          // 赤字密度メモ: CPM は午前Ⅱ/午後Ⅰ双方の計算問題核心のため 15 個許容（方針書 §7）
      ...
      },
      {
        ...
        items: [
          ...
          '__目的__: スケジュール・ベースラインに対する進捗監視と変更管理',
      ...
      // ── D. コストマネジメント（PMBOK6 第7章） ──
      {
        ...
        items: [
          ...
          '　測定単位・精度（丸めルール）・コントロール・スレッショルド（差異の閾値）・EVM 適用方針などを定める',
        ],
      },
      {
        ...
        items: [
          ...
          '__見積もり技法__: 類推／パラメトリック／ボトムアップ／3点（§15 と同じ4技法）',
          '__精度のクラス__（PMBOK6 §7.2.2.4）:',
          '　==ROM 見積もり==（Rough Order of Magnitude, 超概算）: ==-25%〜+75%==',
          '　==確定見積もり==（Definitive）: ==-5%〜+10%==',
          '__予備分析__: コンティンジェンシー予備／マネジメント予備の見積もり（§22）',
          'コスト・オブ・クオリティ（COQ）も考慮（詳細は delivery §12）',
        ],
      ...
      },
      {
        ...
        items: [
          '__4技法の比較__:',
          '　__類推__: 過去類似プロジェクト, トップダウン, 早期・安価, 精度低',
          '　__パラメトリック__: 単価×数量, 中速・中精度, 統計的関係要',
          '　__ボトムアップ__: WBS積み上げ, 遅い・高価, 最高精度',
          '　__3点__: O/M/P 推定, 不確実性表現, PERT/三角分布',
          '__精度の序列__: ==ボトムアップが最高==・==類推が最低==（この対比が頻出）',
          '__プロジェクトフェーズ別__: 立上げ=類推（情報不足）→ 計画初期=パラメトリック → 計画詳細=ボトムアップ',
          '複数技法の併用が推奨',
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          '　PV（計画値）／EV（出来高）／AC（実コスト）を基に CV・SV・CPI・SPI・EAC 等を算出',
          'EVM の公式・計算・解釈は measurement カテゴリ §4〜§8 で詳細に扱う',
        ],
      ...
      },
      {
        ...
        items: [
          ...
          '　損益分岐点分析（Break-Even Analysis）／コスト・ベネフィット分析（CBA）',
      ...
      },
      {
        ...
        items: [
          ...
          '__計画プロセスとの連携__:',
          '　__スコープ計画__: 要求事項収集の対象者を特定',
          '　__スケジュール計画__: マイルストーンの承認者・報告先を特定',
          '　__コスト計画__: 予算承認者・CCB メンバーを特定',
          '　__リスク計画__: リスク影響を受けるステークホルダーを特定',
          '　__調達計画__: サプライヤ・契約承認者を特定',
      ...
      },
      {
        ...
        items: [
          // 赤字密度メモ: RFP/RFQ/SOW の文書名判別が頻出のため 7 個許容（方針書 §7）
      ...
      // ── F. 計画統合と PMBOK7 ──
      {
        ...
        items: [
          ...
          '__目的__: サブシディアリー計画書（§2）を統合して全体計画書を作成',
          '__統合される要素__: 3つのベースライン／10のサブシディアリー計画書／補助計画書（変更管理・構成管理等）／ライフサイクル選定',
      ...
      },
      {
        ...
        items: [
          '__第7版の8パフォーマンス領域__の1つ。§1 の概観を参照',
          '__成果__: 進捗の組織化／価値創出アプローチの選定／品質確保／ステークホルダー期待への対応',
          '__主な検討事項__: スコープ・スケジュール・予算のバランス、チーム能力、組織の方針・標準、市場環境',
          '__テーラリング__: 規模・複雑性・リスクに応じた計画の精緻度調整（§3）',
        ],
      ...
      },
      {
        ...
        items: [
          '__第6版__: ==プロセス・ITTO==による詳細記述。第5/6/7章で16プロセス（計画プロセス群中心）',
          '__第7版__: 「計画」==パフォーマンス領域==として統合記述（プロセス分解は省略）',
          '__本領域での対応__: 第6版 §5（スコープ）+ §6（スケジュール）+ §7（コスト）= 第7版「計画」領域',
          '__IPA PM試験__:',
          '　__午前Ⅱ__: 第6版用語（WBS・CPM・PERT・EVM・コスト・ベースライン）が中心',
          '　__午後I__: 第6版プロセスベースのシナリオが多い',
        ],
      ...
      },
      {
        ...
        items: [
          ...
          '__8. 与えられた前提・スコープを疑う__: 計画の==前提==（既存資産の流用可否・データ品質等）に誤りがないか計画段階で検証する。前提崩れは最大の手戻り要因（H25問2）',
          '__9. 見積もりの妥当性は比較で確認__: 1社見積もりを鵜呑みにせず==相見積り==や独立コスト見積もりと比較して妥当性を確認する（H26問3）',
          '__10. 制約がリスクの源__: 必達期限・固定予算・限られた要員という==制約==からリスクを洗い出し、対応を計画に織り込む（R1問1・H29問1）',
          '__11. 兼任要員は稼働率を明示__: 他業務と掛け持ちのメンバーは==稼働割合==を明確化し、業務間の優先度調整ルールを事前に決める（R6問2）',
          '__12. 環境変化はスコープから見直す__: 合併・制度変更などが起きたら、まず==スコープへの影響==を判断し、その後にスケジュール・コストを見直す（H25問3）',
          '__13. 標準プロセスはテーラリングして使う__: 組織標準をそのまま強制せず、案件特性に合わせ==修整（テーラリング）==する。全体で揃える所とチームに任せる所を見極める（R6問3）',
          '__14. 設問の限定語で解答の向きを固定__: 「事業の観点で」「理由を」等の==限定語==が解答の方向を決める。因果（〜だから〜する）で書き、本文の言葉を言い換えて使う（R6問1ほか全問共通）',
        ],
  ...
  'service-management': {
    summary:
      'IT サービスの==提供==・==運用==・==継続的改善==を扱う活動領域（==PMBOK 外==）。==ITIL v3/v4==・==ISO/IEC 20000==・==SLA/OLA/UC==・==インシデント vs 問題管理==・==構成管理（CMDB）==・==システム監査==・==関連法令==（個人情報保護法・サイバーセキュリティ基本法等）が試験頻出。プロジェクト完了後の==運用引継ぎ==で PM が関わる重要領域。',
    sections: [
      // ── A. 領域概観 ──
      {
        heading: '1. サービスマネジメントの定義とプロジェクトとの関係',
        items: [
          '==サービスマネジメント==（Service Management）: 顧客に==価値==を提供する==サービス==を==計画==・==設計==・==移行==・==運用==・==改善==する活動',
          '__定義（ITIL）__: 「==サービス==の形態で==顧客==に==価値==を提供するための==組織能力==の集合」',
          '__プロジェクトとの違い__:',
          '　==プロジェクト==: ==有期==・==成果物==指向（一回限り）',
          '　==サービスマネジメント==: ==継続的==・==サービス==提供（運用フェーズ）',
          '__プロジェクトとの接点__:',
          '　==運用引継ぎ==（プロジェクト完了 → 運用開始）',
          '　==プロジェクト中==の==運用要件==考慮（運用性・保守性）',
          '　==サービスデザイン==への==プロジェクト==成果反映',
          '__情報処理試験での位置づけ__:',
      ...
      },
      {
        ...
        items: [
          '==ITIL==（Information Technology Infrastructure Library）: ==IT サービスマネジメント==の==ベストプラクティス集==',
          '__歴史__:',
          '　==1989年==: 英国政府 CCTA（後の OGC）が策定開始',
          '　==v2==（2000年代）: 7コアブック',
          '　==v3==（2007年）: ==サービスライフサイクル==（5フェーズ）',
          '　==2011 edition==（2011年）',
          '　==ITIL 4==（2019年）: ==バリューシステム==中心の再構築',
          '__管理団体__: ==AXELOS==（2013年〜、英国政府＋Capita 合弁）',
          '__認定資格__: ITIL Foundation / ITIL Practice / ITIL Specialist 等',
          '__普及度__: IT サービスマネジメントの==デファクトスタンダード==',
          '__試験対象__:',
      ...
      },
      {
        ...
        items: [
          '==ISO/IEC 20000==: ==IT サービスマネジメントシステム==（==SMS==）の==国際規格==',
          '==JIS Q 20000==: 日本国内の==翻訳規格==',
          '__目的__: ==組織==が SMS を==確立==・==実施==・==維持==・==継続的に改善==するための==要件==を規定',
          '__主要パート__:',
          '　==Part 1==: SMS 要件（認証対象）',
          '　==Part 2==: 実践規範',
          '　==Part 3==: 適用範囲ガイダンス',
          '　==Part 4==: プロセス参照モデル',
          '__ITIL との関係__:',
          '　==ITIL==: ベストプラクティス（==どう実施==するか）',
          '　==ISO/IEC 20000==: 要件（==何を満たす==べきか）',
          '　==補完関係==、ITIL に従って ISO/IEC 20000 認証取得が一般的',
          '__PDCA サイクル__で継続的改善',
          '__認証__: ==組織単位==で取得（個人認証は ITIL）',
          'PM試験では R6秋期 問18 で出題実績あり',
        ],
        navyItems: [[{ text: 'R6 秋期 問18 で ISO/IEC 20000 が出題（service-management 関連）', style: 'navy' }]],
      },
      // ── B. ITIL v3 ライフサイクル ──
      {
        heading: '4. サービス戦略（Service Strategy）',
        items: [
          '==サービス戦略==: ==顧客ニーズ==と==市場機会==に基づき==サービス==を==戦略的に==計画',
          '__主要プロセス__:',
          '　==戦略マネジメント==',
          '　==サービスポートフォリオ管理==',
          '　==財務管理==',
          ...
          '　==事業関係管理==',
          '__成果物__:',
          '　==サービスポートフォリオ==（==パイプライン==・==カタログ==・==廃止==）',
          '　==サービスカタログ==（顧客向け）',
          '　==事業戦略==との整合',
          '__4つのP__（Strategy としての価値創出）:',
          '　==Perspective==（展望）',
          '　==Position==（位置づけ）',
          '　==Plan==（計画）',
          '　==Pattern==（パターン）',
      ...
      },
      {
        ...
        items: [
          '==サービス設計==: 新規・変更サービスの==設計==',
          '__4つの P__（Service Design における要素）:',
          '　==People==（人）',
          '　==Processes==（プロセス）',
          '　==Products==（製品・技術）',
          '　==Partners==（パートナー）',
          '__主要プロセス__:',
          '　==サービスカタログ管理==',
          '　==サービスレベル管理==（==SLM==、==SLA==の策定・管理）',
          '　==可用性管理==',
          '　==キャパシティ管理==',
          '　==IT サービス継続性管理==',
          '　==情報セキュリティ管理==',
          '　==サプライヤ管理==',
          '__成果物__: ==サービス設計パッケージ==（SDP）',
          '__SLA__（Service Level Agreement, §13-14 で詳細）が==この段階==で策定される',
        ],
        navyItems: [[{ text: 'SLA は §13-14 で詳細扱い。ここではサービス設計の主要プロセスとして位置づけ', style: 'navy' }]],
      },
      {
        heading: '6. サービス移行（Service Transition）',
        items: [
          '==サービス移行==: 新規・変更サービスを==本番環境==に==移行==',
          '__主要プロセス__:',
          '　==変更管理==（Change Management, §17 で詳細）',
          '　==サービス資産・構成管理==（==CMDB==, §18 で詳細）',
          '　==リリース・展開管理==（§19 で詳細）',
          '　==サービス検証・テスト==',
          '　==移行計画・サポート==',
          '　==知識管理==',
      ...
      },
      {
        ...
        items: [
          '==継続的サービス改善==（==CSI==）: ==PDCA==サイクルで==サービス==・==プロセス==を==改善==',
          '__7ステップ改善プロセス__:',
          '　==1. 改善戦略の定義==',
          '　==2. 測定対象の定義==',
          '　==3. データ収集==',
          ...
          '　==KPI==（Key Performance Indicator, 重要業績評価指標, measurement §3 参照）',
          '__ベースライン__の確立から改善を追跡',
          '__デミング・サイクル__（PDCA, delivery §18 参照）が基盤',
          '__ライフサイクル全体__に==横断的==に適用',
        ],
        navyItems: [[{ text: 'CSI は ITIL v3 / v4 とも継続採用。PDCA・KPI と密接', style: 'navy' }]],
      },
      // ── C. ITIL 4 ──
      {
        heading: '9. サービスバリューシステム（SVS, Service Value System）',
        items: [
          '==SVS==（Service Value System）: ITIL 4 の==中核フレームワーク==',
          '__目的__: ==組織==の==全コンポーネント==・==活動==が==連携==して==価値==を==共創==',
          '__SVS の構成要素__:',
          '　==ガイディング原則==（7原則、§12 で詳細）',
          '　==ガバナンス==',
          '　==サービスバリューチェーン==（§10 で詳細）',
          '　==プラクティス==（34個、v3 のプロセスに相当）',
          '　==継続的改善==',
          '__インプット__: ==需要==・==機会==',
          '__アウトプット__: ==価値==（顧客にとっての価値）',
          '__v3 との主な違い__:',
          '　v3 はライフサイクル（順序）、v4 は==バリューチェーン==（活動の連携）',
          '　v3「プロセス」→ v4「==プラクティス==」（より広い概念）',
        ],
        navyItems: [[{ text: 'ITIL 4 SVS は AXELOS 2019年改訂の中核概念', style: 'navy' }]],
      },
      {
        heading: '10. サービスバリューチェーン（SVC）',
        items: [
          '==サービスバリューチェーン==（==SVC==）: ITIL 4 の==6つの活動==',
          '__6活動__:',
          '　==1. 計画==（Plan）',
          '　==2. 改善==（Improve）',
          '　==3. エンゲージ==（Engage）',
          ...
          '　==6. デリバリーとサポート==（Deliver & Support）',
          '__特徴__:',
          '　v3 のような==順序==はない',
          '　==バリューストリーム==（特定の価値創出のための活動の連鎖）に応じて==組合せ==',
          '　==非線形==・==創発的==',
          '__例（インシデント対応バリューストリーム）__:',
          '　エンゲージ（受付）→ デリバリーとサポート（解決）→ 改善（教訓）',
          '各活動に==プラクティス==が紐づく',
        ],
      },
      {
        ...
        items: [
          '==4側面==（Four Dimensions of Service Management）: サービスマネジメントを==包括的==に捉える視点',
          '__1. 組織と人々__（Organizations and People）:',
          '　==組織構造==・==文化==・==コミュニケーション==',
          '　==役割と責任==・==スキル==・==コンピテンシー==',
          '__2. 情報と技術__（Information and Technology）:',
          '　==情報==（データ・知識）',
          '　==技術==（ハードウェア・ソフトウェア・AI・IoT）',
          '__3. パートナーとサプライヤー__（Partners and Suppliers）:',
          '　==外部委託==・==サプライチェーン==',
          '　==契約==・==SLA==',
          '__4. バリューストリームとプロセス__（Value Streams and Processes）:',
          '　==活動の連鎖==・==プロセス定義==',
          '__外部要因__（PESTLE と類似）:',
          '　政治・経済・社会・技術・法的・環境的要因が4側面に影響',
        ],
      },
      {
        heading: '12. ITIL 4 ガイディング原則 7つ',
        items: [
          '==ガイディング原則==（Guiding Principles）: あらゆる状況で==組織を導く==推奨事項',
          '__7原則__:',
          '　==1. 価値に注力==（Focus on Value）: 顧客・利害関係者の==価値==を最優先',
          '　==2. 現状から始める==（Start Where You Are）: ==既存==を活かし、ゼロから作らない',
          '　==3. フィードバックを得てイテレーティブに進める==（Progress Iteratively with Feedback）',
          '　==4. コラボレーションし可視性を高める==（Collaborate and Promote Visibility）',
          '　==5. 包括的に考え機能する==（Think and Work Holistically）: ==全体最適==',
          '　==6. シンプルさと実用性を維持==（Keep It Simple and Practical）',
          '　==7. 最適化と自動化==（Optimize and Automate）: ==人間==の介入は==最適化後==',
          '__アジャイル思想__との親和性が高い',
          '__テーラリング__（tailoring-models §3 参照）の考え方と類似',
        ],
        navyItems: [[{ text: 'ITIL 4 ガイディング原則 7つは試験で出題される可能性あり', style: 'navy' }]],
      },
      // ── D. SLA / OLA / UC ──
      {
        heading: '13. SLA / OLA / UC の階層',
        items: [
          '__サービスレベルに関する 3 種類の合意__:',
          '　==SLA==（Service Level Agreement, ==サービスレベル合意==）: ==顧客==と==サービスプロバイダ==の==合意==',
          '　==OLA==（Operational Level Agreement, ==運用レベル合意==）: ==プロバイダ内部==の部門間合意',
          '　==UC==（Underpinning Contract, ==補強契約==）: プロバイダと==外部サプライヤ==の==契約==',
          '__階層関係__:',
          '　==SLA==（顧客向け）',
          '　　を支える==OLA==（内部部門）',
          '　　を支える==UC==（外部サプライヤ）',
          '__重要原則__: ==SLA==の==サービスレベル== ≦ ==OLA== ≦ ==UC==',
          '　（外部依存先のレベルが高くないと、内部・対顧客のレベルを維持できない）',
      ...
      },
      {
        ...
        items: [
          '__SLA に記載される主要項目__:',
          '　==サービスの説明==（範囲・対象）',
          '　==サービス時間==（提供時間帯、24時間/365日 等）',
          '　==可用性==（Availability, 例: 99.9% = ==月43分以内==の停止）',
          '　==応答時間==（Response Time, 例: 90% が ==2秒以内==）',
          '　==処理時間==（Resolution Time, インシデント対応時間）',
          '　==サポート体制==（窓口・連絡手段・対応時間）',
          '　==スループット==（処理能力、件数/時間 等）',
          '　==バックアップ==・==復旧==（RPO/RTO）',
          '　==報告==（月次報告書・頻度）',
          '　==違反時の対応==（==ペナルティ==・サービスクレジット）',
          '__SLA メトリクス__:',
          '　==可用性==計算: (稼働時間 - 停止時間) / 稼働時間 × 100%',
          '　==99.9%==（スリーナイン）= 月==43.2分==、年==8.76時間==の停止許容',
      ...
      },
      {
        ...
        items: [
          '==SLM==（Service Level Management, ==サービスレベル管理==）: ==SLA==の==策定==・==監視==・==報告==・==改善==プロセス',
          '__SLM 活動__:',
          '　==1. 顧客ニーズ収集==',
          '　==2. SLR==（Service Level Requirement, 要件）の文書化',
          '　==3. SLA 草案==の作成・交渉',
          '　==4. SLA 合意==・署名',
          '　==5. OLA / UC との整合==',
          '　==6. パフォーマンス監視==',
      ...
      // ── E. ITIL プロセス詳細 ──
      {
        ...
        items: [
          '__インシデント管理__（Incident Management）:',
          '　==目的==: ==サービス回復==を==迅速に==（==根本原因==は問わない）',
          '　==SLA==範囲内での==解決==',
          '　==サービスデスク==が主担当',
          '　==プロセス==: 検出 → 記録 → 分類 → 優先順位付け → 初期診断 → エスカレーション → 解決 → クローズ',
          '　==KPI==: ==MTTR==（平均修復時間）、SLA達成率',
          '__問題管理__（Problem Management）:',
          '　==目的==: インシデントの==根本原因==を特定し==再発防止==',
          '　==プロアクティブ==（事前防止）と==リアクティブ==（事後対応）',
          '　==プロセス==: 検出 → 分類 → 調査 → 既知エラー登録 → 解決策提案 → クローズ',
          '　==成果物==: ==KEDB==（Known Error Database, 既知エラーDB）',
          '　==KPI==: ==MTBF==（平均故障間隔）、再発率',
          '__違い__:',
          '　インシデント = ==症状==への対処（早く回復）',
          '　問題 = ==原因==への対処（再発防止）',
      ...
      },
      {
        ...
        items: [
          '==変更管理==（Change Management）: IT サービスの==変更==を==計画的==に==管理==',
          '__目的__:',
          '　==変更==による==サービス影響==の==最小化==',
          '　==変更失敗時==の==ロールバック==準備',
          '　==変更履歴==の追跡',
          '__変更の3類型__:',
          '　==標準変更==（Standard Change）: ==事前承認済み==・==定型的==（パスワードリセット等）',
          '　==通常変更==（Normal Change）: ==CAB==（Change Advisory Board）の==審議==が必要',
          '　==緊急変更==（Emergency Change）: ==ECAB==（Emergency CAB）で==迅速==承認',
          '__主要プロセス__:',
          '　==RFC==（Request for Change）起票',
          '　==影響評価==',
          '　==CAB 審議==',
          '　==実装==',
          '　==事後レビュー==（PIR, Post-Implementation Review）',
          '__注意__: PMBOK の==統合変更管理==（integration §13）と==別物==:',
      ...
      },
      {
        ...
        items: [
          '==構成管理==（Configuration Management, ITIL）: ==構成項目==の==情報==を==中央管理==',
          '==CMDB==（Configuration Management Database, ==構成管理データベース==）',
          '__CI（Configuration Item, 構成項目）の例__:',
          '　==ハードウェア==（サーバ・ネットワーク機器・PC）',
          '　==ソフトウェア==（OS・ミドルウェア・アプリ）',
          '　==文書==（設計書・契約書）',
          '　==サービス==（提供しているサービス自体）',
          '　==人員==（担当者情報）',
          '__CMDB 記載項目__:',
          '　==CI 識別==・==属性==（バージョン・状態・所有者）',
          '　==CI 間の関係==（依存・包含）',
          '__メリット__:',
          '　==影響分析==（変更・障害時）',
          '　==コンプライアンス==・==監査==対応',
          '　==ライセンス管理==',
          'プロジェクトの==構成管理==（integration §18）と類似だが==運用フェーズ==が対象',
        ],
      ...
      },
      {
        ...
        items: [
          '==リリース管理==（Release Management）: 変更を==まとめて==本番環境に==展開==',
          '__リリースの3類型__:',
          '　==メジャー・リリース==: 大規模機能追加',
          '　==マイナー・リリース==: 軽微な機能改善',
          '　==緊急リリース==: 重大バグ修正',
          ...
          '　==リリース計画==',
          '　==ビルド==・==テスト==',
          '　==デプロイ==（==DML==: Definitive Media Library から）',
          '　==検証==',
          '　==文書化==',
          '__デプロイ手法__:',
          '　==ブルー・グリーン==デプロイ（2環境を切替）',
          '　==カナリア・リリース==（一部ユーザに先行公開）',
          '　==ローリング・アップデート==',
          '__DevOps__（development-approach §30 参照）と密接',
          '__CI/CD__（継続的インテグレーション・デリバリー）が現代的',
        ],
      },
      {
        ...
        items: [
          ...
          '　　==保守性==（Maintainability）= MTTR',
          '　　==サービサビリティ==（外部サプライヤの可用性）',
          '__冗長化手法__: ==デュアル==（==アクティブ・スタンバイ==）／==クラスタ==／==ロードバランシング==',
        ],
      },
      {
        heading: '21. IT サービス継続性管理（ITSCM / IT-BCP）',
        items: [
          '==IT サービス継続性管理==（ITSCM, IT Service Continuity Management）: ==災害==・==重大障害==時の==サービス継続==',
          '__BCP との関係__: ==事業継続計画==（BCP, Business Continuity Plan）の==IT 部分==',
          '__主要指標__:',
          '　==RPO==（Recovery Point Objective, ==目標復旧時点==）: ==データ==の==最大許容損失時間==',
          '　==RTO==（Recovery Time Objective, ==目標復旧時間==）: ==サービス==の==最大許容停止時間==',
          '　==RLO==（Recovery Level Objective, ==目標復旧レベル==）: 復旧後の==サービスレベル==',
          '__計画策定の流れ__:',
          '　==1. リスク評価==・==事業影響度分析==（BIA）',
          '　==2. 継続戦略==の選定',
          '　==3. 計画策定==',
      ...
      },
      {
        ...
        items: [
          '==システム監査==: 情報システムの==信頼性==・==安全性==・==効率性==を==独立した立場==で==評価==',
          '__目的__:',
          '　==経営目標==への==貢献度==の確認',
          '　==リスク==の評価',
          '　==コントロール==の有効性確認',
          ...
          '　==改善提案==',
          '__種類__:',
          '　==内部監査==: ==組織内部==の==監査人==（独立部門）',
          '　==外部監査==: ==外部監査法人==（==公認会計士==・==システム監査技術者==）',
          '　==法定監査==: 法令に基づく義務監査（J-SOX等）',
          '　==任意監査==: 経営判断による監査',
          '__視点別__:',
          '　==情報セキュリティ監査==',
          '　==個人情報保護監査==',
          '　==IT統制監査==',
          '__IPA システム監査技術者試験__が国家資格',
        ],
      },
      {
        heading: '24. システム監査基準・実施プロセス',
        items: [
          '==システム監査基準==（経済産業省）: 監査の==判断尺度==',
          '==システム管理基準==（経済産業省）: 監査==対象==の==管理基準==',
          '==システム監査の3独立性==:',
          '　==精神的独立性==（中立性・公正性）',
          '　==外観的独立性==（被監査側との関係なし）',
          '　==組織的独立性==（被監査部門から独立した組織）',
          '==実施プロセス（4段階）==:',
          '　==1. 監査計画策定==:',
          '　　目的・範囲・体制・スケジュール',
          '　==2. 予備調査==:',
      ...
      // ── G. 関連法令 ──
      {
        ...
        items: [
          ...
          '　==第三者提供==の制限',
          '　==本人開示==・==訂正==・==利用停止==への対応',
          '__個人情報取扱事業者__: すべての事業者（取扱件数による義務軽減撤廃）',
          '__個人識別符号__: マイナンバー・パスポート番号等',
          '__要配慮個人情報__: 人種・信条・病歴等',
          '==GDPR==（General Data Protection Regulation, EU 一般データ保護規則）:',
          '　==EU 域内==の個人データ保護',
          '　==違反時の制裁金==: 最大 ==2000万ユーロ==または==全世界売上の4%==の高い方',
          '　==DPO==（Data Protection Officer, データ保護責任者）',
          '　==データポータビリティ==・==忘れられる権利==',
          'プロジェクトで個人データを扱う場合の==法的要件==',
        ],
      },
      {
        heading: '26. サイバーセキュリティ基本法・不正アクセス禁止法',
        items: [
          '==サイバーセキュリティ基本法==（2014年成立）:',
          '　==国==・==地方公共団体==・==重要社会基盤事業者==の責務',
          '　==サイバーセキュリティ戦略本部==の設置',
          '　==NISC==（内閣サイバーセキュリティセンター）',
          '　==重要インフラ==分野: 14分野（金融・電力・水道・医療・物流等）',
          '==不正アクセス禁止法==（1999年制定）:',
          '　==アクセス制御機能==による==識別符号==の==不正使用==等の禁止',
          '　==違反==: 3年以下の懲役または100万円以下の罰金',
          '　==識別符号==の==不正取得==・==保管==・==助長==も禁止',
          '==サイバーセキュリティ経営ガイドライン==（経産省）:',
          '　==経営層==の==10原則==・==重要10項目==',
          '　==CISO==の設置推奨',
          '==プライバシーマーク==・==ISMS==（ISO/IEC 27001）認証',
        ],
        navyItems: [[{ text: 'IPA 試験で頻出。サイバーセキュリティ基本法は重要インフラ事業者の責務が問われる', style: 'navy' }]],
      },
      {
        ...
        items: [
          '==著作権法==（IT 関連）:',
          '　==プログラムの著作物==が==保護対象==',
          '　==職務著作==: ==法人著作==（法人に帰属、project-work §23 参照）',
          '　==複製権==・==翻案権==・==公衆送信権==',
          '　==オープンソースライセンス==の遵守（GPL/Apache/MIT 等）',
          '　==著作権の保護期間==: ==著作者死後70年==',
          '==不正競争防止法==:',
          '　==営業秘密==の保護:',
          '　　==秘密管理性==（秘密として管理）',
          '　　==有用性==（事業活動に有用）',
          '　　==非公知性==（公知でない）',
          '　==営業秘密侵害==: 不正取得・使用・開示の禁止',
          '　==違反==: 10年以下の懲役 + 2000万円以下の罰金（個人）',
          '__プロジェクトでの注意__:',
          '　==退職者==による==営業秘密持出==の防止',
          '　==委託先==への==NDA==締結（project-work §25 参照）',
          '　==オープンソース==コンプライアンス',
        ],
      },
      // ── H. IPA PM試験 出題傾向 ──
    ...
    exam_tips: [
      '【最重要・ITIL v3】5ライフサイクル（==戦略==・==設計==・==移行==・==運用==・==CSI==）と各プロセス。',
      '【SLA/OLA/UC】顧客（SLA）／内部部門（OLA）／外部サプライヤ（UC）の階層。==SLA ≦ OLA ≦ UC== の関係。',
      '【可用性計算】99.9% = 月==43.2分==、99.99% = 月==4.32分==、99.999% = 月==25.9秒== の停止許容。',
      '【インシデント vs 問題】インシデントは==サービス回復==（早期）、問題は==根本原因解決==（再発防止）。',
      '【MTTR vs MTBF】MTTR=平均修復時間（==短い==ほど良い）、MTBF=平均故障間隔（==長い==ほど良い）。可用性 = MTBF/(MTBF+MTTR)。',
      '【変更管理】3類型（==標準==/==通常==/==緊急==）と==CAB==の役割。ITIL 変更管理と PMBOK 4.6 統合変更管理は==別物==。',
      '【RPO vs RTO】RPOは==データの最大許容損失時間==（巻き戻し）、RTOは==サービスの最大許容停止時間==。',
      '【ISO/IEC 20000】SMS 要件の国際規格。ITIL（実践）との==補完関係==。R6 秋期 問18 で出題実績。',
      '【個人情報保護法】取扱事業者の義務（==利用目的通知==・==同意==・==安全管理==・==第三者提供制限==）。',
      '【関連法令】サイバーセキュリティ基本法（重要インフラ）／不正アクセス禁止法（識別符号不正）／不正競争防止法（営業秘密3要件）／著作権法（職務著作=法人帰属）。',
    ],
  },
}
