...
> バージョン: 0.17（フェーズ2 計画詳細化：§2.7e 新設、F1.5-P5/P6 スキップ判断、F2-P1 カテゴリ順 PMBOK第7版章順に確定、品質ゲート強化）
> 作成日: 2026-05-06（v0.14） / 2026-05-13（v0.15） / 2026-05-16（v0.16） / 2026-05-17（v0.17）
...
> v0.17 で §2.7e に詳細化済み。本節は概要のみを残す。
> 詳細は [§2.7e フェーズ2 計画](#27e-フェーズ2-計画v017-新設) を参照。

- F2-P1: 残り11カテゴリのノート（PMBOK第7版章順、7〜12日）
