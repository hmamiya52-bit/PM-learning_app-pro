...
> バージョン: 0.18（PMBOK版方針修正：第6版＋第7版を各カテゴリで統合、F2-P0 stakeholder 遡及補完を新設、team 章構成案を36セクションに拡張）
> 作成日: 2026-05-06（v0.14） / 2026-05-13（v0.15） / 2026-05-16（v0.16） / 2026-05-17（v0.17・v0.18）
